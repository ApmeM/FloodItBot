 ...
 */
Bridge.assembly("GeonBit.UI", function ($asm, globals) {
    "use strict";
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.Animators.IAnimator
     */
    Bridge.define("GeonBit.UI.Animators.IAnimator", {
        fields: {
            /**
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Animators.IAnimator
             * @default true
             * @type boolean
             */
            Enabled: false
        ...
        props: {
             ...
             * @type GeonBit.UI.Entities.Entity
             */
            TargetEntity: null,
            /**
        ...
        methods: {
             ...
             *
             * @instance
             * @this GeonBit.UI.Animators.IAnimator
             * @memberof GeonBit.UI.Animators.IAnimator
             * @param   {GeonBit.UI.Entities.Entity}    entity    Target entity to animate.
             * @return  {void}
             */
            SetTargetEntity: function (entity) {
                // validate compatibility
                if (!this.CheckEntityCompatibility(entity)) {
                    throw new GeonBit.UI.Exceptions.InvalidValueException.$ctor1("Entity type not compatible with this animator!");
                }

                // make sure not already attached
                if (this.TargetEntity != null && entity != null) {
                    throw new GeonBit.UI.Exceptions.InvalidStateException.$ctor1("Cannot attach animator to entity after it was already attached!");
                }
             ...
             * @this GeonBit.UI.Animators.IAnimator
             * @memberof GeonBit.UI.Animators.IAnimator
             * @param   {GeonBit.UI.Entities.Entity}    entity    Entity to test.
    ...
    Bridge.define("GeonBit.UI.BridgeExtension", {
        statics: {
            methods: {
     ...
     *
     * @public
     * @class GeonBit.UI.BuiltinThemes
     */
    Bridge.define("GeonBit.UI.BuiltinThemes", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.BuiltinThemes
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.BuiltinThemes
                 */
                hd: 0,
                /**
     ...
     *
     * @public
     * @class GeonBit.UI.CursorType
     */
    Bridge.define("GeonBit.UI.CursorType", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.CursorType
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.CursorType
                 */
                Default: 0,
                /**
     ...
     *
     * @public
     * @class GeonBit.UI.DataTypes._FontStyle
     */
    Bridge.define("GeonBit.UI.DataTypes._FontStyle", {
        $kind: "enum",
        statics: {
            fields: {
                Regular: 0,
     ...
     *
     * @public
     * @class GeonBit.UI.DataTypes.CursorTextureData
     */
    Bridge.define("GeonBit.UI.DataTypes.CursorTextureData", {
        fields: {
            /**
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.DataTypes.CursorTextureData
             * @default 0
             * @type number
             */
            OffsetX: 0,
     ...
     *
     * @public
     * @class GeonBit.UI.DataTypes.DefaultStyles
     */
    Bridge.define("GeonBit.UI.DataTypes.DefaultStyles", {
        fields: {
            Scale: null,
            FillColor: null,
            OutlineColor: null,
     ...
     *
     * @public
     * @class GeonBit.UI.DataTypes.StyleProperty
     */
    Bridge.define("GeonBit.UI.DataTypes.StyleProperty", {
        $kind: "struct",
        statics: {
            methods: {
                getDefaultValue: function () { return new GeonBit.UI.DataTypes.StyleProperty(); }
            }
        },
        fields: {
            /**
             ...
             * @instance
             * @private
             * @memberof GeonBit.UI.DataTypes.StyleProperty
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.DataTypes.StyleProperty
             * @memberof GeonBit.UI.DataTypes.StyleProperty
     ...
     *
     * @public
     * @class GeonBit.UI.DataTypes.TextureData
     */
    Bridge.define("GeonBit.UI.DataTypes.TextureData", {
        fields: {
            /**
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.DataTypes.TextureData
             * @type number
             */
            FrameWidth: 0,
            /**
     ...
     *
     * @public
     * @class GeonBit.UI.DataTypes.ThemeSettings
     */
    Bridge.define("GeonBit.UI.DataTypes.ThemeSettings", {
        fields: {
            /**
             * Name fot he theme.
             *
             * @instance
             * @public
             * @memberof GeonBit.UI.DataTypes.ThemeSettings
             * @type string
             */
            ThemeName: null,
            /**
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.IKeyboardInput
     */
    Bridge.define("GeonBit.UI.IKeyboardInput", {
        $kind: "interface"
    });
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.IMouseInput
     */
    Bridge.define("GeonBit.UI.IMouseInput", {
        $kind: "interface"
    });
     ...
     *
     * @public
     * @class GeonBit.UI.DrawUtils
     */
    Bridge.define("GeonBit.UI.DrawUtils", {
        fields: {
            _renderTargets: null,
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.DrawUtils
             * @memberof GeonBit.UI.DrawUtils
            ...
            PushRenderTarget: function (target) {
                ...
                if (!GeonBit.UI.UserInterface.Active.UseRenderTarget) {
                    throw new GeonBit.UI.Exceptions.InvalidStateException.$ctor1("UserInterface.Active.UseRenderTarget must be 'true' to use render-target features!");
                }
             ...
             * @this GeonBit.UI.DrawUtils
             * @memberof GeonBit.UI.DrawUtils
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}          spriteBatch    SpriteBatch to draw on.
            ...
            DrawImage: function (spriteBatch, texture, destination, color, scale, sourceRect) {
                ...
                // draw image
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw$1(texture, destination.$clone(), src.$clone(), System.Nullable.getValue(color));
            },
            /**
            ...
            DrawSurface: function (spriteBatch, texture, destination, textureFrameWidth, scale, color, frameScale) {
                ...
                var ScaleFactor = GeonBit.UI.UserInterface.Active.GlobalScale * frameScale;
                ...
                // top left corner
                {
                    ...
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw$1(texture, destRect.$clone(), srcRect.$clone(), System.Nullable.getValue(color));
                }
                // top right corner
                {
            ...
            StartDraw: function (spriteBatch, isDisabled) {
                // start drawing
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Begin(Microsoft.Xna.Framework.Graphics.SpriteSortMode.Deferred, GeonBit.UI.UserInterface.Active.BlendState, GeonBit.UI.UserInterface.Active.SamplerState, Microsoft.Xna.Framework.Graphics.DepthStencilState.None, Microsoft.Xna.Framework.Graphics.RasterizerState.CullCounterClockwise, isDisabled ? GeonBit.UI.Resources.DisabledEffect : null, void 0);
            ...
            StartDrawSilhouette: function (spriteBatch) {
                ...
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Begin(Microsoft.Xna.Framework.Graphics.SpriteSortMode.Deferred, GeonBit.UI.UserInterface.Active.BlendState, GeonBit.UI.UserInterface.Active.SamplerState, Microsoft.Xna.Framework.Graphics.DepthStencilState.None, Microsoft.Xna.Framework.Graphics.RasterizerState.CullCounterClockwise, GeonBit.UI.Resources.SilhouetteEffect, void 0);
             ...
             * @this GeonBit.UI.DrawUtils
             * @memberof GeonBit.UI.DrawUtils
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}    spriteBatch    Current spritebatch we are using.
             * @return  {void}
             */
            UpdateRenderTarget: function (spriteBatch) {
                ...
                if (this._renderTargets.Count > 0) {
                    ...
                    newRenderTarget = GeonBit.UI.UserInterface.Active.RenderTarget;
                }
                ...
                if (!Bridge.referenceEquals(this._lastRenderTarget, newRenderTarget)) {
                    ...
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.SetRenderTarget(this._lastRenderTarget);
                }
            },
            /**
            ...
            EndDraw: function (spriteBatch) {
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$End();
            }
        }
    });

    Bridge.define("GeonBit.UI.ECS.Components.TextComponent", {
    ...
    Bridge.define("GeonBit.UI.ECS.Components.UIComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            GameTime: null,
            MouseProvider: null
        ...
        ctors: {
            init: function () {
                ...
                this.MouseProvider = new GeonBit.UI.ResolutionMouseProvider();
                this.UserInterface = new GeonBit.UI.UserInterface();
            }
        }
    });

    Bridge.define("GeonBit.UI.ECS.EntitySystems.TextUIUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([GeonBit.UI.ECS.Components.TextComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var ui = entity.GetOrCreateComponent(GeonBit.UI.ECS.Components.UIComponent);
                ...
                if (text.Label == null) {
                    text.Label = new GeonBit.UI.Entities.Label.$ctor1(text.Text);
    ...
    Bridge.define("GeonBit.UI.ECS.EntitySystems.UIUpdateSystem", {
        ...
        ctors: {
            init: function () {
                ...
                this.spriteBatchWrapper = new GeonBit.UI.Utils.MeshBatchWrapper();
                this.totalTime = System.TimeSpan.zero;
            },
            ctor: function (content) {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([GeonBit.UI.ECS.Components.UIComponent]));
        ...
        methods: {
            DoAction$1: function (entity, gameTime) {
                var $t, $t1;
                LocomotorECS.EntityProcessingSystem.prototype.DoAction$1.call(this, entity, gameTime);
                var ui = entity.GetComponent(GeonBit.UI.ECS.Components.UIComponent);
                var scale = ($t = (($t1 = entity.GetComponent(MyONez.ECS.Components.ScaleComponent)) != null ? $t1.Scale : null), $t != null ? $t : Microsoft.Xna.Framework.Vector2.One);
            ...
            SceneBackBufferSizeChanged: function (realRenderTarget, sceneRenderTarget) {
                Bridge.cast(this.spriteBatchWrapper.GraphicsDevice, GeonBit.UI.Utils.ScreenGraphicDeviceWrapper).ViewRectangle = sceneRenderTarget.$clone();
            }
        }
    });
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.Anchor
     */
    Bridge.define("GeonBit.UI.Entities.Anchor", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.Anchor
                 * @constant
                 * @default 0
    ...
    /**
     * @memberof GeonBit.UI
     * @callback GeonBit.UI.EventCallback
     * @param   {GeonBit.UI.Entities.Entity}    entity
     * @return  {void}
     */
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.Entity", {
        statics: {
            fields: {
                 ...
                 * @public
                 * @readonly
                 * @memberof GeonBit.UI.Entities.Entity
                 * @type Microsoft.Xna.Framework.Vector2
                 */
                 ...
                 * @public
                 * @memberof GeonBit.UI.Entities.Entity
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                init: function () {
                    ...
                    this.DefaultStyle = new GeonBit.UI.Entities.StyleSheet();
                },
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.Entity);
                }
            },
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this GeonBit.UI.Entities.Entity
                 * @memberof GeonBit.UI.Entities.Entity
                 * @param   {Function}    type    Entity type to make serializable.
                 * @return  {void}
                 */
                MakeSerializable: function (type) {
                    GeonBit.UI.Entities.Entity._serializableTypes.add(type);
                }
            }
        },
        fields: {
             ...
             * @protected
             * @memberof GeonBit.UI.Entities.Entity
             * @type GeonBit.UI.Entities.EntityState
             */
            _entityState: 0,
            _isFocused: false,
            /**
        ...
        props: {
            ...
            Children: {
                get: function () {
                    return Bridge.as(this._children.AsReadOnly(), System.Collections.Generic.IReadOnlyList$1(GeonBit.UI.Entities.Entity));
                }
            },
            /**
            ...
            EntityDefaultSize: {
                get: function () {
                    var ret = this.GetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.DefaultSize, GeonBit.UI.Entities.EntityState.Default, true).asVector.$clone();
                    return ret.$clone();
                }
            },
            /**
             ...
             * @memberof GeonBit.UI.Entities.Entity
             * @function MouseInput
             * @type GeonBit.UI.IMouseInput
             */
            MouseInput: {
                get: function () {
                    return GeonBit.UI.UserInterface.Active.MouseInputProvider;
                }
            },
            /**
             ...
             * @type GeonBit.UI.IKeyboardInput
             */
            KeyboardInput: {
                get: function () {
                    return GeonBit.UI.UserInterface.Active.KeyboardInputProvider;
                }
            },
            /**
            ...
            GlobalScale: {
                get: function () {
                    return GeonBit.UI.UserInterface.Active.GlobalScale;
                }
            },
            /**
            ...
            DebugDraw: {
                get: function () {
                    return GeonBit.UI.UserInterface.Active.DebugDraw;
                }
            },
            /**
            ...
            Background: {
                ...
                set: function (value) {
                    if (value != null && value._parent != null) {
                        throw new GeonBit.UI.Exceptions.InvalidStateException.$ctor1("Cannot set background entity that have a parent!");
                    }
            ...
            SpaceAfter: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.SpaceAfter).asVector.$clone();
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.SpaceAfter, new GeonBit.UI.DataTypes.StyleProperty.$ctor2(value.$clone()));
                }
            },
            /**
            ...
            SpaceBefore: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.SpaceBefore).asVector.$clone();
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.SpaceBefore, new GeonBit.UI.DataTypes.StyleProperty.$ctor2(value.$clone()));
                }
            },
            /**
            ...
            FillColor: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.FillColor).asColor.$clone();
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.FillColor, new GeonBit.UI.DataTypes.StyleProperty.$ctor1(value.$clone()), 0, false);
                }
            },
            /**
            ...
            Opacity: {
                ...
                set: function (value) {
                    ...
                    col.A = value;
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.FillColor, new GeonBit.UI.DataTypes.StyleProperty.$ctor1(col.$clone()), 0, false);

                    // update outline color
                    col = this.OutlineColor.$clone();
                    col.A = value;
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.OutlineColor, new GeonBit.UI.DataTypes.StyleProperty.$ctor1(col.$clone()), 0, false);
                }
            },
            /**
            ...
            Padding: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.Padding).asVector.$clone();
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.Padding, new GeonBit.UI.DataTypes.StyleProperty.$ctor2(value.$clone()));
                }
            },
            /**
            ...
            ShadowColor: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.ShadowColor).asColor.$clone();
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.ShadowColor, new GeonBit.UI.DataTypes.StyleProperty.$ctor1(value.$clone()), 0, false);
                }
            },
            /**
            ...
            ShadowScale: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.ShadowScale).asFloat;
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.ShadowScale, new GeonBit.UI.DataTypes.StyleProperty.$ctor5(value), 0, false);
                }
            },
            /**
            ...
            ShadowOffset: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.ShadowOffset).asVector.$clone();
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.ShadowOffset, new GeonBit.UI.DataTypes.StyleProperty.$ctor2(value.$clone()), 0, false);
                }
            },
            /**
            ...
            Scale: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.Scale).asFloat;
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.Scale, new GeonBit.UI.DataTypes.StyleProperty.$ctor5(value));
                }
            },
            /**
            ...
            OutlineColor: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.OutlineColor).asColor.$clone();
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.OutlineColor, new GeonBit.UI.DataTypes.StyleProperty.$ctor1(value.$clone()), 0, false);
                }
            },
            /**
            ...
            OutlineWidth: {
                get: function () {
                    return this.GetActiveStyle(GeonBit.UI.Entities.StylePropertyIds.OutlineWidth).asInt;
                },
                set: function (value) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.OutlineWidth, new GeonBit.UI.DataTypes.StyleProperty.$ctor4(value), 0, false);
                }
            },
            /**
            ...
            IsMouseDown: {
                get: function () {
                    return this._entityState === GeonBit.UI.Entities.EntityState.MouseDown;
                }
            },
            /**
        ...
        ctors: {
            init: function () {
                ...
                this._children = new (System.Collections.Generic.List$1(GeonBit.UI.Entities.Entity)).ctor();
                this._needToSortChildren = true;
                this._hiddenInternalEntity = false;
                this._animators = new (System.Collections.Generic.List$1(GeonBit.UI.Animators.IAnimator)).ctor();
                ...
                this._isDirty = true;
                this._style = new GeonBit.UI.Entities.StyleSheet();
                ...
                this._entityState = GeonBit.UI.Entities.EntityState.Default;
             ...
             * @param   {GeonBit.UI.Entities.Anchor}          anchor    Poisition anchor.
            ...
            ctor: function (size, anchor, offset) {
                ...
                this.UpdateStyle(GeonBit.UI.Entities.Entity.DefaultStyle);

                // store size, anchor and offset
                this._size = ($t = size, $t != null ? $t : GeonBit.UI.Entities.Entity.USE_DEFAULT_SIZE.$clone());
        ...
        methods: {
            ...
            GetMousePos: function (addVector) {
                ...
                return GeonBit.UI.UserInterface.Active.GetTransformedCursorPos(System.Nullable.lift1("$clone", addVector));
            },
            /**
            ...
            DoOnFirstUpdate: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnEntitySpawn, null) ? GeonBit.UI.UserInterface.Active.OnEntitySpawn(this) : null;
             ...
             * @param   {GeonBit.UI.Entities.EntityState}       state                State to get property for (if undefined will fallback to default state).
             * @param   {boolean}                               fallbackToDefault    If true and property not found for given state, will fallback to default state.
             * @return  {GeonBit.UI.DataTypes.StyleProperty}                         Style property value for given state or default, or null if undefined.
             */
             ...
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {string}                                property       Property identifier.
             * @param   {GeonBit.UI.DataTypes.StyleProperty}    value          Property value.
             * @param   {GeonBit.UI.Entities.EntityState}       state          State to set property for.
             ...
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {string}                                property    Property identifier.
             * @return  {GeonBit.UI.DataTypes.StyleProperty}                Stylesheet property value for current entity state, or default if not defined.
             */
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Entities.StyleSheet}    updates    Stylesheet to update from.
             * @return  {void}
             */
            ...
            Find: function (T, identifier, recursive) {
                ...
                var anyType = Bridge.referenceEquals(T, GeonBit.UI.Entities.Entity);
             ...
             * @param   {string}                        identifier    Identifier to find.
             * @param   {boolean}                       recursive     If true, will search recursively in children of children. If false, will search only in direct children.
             * @return  {GeonBit.UI.Entities.Entity}                  First found entity with given identifier, or null if nothing found.
             */
            Find$1: function (identifier, recursive) {
                if (recursive === void 0) { recursive = false; }
                return this.Find(GeonBit.UI.Entities.Entity, identifier, recursive);
            },
            /**
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.EventCallback}    callback    Callback function to call with every child of this entity.
             * @return  {void}
             */
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Entities.Entity}    other    Entity to check if this entity is descendant of.
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Entities.Anchor}         anchor    New anchor to set.
            ...
            GetSortedChildren: function () {
                ...
                if (this._needToSortChildren) {
                    ...
                    this._sortedChildren = new (System.Collections.Generic.List$1(GeonBit.UI.Entities.Entity)).$ctor1(this._children);

                    // get children in a sorted list
                    this._sortedChildren.Sort$2($asm.$.GeonBit.UI.Entities.Entity.f1);
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}    spriteBatch    SpriteBatch to use for drawing.
             * @return  {void}
             */
            Draw: function (spriteBatch) {
                ...
                GeonBit.UI.UserInterface.Active.DrawUtils.StartDraw(spriteBatch, this._isCurrentlyDisabled);
                this.DrawEntity(spriteBatch, GeonBit.UI.Entities.DrawPhase.Base);
                GeonBit.UI.UserInterface.Active.DrawUtils.EndDraw(spriteBatch);
            ...
            DrawDebugStuff: function (spriteBatch) {
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Begin(Microsoft.Xna.Framework.Graphics.SpriteSortMode.Immediate, Microsoft.Xna.Framework.Graphics.BlendState.NonPremultiplied, void 0, void 0, void 0, void 0, void 0);

                // first draw whole dest rect
                var destRectCol = new Microsoft.Xna.Framework.Color.$ctor9(0.0, 1.0, 0.25, 0.05);
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(GeonBit.UI.Resources.WhiteTexture, this._destRect.$clone(), destRectCol.$clone());

                // now draw internal dest rect
                var internalCol = new Microsoft.Xna.Framework.Color.$ctor9(1.0, 0.5, 0.0, 0.5);
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(GeonBit.UI.Resources.WhiteTexture, this._destRectInternal.$clone(), internalCol.$clone());

                // draw space before
                var spaceColor = new Microsoft.Xna.Framework.Color.$ctor9(0.0, 0.0, 0.5, 0.5);
                if (this.SpaceBefore.X > 0) {
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(GeonBit.UI.Resources.WhiteTexture, new Microsoft.Xna.Framework.Rectangle.$ctor2(Bridge.Int.clip32(this._destRect.Left - this._scaledSpaceBefore.X), this._destRect.Y, Bridge.Int.clip32(this._scaledSpaceBefore.X), this._destRect.Height), spaceColor.$clone());
                }
                if (this.SpaceBefore.Y > 0) {
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(GeonBit.UI.Resources.WhiteTexture, new Microsoft.Xna.Framework.Rectangle.$ctor2(this._destRect.X, Bridge.Int.clip32(this._destRect.Top - this._scaledSpaceBefore.Y), this._destRect.Width, Bridge.Int.clip32(this._scaledSpaceBefore.Y)), spaceColor.$clone());
                }

                // draw space after
                spaceColor = new Microsoft.Xna.Framework.Color.$ctor9(0.5, 0.0, 0.5, 0.5);
                if (this.SpaceAfter.X > 0) {
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(GeonBit.UI.Resources.WhiteTexture, new Microsoft.Xna.Framework.Rectangle.$ctor2(this._destRect.Right, this._destRect.Y, Bridge.Int.clip32(this._scaledSpaceAfter.X), this._destRect.Height), spaceColor.$clone());
                }
                if (this.SpaceAfter.Y > 0) {
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(GeonBit.UI.Resources.WhiteTexture, new Microsoft.Xna.Framework.Rectangle.$ctor2(this._destRect.X, this._destRect.Bottom, this._destRect.Width, Bridge.Int.clip32(this._scaledSpaceAfter.Y)), spaceColor.$clone());
                }
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}    spriteBatch
             * @return  {void}
             */
            ...
            ToEntitiesDictionary: function () {
                var ret = { v : new (System.Collections.Generic.Dictionary$2(System.String,GeonBit.UI.Entities.Entity))() };
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}    spriteBatch    SpriteBatch used to draw entities.
             * @return  {void}
             */
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}    spriteBatch    Sprite batch to draw on.
             * @return  {void}
             */
            DrawEntityShadow: function (spriteBatch) {
                ...
                GeonBit.UI.UserInterface.Active.DrawUtils.StartDrawSilhouette(spriteBatch);
                this.DrawEntity(spriteBatch, GeonBit.UI.Entities.DrawPhase.Shadow);
                GeonBit.UI.UserInterface.Active.DrawUtils.EndDraw(spriteBatch);
            ...
            DrawEntityOutline: function (spriteBatch) {
                ...
                // set fill color
                this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.FillColor, new GeonBit.UI.DataTypes.StyleProperty.$ctor1(outlineColor.$clone()), oldState, false);
                ...
                this.DrawEntity(spriteBatch, GeonBit.UI.Entities.DrawPhase.Outline);
                ...
                this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.FillColor, new GeonBit.UI.DataTypes.StyleProperty.$ctor1(oldFill.$clone()), oldState, false);
             ...
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}    spriteBatch    SpriteBatch to draw on.
             * @param   {GeonBit.UI.Entities.DrawPhase}           phase          The phase we are currently drawing.
             * @return  {void}
             */
            ...
            OnAfterDraw: function (spriteBatch) {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.AfterDraw, null) ? GeonBit.UI.UserInterface.Active.AfterDraw(this) : null;
            },
            /**
            ...
            OnBeforeDraw: function (spriteBatch) {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.BeforeDraw, null) ? GeonBit.UI.UserInterface.Active.BeforeDraw(this) : null;
            },
            /**
             * Add a child entity.
             *
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Entities.Entity}    child                 Entity to add as child.
             ...
             * @return  {GeonBit.UI.Entities.Entity}                          The newly added entity.
             */
            AddChild: function (child, inheritParentState, index) {
                ...
                if (child._parent != null) {
                    if (GeonBit.UI.UserInterface.Active.SilentSoftErrors) {
                        return child;
                    }
                    throw new GeonBit.UI.Exceptions.InvalidStateException.$ctor1("Child element to add already got a parent!");
                }
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Entities.Entity}    child    Entity to remove.
             * @return  {void}
             */
            RemoveChild: function (child) {
                ...
                if (!Bridge.referenceEquals(child._parent, this)) {
                    ...
                    throw new GeonBit.UI.Exceptions.InvalidStateException.$ctor1("Child element to remove does not belong to this entity!");
                }
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Animators.IAnimator}    animator    Animator to attach.
             * @return  {GeonBit.UI.Animators.IAnimator}
             */
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Animators.IAnimator}    animator    Animator to remove.
             * @return  {void}
             */
            ...
            CalcActualSizeInPixels: function (size) {
                ...
                var parentDest = GeonBit.UI.UserInterface.Active.Root._destRect.$clone();
                if (this._parent != null) {
            ...
            CalcDestRect: function () {
                ...
                var parent = this._parent;
                if (parent == null) {
                    parent = GeonBit.UI.UserInterface.Active.Root;
                }
                ...
                if (this._draggable && !this._needToSetDragOffset) {
                    anchor = GeonBit.UI.Entities.Anchor.TopLeft;
                    offset = this._dragOffset.$clone();
                }

                // calculate position based on anchor, parent and offset
                switch (anchor) {
                    case GeonBit.UI.Entities.Anchor.Auto: 
                    case GeonBit.UI.Entities.Anchor.AutoInline: 
                    case GeonBit.UI.Entities.Anchor.AutoInlineNoBreak: 
                    case GeonBit.UI.Entities.Anchor.TopLeft: 
                        ret.X = (parent_left + Bridge.Int.clip32(offset.X)) | 0;
                        ret.Y = (parent_top + Bridge.Int.clip32(offset.Y)) | 0;
                        break;
                    case GeonBit.UI.Entities.Anchor.TopRight: 
                        ret.X = (((parent_right - ret.Width) | 0) - Bridge.Int.clip32(offset.X)) | 0;
                        ret.Y = (parent_top + Bridge.Int.clip32(offset.Y)) | 0;
                        break;
                    case GeonBit.UI.Entities.Anchor.TopCenter: 
                    case GeonBit.UI.Entities.Anchor.AutoCenter: 
                        ret.X = (((parent_center_x - ((Bridge.Int.div(ret.Width, 2)) | 0)) | 0) + Bridge.Int.clip32(offset.X)) | 0;
                        ret.Y = (parent_top + Bridge.Int.clip32(offset.Y)) | 0;
                        break;
                    case GeonBit.UI.Entities.Anchor.BottomLeft: 
                        ret.X = (parent_left + Bridge.Int.clip32(offset.X)) | 0;
                        ret.Y = (((parent_bottom - ret.Height) | 0) - Bridge.Int.clip32(offset.Y)) | 0;
                        break;
                    case GeonBit.UI.Entities.Anchor.BottomRight: 
                        ret.X = (((parent_right - ret.Width) | 0) - Bridge.Int.clip32(offset.X)) | 0;
                        ret.Y = (((parent_bottom - ret.Height) | 0) - Bridge.Int.clip32(offset.Y)) | 0;
                        break;
                    case GeonBit.UI.Entities.Anchor.BottomCenter: 
                        ret.X = (((parent_center_x - ((Bridge.Int.div(ret.Width, 2)) | 0)) | 0) + Bridge.Int.clip32(offset.X)) | 0;
                        ret.Y = (((parent_bottom - ret.Height) | 0) - Bridge.Int.clip32(offset.Y)) | 0;
                        break;
                    case GeonBit.UI.Entities.Anchor.CenterLeft: 
                        ret.X = (parent_left + Bridge.Int.clip32(offset.X)) | 0;
                        ret.Y = (((parent_center_y - ((Bridge.Int.div(ret.Height, 2)) | 0)) | 0) + Bridge.Int.clip32(offset.Y)) | 0;
                        break;
                    case GeonBit.UI.Entities.Anchor.CenterRight: 
                        ret.X = (((parent_right - ret.Width) | 0) - Bridge.Int.clip32(offset.X)) | 0;
                        ret.Y = (((parent_center_y - ((Bridge.Int.div(ret.Height, 2)) | 0)) | 0) + Bridge.Int.clip32(offset.Y)) | 0;
                        break;
                    case GeonBit.UI.Entities.Anchor.Center: 
                        ret.X = (((parent_center_x - ((Bridge.Int.div(ret.Width, 2)) | 0)) | 0) + Bridge.Int.clip32(offset.X)) | 0;
                        ret.Y = (((parent_center_y - ((Bridge.Int.div(ret.Height, 2)) | 0)) | 0) + Bridge.Int.clip32(offset.Y)) | 0;
                        break;
                }
                ...
                if ((anchor === GeonBit.UI.Entities.Anchor.Auto || anchor === GeonBit.UI.Entities.Anchor.AutoInline || anchor === GeonBit.UI.Entities.Anchor.AutoCenter || anchor === GeonBit.UI.Entities.Anchor.AutoInlineNoBreak)) {
                    ...
                    if (prevEntity != null) {
                        ...
                        // handle inline align
                        if (anchor === GeonBit.UI.Entities.Anchor.AutoInline || anchor === GeonBit.UI.Entities.Anchor.AutoInlineNoBreak) {
                        ...
                        if ((anchor === GeonBit.UI.Entities.Anchor.AutoInline && ret.Right > parent._destRectInternal.Right) || (anchor === GeonBit.UI.Entities.Anchor.Auto || anchor === GeonBit.UI.Entities.Anchor.AutoCenter)) {
                            // align x
                            if (anchor !== GeonBit.UI.Entities.Anchor.AutoCenter) {
                                ret.X = (parent_left + Bridge.Int.clip32(offset.X)) | 0;
                            }
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Entities.Entity}    other    Entity to propagate events to.
             * @return  {void}
             */
             ...
             * @return  {GeonBit.UI.Entities.Entity}                      Entity before this in parent, or null if first in parent or if orphan entity.
             */
            ...
            DoOnMouseDown: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnMouseDown, null) ? GeonBit.UI.UserInterface.Active.OnMouseDown(this) : null;
            },
            /**
            ...
            DoOnMouseReleased: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnMouseReleased, null) ? GeonBit.UI.UserInterface.Active.OnMouseReleased(this) : null;
            },
            /**
            ...
            DoOnClick: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnClick, null) ? GeonBit.UI.UserInterface.Active.OnClick(this) : null;
            },
            /**
            ...
            DoWhileMouseDown: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.WhileMouseDown, null) ? GeonBit.UI.UserInterface.Active.WhileMouseDown(this) : null;
            },
            /**
            ...
            DoWhileMouseHover: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.WhileMouseHover, null) ? GeonBit.UI.UserInterface.Active.WhileMouseHover(this) : null;
            },
            /**
            ...
            DoWhileMouseHoverOrDown: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.WhileMouseHoverOrDown, null) ? GeonBit.UI.UserInterface.Active.WhileMouseHoverOrDown(this) : null;

                // do right mouse click event
                if (this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonClick(GeonBit.UI.MouseButton.Right)) {
                    !Bridge.staticEquals(this.OnRightClick, null) ? this.OnRightClick(this) : null;
                    !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnRightClick, null) ? GeonBit.UI.UserInterface.Active.OnRightClick(this) : null;
                } else if (this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonPressed(GeonBit.UI.MouseButton.Right)) {
                    !Bridge.staticEquals(this.OnRightMouseDown, null) ? this.OnRightMouseDown(this) : null;
                    !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnRightMouseDown, null) ? GeonBit.UI.UserInterface.Active.OnRightMouseDown(this) : null;
                } else if (this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonDown(GeonBit.UI.MouseButton.Right)) {
                    !Bridge.staticEquals(this.WhileRightMouseDown, null) ? this.WhileRightMouseDown(this) : null;
                    !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.WhileRightMouseDown, null) ? GeonBit.UI.UserInterface.Active.WhileRightMouseDown(this) : null;
                }
            },
            /**
            ...
            DoOnValueChange: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnValueChange, null) ? GeonBit.UI.UserInterface.Active.OnValueChange(this) : null;
            },
            /**
            ...
            DoOnMouseEnter: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnMouseEnter, null) ? GeonBit.UI.UserInterface.Active.OnMouseEnter(this) : null;
            },
            /**
            ...
            DoOnMouseLeave: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnMouseLeave, null) ? GeonBit.UI.UserInterface.Active.OnMouseLeave(this) : null;
            },
            /**
            ...
            DoOnStartDrag: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnStartDrag, null) ? GeonBit.UI.UserInterface.Active.OnStartDrag(this) : null;
            },
            /**
            ...
            DoOnStopDrag: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnStopDrag, null) ? GeonBit.UI.UserInterface.Active.OnStopDrag(this) : null;
            },
            /**
            ...
            DoWhileDragging: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.WhileDragging, null) ? GeonBit.UI.UserInterface.Active.WhileDragging(this) : null;
            },
            /**
            ...
            DoOnMouseWheelScroll: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnMouseWheelScroll, null) ? GeonBit.UI.UserInterface.Active.OnMouseWheelScroll(this) : null;
            },
            /**
            ...
            DoAfterUpdate: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.AfterUpdate, null) ? GeonBit.UI.UserInterface.Active.AfterUpdate(this) : null;
            },
            /**
            ...
            DoOnVisibilityChange: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnVisiblityChange, null) ? GeonBit.UI.UserInterface.Active.OnVisiblityChange(this) : null;
            },
            /**
            ...
            DoBeforeUpdate: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.BeforeUpdate, null) ? GeonBit.UI.UserInterface.Active.BeforeUpdate(this) : null;
            },
            /**
            ...
            DoOnFocusChange: function () {
                ...
                !Bridge.staticEquals(GeonBit.UI.UserInterface.Active.OnFocusChange, null) ? GeonBit.UI.UserInterface.Active.OnFocusChange(this) : null;
            },
            /**
            ...
            UpdateAnimators: function (recursive) {
                ...
                this._animators.RemoveAll($asm.$.GeonBit.UI.Entities.Entity.f2);
             ...
             * @this GeonBit.UI.Entities.Entity
             * @memberof GeonBit.UI.Entities.Entity
             * @param   {GeonBit.UI.Entities.Entity}       targetEntity        The deepest child entity with highest priority that we point on and can be interacted with.
             * @param   {GeonBit.UI.Entities.Entity}       dragTargetEntity    The deepest child dragable entity with highest priority that we point on and can be drag if mouse down.
            ...
            Update: function (targetEntity, dragTargetEntity, wasEventHandled, scrollVal) {
                ...
                if (this._isCurrentlyDisabled || this.IsLocked() || !this.IsVisible()) {
                    ...
                    if (this._isInteractable) {
                        ...
                        if (this._entityState === GeonBit.UI.Entities.EntityState.MouseHover) {
                            this.DoOnMouseLeave();
                        } else if (this._entityState === GeonBit.UI.Entities.EntityState.MouseDown) {
                ...
                if (!wasEventHandled.v) {
                    ...
                    if (!this.InheritParentState) {
                        ...
                        if (this.IsTouching(mousePos.$clone())) {
                            ...
                            // update mouse state
                            this._entityState = (this.IsFocused || this.PromiscuousClicksMode || this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonPressed(0)) && this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonDown(0) ? GeonBit.UI.Entities.EntityState.MouseDown : GeonBit.UI.Entities.EntityState.MouseHover;
                        }
                    }

                    // set if focused
                    if (this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonPressed(0)) {
                        this.IsFocused = this._isMouseOver;
                    }
                } else if (this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonClick(0)) {
                ...
                if ((this._draggable || this.IsNaturallyInteractable()) && dragTargetEntity.v == null && this._isMouseOver && this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonPressed(GeonBit.UI.MouseButton.Left)) {
                ...
                if (Bridge.referenceEquals(targetEntity.v, this)) {
                    ...
                    if (prevState !== this._entityState) {
                        ...
                        // mouse up
                        if (this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonReleased(0)) {
                            this.DoOnMouseReleased();
                        }
                        // mouse click
                        if (this.MouseInput.GeonBit$UI$IMouseInput$MouseButtonClick(0)) {
                            this.DoOnClick();
                        }
                    }

                    // call the while-mouse-down / while-mouse-hover events
                    if (this._entityState === GeonBit.UI.Entities.EntityState.MouseDown) {
                ...
                if (Bridge.referenceEquals(targetEntity.v, this) || Bridge.referenceEquals(GeonBit.UI.UserInterface.Active.ActiveEntity, this)) {
                    if (this.MouseInput.GeonBit$UI$IMouseInput$MouseWheelChange !== 0) {
                ...
                if (this._draggable && (Bridge.referenceEquals(dragTargetEntity.v, this)) && this.IsFocused) {
                    ...
                    if (!this._isBeingDragged && this.MouseInput.GeonBit$UI$IMouseInput$MousePositionDiff.Length() !== 0) {
                    ...
                    if (this._isBeingDragged) {
                        ...
                        this._dragOffset = Microsoft.Xna.Framework.Vector2.op_Addition(this._dragOffset.$clone(), this.MouseInput.GeonBit$UI$IMouseInput$MousePositionDiff.$clone());
    ...
    Bridge.ns("GeonBit.UI.Entities.Entity", $asm.$);

    Bridge.apply($asm.$.GeonBit.UI.Entities.Entity, {
        f1: function (x, y) {
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.ButtonSkin
     */
    Bridge.define("GeonBit.UI.Entities.ButtonSkin", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.ButtonSkin
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.Entities.ButtonSkin
                 */
                Default: 0,
                /**
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.DrawPhase
     */
    Bridge.define("GeonBit.UI.Entities.DrawPhase", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.DrawPhase
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.Entities.DrawPhase
                 */
                Base: 0,
                /**
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.EntityState
     */
    Bridge.define("GeonBit.UI.Entities.EntityState", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.EntityState
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.Entities.EntityState
                 */
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.FontStyle
     */
    Bridge.define("GeonBit.UI.Entities.FontStyle", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.FontStyle
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.Entities.FontStyle
                 */
                Regular: 0,
                /**
                 * Bold font.
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.IconType
     */
    Bridge.define("GeonBit.UI.Entities.IconType", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.IconType
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.Entities.IconType
                 */
                Sword: 0,
                /**
                 * 'Shield' Icon.
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.ImageDrawMode
     */
    Bridge.define("GeonBit.UI.Entities.ImageDrawMode", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.ImageDrawMode
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.Entities.ImageDrawMode
                 */
                Stretch: 0,
                /**
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.PanelOverflowBehavior
     */
    Bridge.define("GeonBit.UI.Entities.PanelOverflowBehavior", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.PanelOverflowBehavior
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.Entities.PanelOverflowBehavior
                 */
                Overflow: 0,
                /**
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.PanelSkin
     */
    Bridge.define("GeonBit.UI.Entities.PanelSkin", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.PanelSkin
                 * @constant
                 * @default -1
    ...
    Bridge.define("GeonBit.UI.Entities.ParagraphData", {
        $kind: "struct",
        statics: {
            methods: {
                getDefaultValue: function () { return new GeonBit.UI.Entities.ParagraphData(); }
            }
        },
        fields: {
            list: null,
        ...
        methods: {
            ...
            equals: function (o) {
                if (!Bridge.is(o, GeonBit.UI.Entities.ParagraphData)) {
                    return false;
                }
                return Bridge.equals(this.list, o.list) && Bridge.equals(this.relativeIndex, o.relativeIndex);
            },
            $clone: function (to) {
                var s = to || new GeonBit.UI.Entities.ParagraphData();
                s.list = this.list;
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.RichParagraphStyleInstruction
     */
    Bridge.define("GeonBit.UI.Entities.RichParagraphStyleInstruction", {
        $kind: "struct",
        statics: {
            fields: {
                /**
                 ...
                 *
                 * @static
                 * @memberof GeonBit.UI.Entities.RichParagraphStyleInstruction
            ...
            ctors: {
                init: function () {
                    this._instructions = new (System.Collections.Generic.Dictionary$2(System.String,GeonBit.UI.Entities.RichParagraphStyleInstruction))();
                },
                ctor: function () {
                    // set style instructions denotes
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.SetStyleInstructionsDenotes("{{", "}}");

                    // reset all properties
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("DEFAULT", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(void 0, void 0, void 0, void 0, true));

                    // add color-changing instructions
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("RED", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Red, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("BLUE", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Blue, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("GREEN", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Green, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("YELLOW", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Yellow, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("BROWN", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Brown, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("BLACK", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Black, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("WHITE", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.White, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("CYAN", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Cyan, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("PINK", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Pink, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("GRAY", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Gray, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("MAGENTA", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Magenta, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("ORANGE", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Orange, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("PURPLE", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Purple, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("SILVER", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Silver, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("GOLD", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Gold, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("TEAL", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Teal, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("NAVY", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.Navy, void 0, void 0, void 0, false));

                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("L_RED", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.PaleVioletRed, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("L_BLUE", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.AliceBlue, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("L_GREEN", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.LawnGreen, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("L_YELLOW", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.LightYellow, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("L_BROWN", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.RosyBrown, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("L_CYAN", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.LightCyan, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("L_PINK", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.LightPink, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("L_GRAY", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.LightGray, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("L_GOLD", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.LightGoldenrodYellow, void 0, void 0, void 0, false));

                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("D_RED", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.DarkRed, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("D_BLUE", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.DarkBlue, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("D_GREEN", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.ForestGreen, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("D_YELLOW", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.GreenYellow, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("D_BROWN", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.SaddleBrown, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("D_CYAN", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.DarkCyan, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("D_PINK", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.DeepPink, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("D_GRAY", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.DarkGray, void 0, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("D_GOLD", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(Microsoft.Xna.Framework.Color.DarkGoldenrod, void 0, void 0, void 0, false));

                    // add font style change instructions
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("BOLD", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(void 0, GeonBit.UI.Entities.FontStyle.Bold, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("REGULAR", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(void 0, GeonBit.UI.Entities.FontStyle.Regular, void 0, void 0, false));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction.AddInstruction("ITALIC", new GeonBit.UI.Entities.RichParagraphStyleInstruction.$ctor1(void 0, GeonBit.UI.Entities.FontStyle.Italic, void 0, void 0, false));
                }
            },
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this GeonBit.UI.Entities.RichParagraphStyleInstruction
                 * @memberof GeonBit.UI.Entities.RichParagraphStyleInstruction
                 * @param   {string}                                               key            Key to invoke this style change.
                 * @param   {GeonBit.UI.Entities.RichParagraphStyleInstruction}    instruction    Style change data.
                 * @return  {void}
                 */
                AddInstruction: function (key, instruction) {
                    GeonBit.UI.Entities.RichParagraphStyleInstruction._instructions.set(key, instruction.$clone());
                },
                /**
                ...
                SetStyleInstructionsDenotes: function (opening, closing) {
                    GeonBit.UI.Entities.RichParagraphStyleInstruction._styleInstructionsRegex = new System.Text.RegularExpressions.Regex.ctor((opening || "") + "[^{}]*" + (closing || ""));
                    GeonBit.UI.Entities.RichParagraphStyleInstruction._styleInstructionsOpening = opening;
                    GeonBit.UI.Entities.RichParagraphStyleInstruction._styleInstructionsClosing = closing;
                },
                getDefaultValue: function () { return new GeonBit.UI.Entities.RichParagraphStyleInstruction(); }
            }
        },
        props: {
            /**
        ...
        ctors: {
             ...
             * @param   {?GeonBit.UI.Entities.FontStyle}    fontStyle       Set font style.
        ...
        methods: {
            ...
            equals: function (o) {
                if (!Bridge.is(o, GeonBit.UI.Entities.RichParagraphStyleInstruction)) {
                    return false;
                }
            ...
            $clone: function (to) {
                var s = to || new GeonBit.UI.Entities.RichParagraphStyleInstruction();
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.SliderSkin
     */
    Bridge.define("GeonBit.UI.Entities.SliderSkin", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.SliderSkin
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.Entities.SliderSkin
                 */
                Default: 0,
                /**
     ...
     * @static
     * @abstract
     * @class GeonBit.UI.Entities.StylePropertyIds
     */
    Bridge.define("GeonBit.UI.Entities.StylePropertyIds", {
        statics: {
            fields: {
                SpaceAfter: null,
                SpaceBefore: null,
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.TabData
     */
    Bridge.define("GeonBit.UI.Entities.TabData", {
        fields: {
            /**
             * The tab panel.
             *
             * @instance
             * @public
             * @memberof GeonBit.UI.Entities.TabData
             * @type GeonBit.UI.Entities.Panel
             */
            panel: null,
            /**
             * The tab top button.
             ...
             * @public
             * @memberof GeonBit.UI.Entities.TabData
             * @type GeonBit.UI.Entities.Button
             */
            button: null,
            /**
             * Tab identifier / name.
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.TabData
             * @memberof GeonBit.UI.Entities.TabData
             * @param   {string}                        tabName      Tab name / identifier.
             * @param   {GeonBit.UI.Entities.Panel}     tabPanel     Tab panel.
             * @param   {GeonBit.UI.Entities.Button}    tabButton    Tab button.
             * @return  {void}
             */
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.TextValidators.ITextValidator
     */
    Bridge.define("GeonBit.UI.Entities.TextValidators.ITextValidator", {
        methods: {
            /**
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.TextValidators.ITextValidator
             * @memberof GeonBit.UI.Entities.TextValidators.ITextValidator
     ...
     *
     * @public
     * @class GeonBit.UI.Exceptions.InvalidStateException
     * @augments System.Exception
     */
    Bridge.define("GeonBit.UI.Exceptions.InvalidStateException", {
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Exceptions.InvalidStateException
             * @memberof GeonBit.UI.Exceptions.InvalidStateException
             * @return  {void}
             */
            ctor: function () {
                this.$initialize();
     ...
     *
     * @public
     * @class GeonBit.UI.Exceptions.InvalidValueException
     * @augments System.Exception
     */
    Bridge.define("GeonBit.UI.Exceptions.InvalidValueException", {
        inherits: [System.Exception],
        ctors: {
            /**
             * Create the exception without message.
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Exceptions.InvalidValueException
             * @memberof GeonBit.UI.Exceptions.InvalidValueException
             * @return  {void}
             */
            ctor: function () {
                this.$initialize();
     ...
     *
     * @public
     * @class GeonBit.UI.Exceptions.NotFoundException
     * @augments System.Exception
     */
    Bridge.define("GeonBit.UI.Exceptions.NotFoundException", {
        inherits: [System.Exception],
        ctors: {
            /**
             * Create the exception without message.
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Exceptions.NotFoundException
             * @memberof GeonBit.UI.Exceptions.NotFoundException
             * @return  {void}
             */
            ctor: function () {
                this.$initialize();
     ...
     *
     * @public
     * @class GeonBit.UI.MouseButton
     */
    Bridge.define("GeonBit.UI.MouseButton", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.MouseButton
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.MouseButton
                 */
                Left: 0,
                /**
                 * Right mouse button.
    ...
    Bridge.define("GeonBit.UI.ResolutionMouseProvider.State", {
        $kind: "nested struct",
        statics: {
            methods: {
                getDefaultValue: function () { return new GeonBit.UI.ResolutionMouseProvider.State(); }
            }
        },
        props: {
            X: 0,
        ...
        methods: {
            ...
            equals: function (o) {
                if (!Bridge.is(o, GeonBit.UI.ResolutionMouseProvider.State)) {
                    return false;
                }
            ...
            $clone: function (to) {
                var s = to || new GeonBit.UI.ResolutionMouseProvider.State();
                s.X = this.X;
                s.Y = this.Y;
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.Resources
     */
    Bridge.define("GeonBit.UI.Resources", {
        statics: {
            fields: {
                /**
                 ...
                 * @public
                 * @memberof GeonBit.UI.Resources
                 * @type GeonBit.UI.TexturesGetter$1
                 */
                Cursors: null,
                /**
                 ...
                 * @public
                 * @memberof GeonBit.UI.Resources
                 * @type Array.<GeonBit.UI.DataTypes.CursorTextureData>
                 */
                CursorsData: null,
                /**
                 ...
                 * @public
                 * @memberof GeonBit.UI.Resources
                 * @type Array.<GeonBit.UI.DataTypes.TextureData>
                 */
                PanelData: null,
                /**
                 ...
                 * @public
                 * @memberof GeonBit.UI.Resources
                 * @type GeonBit.UI.DataTypes.TextureData
                 */
            ...
            ctors: {
                init: function () {
                    ...
                    this.Cursors = new (GeonBit.UI.TexturesGetter$1(GeonBit.UI.CursorType))("textures/cursor_");
                    this.PanelTextures = new (GeonBit.UI.TexturesGetter$1(GeonBit.UI.Entities.PanelSkin))("textures/panel_");
                    this.ButtonTextures = new (GeonBit.UI.TexturesGetter$1(GeonBit.UI.Entities.ButtonSkin))("textures/button_");
                    this.CheckBoxTextures = new (GeonBit.UI.TexturesGetter$1(GeonBit.UI.Entities.EntityState))("textures/checkbox");
                    this.RadioTextures = new (GeonBit.UI.TexturesGetter$1(GeonBit.UI.Entities.EntityState))("textures/radio");
                    this.SliderTextures = new (GeonBit.UI.TexturesGetter$1(GeonBit.UI.Entities.SliderSkin))("textures/slider_");
                    this.SliderMarkTextures = new (GeonBit.UI.TexturesGetter$1(GeonBit.UI.Entities.SliderSkin))("textures/slider_", "_mark");
                    this.IconTextures = new (GeonBit.UI.TexturesGetter$1(GeonBit.UI.Entities.IconType))("textures/icons/");
                }
            },
            methods: {
                /**
                ...
                LoadContent: function (content, theme) {
                    ...
                    GeonBit.UI.Resources.InitialiseCharStringDict();

                    // set resources root path and store content manager
                    GeonBit.UI.Resources._root = "GeonBit.UI/themes/" + (theme || "") + "/";
                    GeonBit.UI.Resources._content = content;

                    // set Texture2D static fields
                    GeonBit.UI.Resources.HorizontalLineTexture = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, (GeonBit.UI.Resources._root || "") + "textures/horizontal_line");
                    GeonBit.UI.Resources.WhiteTexture = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, (GeonBit.UI.Resources._root || "") + "textures/white_texture");
                    GeonBit.UI.Resources.IconBackgroundTexture = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, (GeonBit.UI.Resources._root || "") + "textures/icons/background");
                    GeonBit.UI.Resources.VerticalScrollbarTexture = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, (GeonBit.UI.Resources._root || "") + "textures/scrollbar");
                    GeonBit.UI.Resources.VerticalScrollbarMarkTexture = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, (GeonBit.UI.Resources._root || "") + "textures/scrollbar_mark");
                    GeonBit.UI.Resources.ArrowDown = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, (GeonBit.UI.Resources._root || "") + "textures/arrow_down");
                    GeonBit.UI.Resources.ArrowUp = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, (GeonBit.UI.Resources._root || "") + "textures/arrow_up");
                    GeonBit.UI.Resources.ProgressBarTexture = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, (GeonBit.UI.Resources._root || "") + "textures/progressbar");
                    GeonBit.UI.Resources.ProgressBarFillTexture = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, (GeonBit.UI.Resources._root || "") + "textures/progressbar_fill");

                    // load cursors metadata
                    GeonBit.UI.Resources.CursorsData = System.Array.init(System.Enum.getValues(GeonBit.UI.CursorType).length, null, GeonBit.UI.DataTypes.CursorTextureData);
                    $t = Bridge.getEnumerator(System.Enum.getValues(GeonBit.UI.CursorType));
                    try {
                        while ($t.moveNext()) {
                            var cursor = Bridge.cast($t.Current, GeonBit.UI.CursorType);
                            var cursorName = GeonBit.UI.BridgeExtension.ToLowerInvariant(System.Enum.getName(GeonBit.UI.CursorType, Bridge.box(cursor, GeonBit.UI.CursorType, System.Enum.toStringFn(GeonBit.UI.CursorType))));
                            GeonBit.UI.Resources.CursorsData[System.Array.index(cursor, GeonBit.UI.Resources.CursorsData)] = content.Load(GeonBit.UI.DataTypes.CursorTextureData, (GeonBit.UI.Resources._root || "") + "textures/cursor_" + (cursorName || "") + "_md");
                        }
                    } finally {
                        if (Bridge.is($t, System.IDisposable)) {
                            $t.System$IDisposable$Dispose();
                    ...
                    // load panels
                    GeonBit.UI.Resources.PanelData = System.Array.init(System.Enum.getValues(GeonBit.UI.Entities.PanelSkin).length, null, GeonBit.UI.DataTypes.TextureData);
                    $t1 = Bridge.getEnumerator(System.Enum.getValues(GeonBit.UI.Entities.PanelSkin));
                    try {
                        while ($t1.moveNext()) {
                            var skin = Bridge.cast($t1.Current, GeonBit.UI.Entities.PanelSkin);
                            ...
                            var skinName = GeonBit.UI.BridgeExtension.ToLowerInvariant(System.Enum.toString(GeonBit.UI.Entities.PanelSkin, skin));
                            GeonBit.UI.Resources.PanelData[System.Array.index(skin, GeonBit.UI.Resources.PanelData)] = content.Load(GeonBit.UI.DataTypes.TextureData, (GeonBit.UI.Resources._root || "") + "textures/panel_" + (skinName || "") + "_md");
                        }
                    } finally {
                        if (Bridge.is($t1, System.IDisposable)) {
                            $t1.System$IDisposable$Dispose();
                    ...
                    GeonBit.UI.Resources.VerticalScrollbarData = content.Load(GeonBit.UI.DataTypes.TextureData, (GeonBit.UI.Resources._root || "") + "textures/scrollbar_md");

                    // load slider metadata
                    GeonBit.UI.Resources.SliderData = System.Array.init(System.Enum.getValues(GeonBit.UI.Entities.SliderSkin).length, null, GeonBit.UI.DataTypes.TextureData);
                    $t2 = Bridge.getEnumerator(System.Enum.getValues(GeonBit.UI.Entities.SliderSkin));
                    try {
                        while ($t2.moveNext()) {
                            var skin1 = Bridge.cast($t2.Current, GeonBit.UI.Entities.SliderSkin);
                            var skinName1 = GeonBit.UI.BridgeExtension.ToLowerInvariant(System.Enum.toString(GeonBit.UI.Entities.SliderSkin, skin1));
                            GeonBit.UI.Resources.SliderData[System.Array.index(skin1, GeonBit.UI.Resources.SliderData)] = content.Load(GeonBit.UI.DataTypes.TextureData, (GeonBit.UI.Resources._root || "") + "textures/slider_" + (skinName1 || "") + "_md");
                        }
                    } finally {
                    ...
                    // load fonts
                    GeonBit.UI.Resources.Fonts = System.Array.init(System.Enum.getValues(GeonBit.UI.Entities.FontStyle).length, null, Microsoft.Xna.Framework.Graphics.SpriteFont);
                    $t3 = Bridge.getEnumerator(System.Enum.getValues(GeonBit.UI.Entities.FontStyle));
                    try {
                        while ($t3.moveNext()) {
                            var style = Bridge.cast($t3.Current, GeonBit.UI.Entities.FontStyle);
                            GeonBit.UI.Resources.Fonts[System.Array.index(style, GeonBit.UI.Resources.Fonts)] = content.Load(Microsoft.Xna.Framework.Graphics.SpriteFont, (GeonBit.UI.Resources._root || "") + "fonts/" + (System.Enum.toString(GeonBit.UI.Entities.FontStyle, style) || ""));
                            GeonBit.UI.Resources.Fonts[System.Array.index(style, GeonBit.UI.Resources.Fonts)].LineSpacing = (GeonBit.UI.Resources.Fonts[System.Array.index(style, GeonBit.UI.Resources.Fonts)].LineSpacing + 2) | 0;
                        }
                    } finally {
                    ...
                    GeonBit.UI.Resources.ButtonData = System.Array.init(System.Enum.getValues(GeonBit.UI.Entities.ButtonSkin).length, null, GeonBit.UI.DataTypes.TextureData);
                    $t4 = Bridge.getEnumerator(System.Enum.getValues(GeonBit.UI.Entities.ButtonSkin));
                    try {
                        while ($t4.moveNext()) {
                            var skin2 = Bridge.cast($t4.Current, GeonBit.UI.Entities.ButtonSkin);
                            var skinName2 = GeonBit.UI.BridgeExtension.ToLowerInvariant(System.Enum.toString(GeonBit.UI.Entities.ButtonSkin, skin2));
                            GeonBit.UI.Resources.ButtonData[System.Array.index(skin2, GeonBit.UI.Resources.ButtonData)] = content.Load(GeonBit.UI.DataTypes.TextureData, (GeonBit.UI.Resources._root || "") + "textures/button_" + (skinName2 || "") + "_md");
                        }
                    } finally {
                    ...
                    GeonBit.UI.Resources.ProgressBarData = content.Load(GeonBit.UI.DataTypes.TextureData, (GeonBit.UI.Resources._root || "") + "textures/progressbar_md");

                    // load effects
                    GeonBit.UI.Resources.DisabledEffect = content.Load(Microsoft.Xna.Framework.Graphics.Effect, (GeonBit.UI.Resources._root || "") + "effects/disabled");
                    GeonBit.UI.Resources.SilhouetteEffect = content.Load(Microsoft.Xna.Framework.Graphics.Effect, (GeonBit.UI.Resources._root || "") + "effects/silhouette");

                    // load default styleSheets
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Entity, "DefaultStyle"), "Entity", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Paragraph, "DefaultStyle"), "Paragraph", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Button, "DefaultStyle"), "Button", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Button, "DefaultParagraphStyle"), "ButtonParagraph", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.CheckBox, "DefaultStyle"), "CheckBox", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.CheckBox, "DefaultParagraphStyle"), "CheckBoxParagraph", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.ColoredRectangle, "DefaultStyle"), "ColoredRectangle", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.DropDown, "DefaultStyle"), "DropDown", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.DropDown, "DefaultParagraphStyle"), "DropDownParagraph", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.DropDown, "DefaultSelectedParagraphStyle"), "DropDownSelectedParagraph", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Header, "DefaultStyle"), "Header", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.HorizontalLine, "DefaultStyle"), "HorizontalLine", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Icon, "DefaultStyle"), "Icon", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Image, "DefaultStyle"), "Image", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Label, "DefaultStyle"), "Label", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Panel, "DefaultStyle"), "Panel", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.ProgressBar, "DefaultStyle"), "ProgressBar", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.ProgressBar, "DefaultFillStyle"), "ProgressBarFill", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.RadioButton, "DefaultStyle"), "RadioButton", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.RadioButton, "DefaultParagraphStyle"), "RadioButtonParagraph", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.SelectList, "DefaultStyle"), "SelectList", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.SelectList, "DefaultParagraphStyle"), "SelectListParagraph", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.Slider, "DefaultStyle"), "Slider", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.TextInput, "DefaultStyle"), "TextInput", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.TextInput, "DefaultParagraphStyle"), "TextInputParagraph", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.TextInput, "DefaultPlaceholderStyle"), "TextInputPlaceholder", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.VerticalScrollbar, "DefaultStyle"), "VerticalScrollbar", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.PanelTabs, "DefaultButtonStyle"), "PanelTabsButton", GeonBit.UI.Resources._root, content);
                    GeonBit.UI.Resources.LoadDefaultStyles(Bridge.ref(GeonBit.UI.Entities.PanelTabs, "DefaultButtonParagraphStyle"), "PanelTabsButtonParagraph", GeonBit.UI.Resources._root, content);
                },
                /**
                ...
                InitialiseCharStringDict: function () {
                    GeonBit.UI.Resources.charStringDict.clear();
                    ...
                    for (var i = 0; i < asciiValues.length; i = (i + 1) | 0) {
                        ...
                        GeonBit.UI.Resources.charStringDict.add(c, String.fromCharCode(c));
                    }
                },
                /**
                ...
                GetStringForChar: function (c) {
                    if (!GeonBit.UI.Resources.charStringDict.containsKey(c)) {
                        return String.fromCharCode(c);
                    }
                    return GeonBit.UI.Resources.charStringDict.get(c);
                },
                /**
                 ...
                 * @this GeonBit.UI.Resources
                 * @memberof GeonBit.UI.Resources
                 * @param   {GeonBit.UI.Entities.StyleSheet}                    sheet         StyleSheet to load.
                ...
                LoadDefaultStyles: function (sheet, entityName, themeRoot, content) {
                    ...
                    // load default styles
                    GeonBit.UI.Resources.FillDefaultStyles(sheet, GeonBit.UI.Entities.EntityState.Default, content.Load(GeonBit.UI.DataTypes.DefaultStyles, (stylesheetBase || "") + "-Default"));

                    // load mouse-hover styles
                    GeonBit.UI.Resources.FillDefaultStyles(sheet, GeonBit.UI.Entities.EntityState.MouseHover, content.Load(GeonBit.UI.DataTypes.DefaultStyles, (stylesheetBase || "") + "-MouseHover"));

                    // load mouse-down styles
                    GeonBit.UI.Resources.FillDefaultStyles(sheet, GeonBit.UI.Entities.EntityState.MouseDown, content.Load(GeonBit.UI.DataTypes.DefaultStyles, (stylesheetBase || "") + "-MouseDown"));
                },
                /**
                 ...
                 * @this GeonBit.UI.Resources
                 * @memberof GeonBit.UI.Resources
                 * @param   {GeonBit.UI.Entities.StyleSheet}        sheet     StyleSheet to fill.
                 * @param   {GeonBit.UI.Entities.EntityState}       state     State to fill values for.
                 * @param   {GeonBit.UI.DataTypes.DefaultStyles}    styles    Default styles, as loaded from xml file.
                 * @return  {void}
                 */
                FillDefaultStyles: function (sheet, state, styles) {
                    if (System.Nullable.liftne(Microsoft.Xna.Framework.Color.op_Inequality, System.Nullable.lift1("$clone", styles.FillColor), null)) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "FillColor", new GeonBit.UI.DataTypes.StyleProperty.$ctor1(System.Nullable.getValue(styles.FillColor)));
                    }
                    if (styles.FontStyle != null) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "FontStyle", new GeonBit.UI.DataTypes.StyleProperty.$ctor4(System.Nullable.getValue(styles.FontStyle)));
                    }
                    if (styles.ForceAlignCenter != null) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "ForceAlignCenter", new GeonBit.UI.DataTypes.StyleProperty.$ctor3(System.Nullable.getValue(styles.ForceAlignCenter)));
                    }
                    if (System.Nullable.liftne(Microsoft.Xna.Framework.Color.op_Inequality, System.Nullable.lift1("$clone", styles.OutlineColor), null)) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "OutlineColor", new GeonBit.UI.DataTypes.StyleProperty.$ctor1(System.Nullable.getValue(styles.OutlineColor)));
                    }
                    if (styles.OutlineWidth != null) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "OutlineWidth", new GeonBit.UI.DataTypes.StyleProperty.$ctor4(System.Nullable.getValue(styles.OutlineWidth)));
                    }
                    if (styles.Scale != null) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "Scale", new GeonBit.UI.DataTypes.StyleProperty.$ctor5(System.Nullable.getValue(styles.Scale)));
                    }
                    if (System.Nullable.liftne(Microsoft.Xna.Framework.Color.op_Inequality, System.Nullable.lift1("$clone", styles.SelectedHighlightColor), null)) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "SelectedHighlightColor", new GeonBit.UI.DataTypes.StyleProperty.$ctor1(System.Nullable.getValue(styles.SelectedHighlightColor)));
                    }
                    if (System.Nullable.liftne(Microsoft.Xna.Framework.Color.op_Inequality, System.Nullable.lift1("$clone", styles.ShadowColor), null)) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "ShadowColor", new GeonBit.UI.DataTypes.StyleProperty.$ctor1(System.Nullable.getValue(styles.ShadowColor)));
                    }
                    if (System.Nullable.liftne(Microsoft.Xna.Framework.Vector2.op_Inequality, System.Nullable.lift1("$clone", styles.ShadowOffset), null)) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "ShadowOffset", new GeonBit.UI.DataTypes.StyleProperty.$ctor2(System.Nullable.getValue(styles.ShadowOffset)));
                    }
                    if (System.Nullable.liftne(Microsoft.Xna.Framework.Vector2.op_Inequality, System.Nullable.lift1("$clone", styles.Padding), null)) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "Padding", new GeonBit.UI.DataTypes.StyleProperty.$ctor2(System.Nullable.getValue(styles.Padding)));
                    }
                    if (System.Nullable.liftne(Microsoft.Xna.Framework.Vector2.op_Inequality, System.Nullable.lift1("$clone", styles.SpaceBefore), null)) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "SpaceBefore", new GeonBit.UI.DataTypes.StyleProperty.$ctor2(System.Nullable.getValue(styles.SpaceBefore)));
                    }
                    if (System.Nullable.liftne(Microsoft.Xna.Framework.Vector2.op_Inequality, System.Nullable.lift1("$clone", styles.SpaceAfter), null)) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "SpaceAfter", new GeonBit.UI.DataTypes.StyleProperty.$ctor2(System.Nullable.getValue(styles.SpaceAfter)));
                    }
                    if (styles.ShadowScale != null) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "ShadowScale", new GeonBit.UI.DataTypes.StyleProperty.$ctor5(System.Nullable.getValue(styles.ShadowScale)));
                    }
                    if (System.Nullable.liftne(Microsoft.Xna.Framework.Vector2.op_Inequality, System.Nullable.lift1("$clone", styles.DefaultSize), null)) {
                        sheet.v.set((System.Enum.toString(GeonBit.UI.Entities.EntityState, state) || "") + "." + "DefaultSize", new GeonBit.UI.DataTypes.StyleProperty.$ctor2(System.Nullable.getValue(styles.DefaultSize)));
                    }
                }
            }
        }
     ...
     *
     * @class GeonBit.UI.SpecialChars
     */
    Bridge.define("GeonBit.UI.SpecialChars", {
        $kind: "enum",
        statics: {
            fields: {
                Null: 0,
     ...
     *
     * @public
     * @class GeonBit.UI.TexturesGetter$1
     */
    Bridge.define("GeonBit.UI.TexturesGetter$1", function (TEnum) { return {
        fields: {
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.TexturesGetter$1
             * @memberof GeonBit.UI.TexturesGetter$1
             * @param   {string}     path          Resource path, under geonbit.ui content.
        ...
        methods: {
            ...
            getItem: function (i) {
                ...
                if (this._loadedTextures[System.Array.index(indx, this._loadedTextures)] == null) {
                    var path = (GeonBit.UI.Resources._root || "") + (this._basepath || "") + (this.EnumToString(i) || "") + (this._suffix || "");
                    this._loadedTextures[System.Array.index(indx, this._loadedTextures)] = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, path);
                }
             ...
             * @memberof GeonBit.UI.TexturesGetter$1
             * @param   {TEnum}                                         i    Texture enum identifier.
             * @param   {GeonBit.UI.Entities.EntityState}               s    Entity state to get texture for.
             * @return  {Microsoft.Xna.Framework.Graphics.Texture2D}         Loaded texture.
             */
            getItem$1: function (i, s) {
                var indx = this.GetIndex(i, s);
                if (this._loadedTextures[System.Array.index(indx, this._loadedTextures)] == null) {
                    var path = (GeonBit.UI.Resources._root || "") + (this._basepath || "") + (this.EnumToString(i) || "") + (this._suffix || "") + (this.StateEnumToString(s) || "");
                    this._loadedTextures[System.Array.index(indx, this._loadedTextures)] = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, path);
                }
                return this._loadedTextures[System.Array.index(indx, this._loadedTextures)];
            },
             ...
             * @memberof GeonBit.UI.TexturesGetter$1
             * @param   {TEnum}                               i    
             * @param   {?GeonBit.UI.Entities.EntityState}    s
             * @return  {number}
             */
            ...
            EnumToString: function (e) {
                // entity state enum
                if (Bridge.referenceEquals(TEnum, GeonBit.UI.Entities.EntityState)) {
                    return this.StateEnumToString(System.Nullable.getValue(Bridge.cast(Bridge.unbox(e, GeonBit.UI.Entities.EntityState), System.Int32)));
                }

                // icon type enum
                if (Bridge.referenceEquals(TEnum, GeonBit.UI.Entities.IconType)) {
                    return System.Enum.getName(TEnum, e);
                }

                // all other type of enums
                return GeonBit.UI.BridgeExtension.ToLowerInvariant(System.Enum.getName(TEnum, e));
            },
            /**
             ...
             * @this GeonBit.UI.TexturesGetter$1
             * @memberof GeonBit.UI.TexturesGetter$1
             * @param   {GeonBit.UI.Entities.EntityState}    e
             * @return  {string}
             */
            StateEnumToString: function (e) {
                switch (e) {
                    case GeonBit.UI.Entities.EntityState.MouseDown: 
                        return "_down";
                    case GeonBit.UI.Entities.EntityState.MouseHover: 
                        return "_hover";
                    case GeonBit.UI.Entities.EntityState.Default: 
                        return "";
                }
                return null;
            }
    ...
    /**
     * @memberof GeonBit.UI
     * @callback GeonBit.UI.GenerateTooltipFunc
     * @param   {GeonBit.UI.Entities.Entity}    entity
     * @return  {GeonBit.UI.Entities.Entity}
     */

    /**
     * @memberof GeonBit.UI
     * @callback GeonBit.UI.DefaultParagraphGenerator
     * @param   {string}                              text      
     * @param   {GeonBit.UI.Entities.Anchor}          anchor    
     ...
     * @return  {GeonBit.UI.Entities.Paragraph}
     */
     ...
     *
     * @public
     * @class GeonBit.UI.UserInterface
     * @implements  System.IDisposable
     */
    Bridge.define("GeonBit.UI.UserInterface", {
        ...
        statics: {
            fields: {
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.UserInterface
                 * @constant
                 * @default "3.4.0.1"
                 * @type string
                 */
                 ...
                 * @public
                 * @memberof GeonBit.UI.UserInterface
                 * @type GeonBit.UI.DefaultParagraphGenerator
                 */
            ...
            ctors: {
                init: function () {
                    ...
                    this.DefaultParagraph = $asm.$.GeonBit.UI.UserInterface.f1;
            ...
            methods: {
                 ...
                 * @static
                 * @public
                 * @this GeonBit.UI.UserInterface
                 * @memberof GeonBit.UI.UserInterface
                 * @param   {Microsoft.Xna.Framework.Content.ContentManager}    contentManager    Content manager.
                 * @param   {string}                                            theme             Which UI theme to use (see options in Content/GeonBit.UI/themes/). This affect the appearance of all textures and effects.
                 * @return  {void}
                 */
                Initialize$1: function (contentManager, theme) {
                    if (theme === void 0) { theme = "hd"; }
                    // store the content manager
                    GeonBit.UI.UserInterface._content = contentManager;

                    // init resources (textures etc)
                    GeonBit.UI.Resources.LoadContent(GeonBit.UI.UserInterface._content, theme);

                    // create a default active user interface
                    GeonBit.UI.UserInterface.Active = new GeonBit.UI.UserInterface();
                },
                /**
                 * Initialize UI manager (mostly load resources and set some defaults).
                 *
                 ...
                 * @memberof GeonBit.UI.UserInterface
                 * @param   {Microsoft.Xna.Framework.Content.ContentManager}    contentManager    Content manager.
                 * @param   {GeonBit.UI.BuiltinThemes}                          theme             Which UI theme to use. This affect the appearance of all textures and effects.
                 * @return  {void}
                 */
                Initialize: function (contentManager, theme) {
                    GeonBit.UI.UserInterface.Initialize$1(contentManager, System.Enum.toString(GeonBit.UI.BuiltinThemes, theme));
                },
                /**
                 ...
                 * @this GeonBit.UI.UserInterface
                 * @memberof GeonBit.UI.UserInterface
                 * @param   {GeonBit.UI.Entities.Entity}    source    Source entity.
                 * @return  {GeonBit.UI.Entities.Entity}              Entity to use for tooltip text.
                 */
                DefaultGenerateTooltipFunc: function (source) {
                    ...
                    var tooltip = new GeonBit.UI.Entities.Paragraph.$ctor2(source.ToolTipText, 9, new Microsoft.Xna.Framework.Vector2.$ctor2(500, -1), void 0, void 0);
                    ...
                    tooltip.BeforeDraw = Bridge.fn.combine(tooltip.BeforeDraw, function (ent) {
                        ...
                        var position = GeonBit.UI.UserInterface.Active.GetTransformedCursorPos(new Microsoft.Xna.Framework.Vector2.$ctor2(((Bridge.Int.div(((-destRect.Width) | 0), 2)) | 0), ((((-destRect.Height) | 0) - 20) | 0)));

                        // make sure tooltip is not out of screen boundaries
                        var screenBounds = GeonBit.UI.UserInterface.Active.Root.GetActualDestRect();
                        ...
                        tooltip.SetAnchorAndOffset(GeonBit.UI.Entities.Anchor.TopLeft, Microsoft.Xna.Framework.Vector2.op_Division$1(position.$clone(), GeonBit.UI.UserInterface.Active.GlobalScale));
                    });
        ...
        fields: {
             ...
             * @public
             * @memberof GeonBit.UI.UserInterface
             * @type GeonBit.UI.GenerateTooltipFunc
             */
        ...
        props: {
             ...
             * @memberof GeonBit.UI.UserInterface
             * @function Root
             * @type GeonBit.UI.Entities.RootPanel
             */
            Root: null,
            /**
        ...
        ctors: {
            init: function () {
                ...
                this._defaultSpriteBatchWrapper = new GeonBit.UI.Utils.DefaultSpriteBatchWrapper();
                this._defaultGraphicDeviceWrapper = new GeonBit.UI.Utils.DefaultGraphicDeviceWrapper();
                this.ShowCursor = true;
                this.IncludeCursorInRenderTarget = true;
                this.GenerateTooltipFunc = GeonBit.UI.UserInterface.DefaultGenerateTooltipFunc;
            },
            /**
            ...
            ctor: function () {
                this.$initialize();
                // sanity test
                if (GeonBit.UI.UserInterface._content == null) {
                    throw new GeonBit.UI.Exceptions.InvalidStateException.$ctor1("Cannot create a UserInterface before calling UserInterface.Initialize()!");
                }

                // create default input providers
                this.MouseInputProvider = new GeonBit.UI.DefaultInputProvider();
                this.KeyboardInputProvider = new GeonBit.UI.DefaultInputProvider();

                // create draw utils
                this.DrawUtils = new GeonBit.UI.DrawUtils();

                // create the root panel
                this.Root = new GeonBit.UI.Entities.RootPanel();

                // set default cursor
                this.SetCursor(GeonBit.UI.CursorType.Default);
            }
        },
        methods: {
            /**
             ...
             * @this GeonBit.UI.UserInterface
             * @memberof GeonBit.UI.UserInterface
             * @param   {GeonBit.UI.CursorType}    type    What type of cursor to show.
             * @return  {void}
             */
            SetCursor: function (type) {
                var data = GeonBit.UI.Resources.CursorsData[System.Array.index(type, GeonBit.UI.Resources.CursorsData)];
                this.SetCursor$1(GeonBit.UI.Resources.Cursors.getItem(type), data.DrawWidth, new Microsoft.Xna.Framework.Point.$ctor2(data.OffsetX, data.OffsetY));
            },
            /**
             ...
             * @this GeonBit.UI.UserInterface
             * @memberof GeonBit.UI.UserInterface
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}    spriteBatch    SpriteBatch to draw the cursor.
             * @return  {void}
             */
            DrawCursor: function (spriteBatch) {
                // start drawing for cursor
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Begin(Microsoft.Xna.Framework.Graphics.SpriteSortMode.Deferred, this.BlendState, this.SamplerState, Microsoft.Xna.Framework.Graphics.DepthStencilState.None, Microsoft.Xna.Framework.Graphics.RasterizerState.CullCounterClockwise, void 0, void 0);
             ...
             * @this GeonBit.UI.UserInterface
             * @memberof GeonBit.UI.UserInterface
             * @param   {GeonBit.UI.Entities.Entity}    entity    Entity to add.
             * @return  {GeonBit.UI.Entities.Entity}
             */
             ...
             * @this GeonBit.UI.UserInterface
             * @memberof GeonBit.UI.UserInterface
             * @param   {GeonBit.UI.Entities.Entity}    entity    Entity to remove.
             * @return  {void}
             */
            ...
            Update: function (gameTime) {
                ...
                this.MouseInputProvider.GeonBit$UI$IMouseInput$Update(gameTime);
                if (!Bridge.referenceEquals(this.MouseInputProvider, this.KeyboardInputProvider)) {
                    this.KeyboardInputProvider.GeonBit$UI$IKeyboardInput$Update(gameTime);
                }

                // unset the drag target if the mouse was released
                if (this._dragTarget != null && !this.MouseInputProvider.GeonBit$UI$IMouseInput$MouseButtonDown(GeonBit.UI.MouseButton.Left)) {
                ...
                // set active entity
                if (this.MouseInputProvider.GeonBit$UI$IMouseInput$MouseButtonDown(GeonBit.UI.MouseButton.Left)) {
             ...
             * @memberof GeonBit.UI.UserInterface
             * @param   {Microsoft.Xna.Framework.GameTime}    gameTime    Current game time.
             * @param   {GeonBit.UI.Entities.Entity}          target      Current target entity.
             * @return  {void}
             */
            UpdateTooltipText: function (gameTime, target) {
                ...
                if (this._tooltipEntity == null) {
                    ...
                    if (this._timeUntilTooltip > GeonBit.UI.UserInterface.TimeToShowTooltipText) {
             ...
             */
            Draw: function (spriteBatch) {
                var newScreenWidth = spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.Viewport.Width;
                var newScreenHeight = spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.Viewport.Height;
                ...
                if (this.UseRenderTarget) {
                    ...
                    if (this._renderTarget == null || this._renderTarget.Width !== this.ScreenWidth || this._renderTarget.Height !== this.ScreenHeight) {
                        ...
                        this.DisposeRenderTarget();
                        this._renderTarget = new Microsoft.Xna.Framework.Graphics.RenderTarget2D.$ctor2(GeonBit.UI.Utils.GraphicDeviceWrapper.op_Implicit(spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice), this.ScreenWidth, this.ScreenHeight, false, spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.PresentationParameters.BackBufferFormat, spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.PresentationParameters.DepthStencilFormat, 0, Microsoft.Xna.Framework.Graphics.RenderTargetUsage.PreserveContents);
                    } else {
                        spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.SetRenderTarget(this._renderTarget);
                        spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.Clear(Microsoft.Xna.Framework.Color.Transparent.$clone());
                    }
                }
                ...
                // reset render target
                if (this.UseRenderTarget) {
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.SetRenderTarget(null);
                }
            },
            /**
            ...
            DrawMainRenderTarget: function (spriteBatch) {
                ...
                if (this.RenderTarget != null && !this.RenderTarget.IsDisposed) {
                    // draw render target
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Begin(Microsoft.Xna.Framework.Graphics.SpriteSortMode.Immediate, Microsoft.Xna.Framework.Graphics.BlendState.AlphaBlend, void 0, void 0, void 0, void 0, this.RenderTargetTransformMatrix);
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(this.RenderTarget, new Microsoft.Xna.Framework.Rectangle.$ctor2(0, 0, this.ScreenWidth, this.ScreenHeight), Microsoft.Xna.Framework.Color.White.$clone());
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$End();
                }
            ...
            GetTransformedCursorPos: function (addVector) {
                ...
                if (this.UseRenderTarget && System.Nullable.liftne(Microsoft.Xna.Framework.Matrix.op_Inequality, System.Nullable.lift1("$clone", this.RenderTargetTransformMatrix), null) && !this.IncludeCursorInRenderTarget) {
                    ...
                    return Microsoft.Xna.Framework.Vector2.op_Addition(this.MouseInputProvider.GeonBit$UI$IMouseInput$TransformMousePosition(matrix.$clone()), Microsoft.Xna.Framework.Vector2.Transform(System.Nullable.getValue(addVector).$clone(), matrix.$clone()));
                }

                // return raw cursor pos
                return Microsoft.Xna.Framework.Vector2.op_Addition(this.MouseInputProvider.GeonBit$UI$IMouseInput$MousePosition.$clone(), System.Nullable.getValue(addVector).$clone());
            }
        }
    });

    Bridge.ns("GeonBit.UI.UserInterface", $asm.$);

    Bridge.apply($asm.$.GeonBit.UI.UserInterface, {
        f1: function (text, anchor, color, scale, size, offset) {
            if (System.Nullable.liftne(Microsoft.Xna.Framework.Color.op_Inequality, System.Nullable.lift1("$clone", color), null)) {
                return new GeonBit.UI.Entities.RichParagraph.$ctor1(text, anchor, System.Nullable.getValue(color).$clone(), scale, System.Nullable.lift1("$clone", size), System.Nullable.lift1("$clone", offset));
            }
            return new GeonBit.UI.Entities.RichParagraph.$ctor2(text, anchor, System.Nullable.lift1("$clone", size), System.Nullable.lift1("$clone", offset), scale);
        }
    });
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.Utils.GraphicDeviceWrapper
     */
    Bridge.define("GeonBit.UI.Utils.GraphicDeviceWrapper", {
        statics: {
            methods: {
                /**
                 * @static
                 * @public
                 * @this GeonBit.UI.Utils.GraphicDeviceWrapper
                 * @memberof GeonBit.UI.Utils.GraphicDeviceWrapper
                 * @param   {GeonBit.UI.Utils.GraphicDeviceWrapper}              instance
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.Utils.ISpriteBatchWrapper
     */
    Bridge.define("GeonBit.UI.Utils.ISpriteBatchWrapper", {
        $kind: "interface"
    });
     ...
     *
     * @public
     * @class GeonBit.UI.Utils.Forms.Form
     */
    Bridge.define("GeonBit.UI.Utils.Forms.Form", {
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Utils.Forms.Form
                 * @default 10
                 * @type number
                 */
        ...
        ctors: {
            init: function () {
                this._fieldsData = new (System.Collections.Generic.Dictionary$2(System.String,GeonBit.UI.Utils.Forms.FormFieldData))();
                this._entities = new (System.Collections.Generic.Dictionary$2(System.String,GeonBit.UI.Entities.Entity))();
            },
            /**
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Utils.Forms.Form
             * @memberof GeonBit.UI.Utils.Forms.Form
             * @param   {System.Collections.Generic.IEnumerable$1}    fields    Fields to generate form from.
             * @param   {GeonBit.UI.Entities.Panel}                   parent    Optional panel to contain the result form.
             * @return  {void}
             */
            ctor: function (fields, parent) {
                ...
                this.$initialize();
                // create root panel
                this.FormPanel = new GeonBit.UI.Entities.Panel.$ctor1(new Microsoft.Xna.Framework.Vector2.$ctor2(0, -1), GeonBit.UI.Entities.PanelSkin.None, GeonBit.UI.Entities.Anchor.Auto);
                this.FormPanel.Padding = Microsoft.Xna.Framework.Vector2.Zero.$clone();

                // create fields
                $t = Bridge.getEnumerator(fields, GeonBit.UI.Utils.Forms.FormFieldData);
                try {
                    while ($t.moveNext()) {
                        ...
                        fieldEntity.v.SpaceAfter = Microsoft.Xna.Framework.Vector2.op_Addition(fieldEntity.v.SpaceAfter.$clone(), new Microsoft.Xna.Framework.Vector2.$ctor2(0, GeonBit.UI.Utils.Forms.Form.ExtraSpaceBetweenFields));

                        // add label
                        if (needLabel.v) {
                            var label = this.FormPanel.AddChild(new GeonBit.UI.Entities.Label.$ctor1(field.v.FieldLabel));
        ...
        methods: {
             ...
             * @this GeonBit.UI.Utils.Forms.Form
             * @memberof GeonBit.UI.Utils.Forms.Form
             * @param   {GeonBit.UI.Utils.Forms.FormFieldData}    fieldData    Field data to generate entity for.
            ...
            CreateEntityForField: function (fieldData, needLabel) {
                ...
                switch (fieldData.Type) {
                    case GeonBit.UI.Utils.Forms.FormFieldType.Checkbox: 
                        needLabel.v = false;
                        return new GeonBit.UI.Entities.CheckBox.$ctor1(fieldData.FieldLabel, 9, void 0, void 0, fieldData.DefaultValue != null && System.Nullable.getValue(Bridge.cast(Bridge.unbox((fieldData.DefaultValue), System.Boolean), System.Boolean)));
                    case GeonBit.UI.Utils.Forms.FormFieldType.DropDown: 
                        // create entity and set choices
                        var dropdown = new GeonBit.UI.Entities.DropDown.$ctor1(new Microsoft.Xna.Framework.Vector2.$ctor2(0, -1));
                        ...
                        return dropdown;
                    case GeonBit.UI.Utils.Forms.FormFieldType.MultilineTextInput: 
                        var multiText = new GeonBit.UI.Entities.TextInput.$ctor1(true);
                        multiText.Value = Bridge.as(fieldData.DefaultValue, System.String);
                        return multiText;
                    case GeonBit.UI.Utils.Forms.FormFieldType.TextInput: 
                        var text = new GeonBit.UI.Entities.TextInput.$ctor1(false);
                        if (fieldData.DefaultValue != null) {
                            text.Value = Bridge.as(fieldData.DefaultValue, System.String);
                        }
                        return text;
                    case GeonBit.UI.Utils.Forms.FormFieldType.Slider: 
                        var slider = new GeonBit.UI.Entities.Slider.$ctor1((fieldData.Min >>> 0), (fieldData.Max >>> 0));
                        ...
                        return slider;
                    case GeonBit.UI.Utils.Forms.FormFieldType.SelectList: 
                        // create the entity itself
                        var selectlist = new GeonBit.UI.Entities.SelectList.$ctor2(new Microsoft.Xna.Framework.Vector2.$ctor2(0, -1));
                        ...
                        return selectlist;
                    case GeonBit.UI.Utils.Forms.FormFieldType.RadioButtons: 
                        var radiosPanel = new GeonBit.UI.Entities.Panel.$ctor1(new Microsoft.Xna.Framework.Vector2.$ctor2(0, -1), GeonBit.UI.Entities.PanelSkin.None, GeonBit.UI.Entities.Anchor.Auto);
                        ...
                        try {
                            while ($t2.moveNext()) {
                                ...
                                var radio = new GeonBit.UI.Entities.RadioButton.$ctor1(choice2, 9, void 0, void 0, Bridge.referenceEquals((Bridge.as(fieldData.DefaultValue, System.String)), choice2));
                        ...
                        return radiosPanel;
                    case GeonBit.UI.Utils.Forms.FormFieldType.Section: 
                        var containerPanel = new GeonBit.UI.Entities.Panel.$ctor1(new Microsoft.Xna.Framework.Vector2.$ctor2(0, -1), GeonBit.UI.Entities.PanelSkin.None, GeonBit.UI.Entities.Anchor.Auto);
                        containerPanel.Padding = Microsoft.Xna.Framework.Vector2.Zero.$clone();
                        if (needLabel.v) {
                            containerPanel.AddChild(new GeonBit.UI.Entities.Paragraph.$ctor2(fieldData.FieldLabel));
                        }
                        containerPanel.AddChild(new GeonBit.UI.Entities.HorizontalLine.ctor());
                        needLabel.v = false;
                        return containerPanel;
                    default: 
                        throw new GeonBit.UI.Exceptions.InvalidStateException.$ctor1("Unknown field type!");
                }
            },
            /**
             ...
             * @return  {GeonBit.UI.Entities.Entity}               Field's root entity.
             */
            ...
            GetValue: function (fieldId, defaultVal) {
                ...
                switch (fieldData.Type) {
                    case GeonBit.UI.Utils.Forms.FormFieldType.Checkbox: 
                        return ApplyDefaultVal(Bridge.box(Bridge.cast((entity), GeonBit.UI.Entities.CheckBox).Checked, System.Boolean, System.Boolean.toString));
                    case GeonBit.UI.Utils.Forms.FormFieldType.DropDown: 
                        return ApplyDefaultVal(Bridge.cast((entity), GeonBit.UI.Entities.DropDown).SelectedValue);
                    case GeonBit.UI.Utils.Forms.FormFieldType.MultilineTextInput: 
                        return ApplyDefaultVal(Bridge.cast((entity), GeonBit.UI.Entities.TextInput).Value);
                    case GeonBit.UI.Utils.Forms.FormFieldType.TextInput: 
                        return ApplyDefaultVal(Bridge.cast((entity), GeonBit.UI.Entities.TextInput).Value);
                    case GeonBit.UI.Utils.Forms.FormFieldType.Slider: 
                        return ApplyDefaultVal(Bridge.box(Bridge.cast((entity), GeonBit.UI.Entities.Slider).Value, System.Int32));
                    case GeonBit.UI.Utils.Forms.FormFieldType.SelectList: 
                        return ApplyDefaultVal(Bridge.cast((entity), GeonBit.UI.Entities.SelectList).SelectedValue);
                    case GeonBit.UI.Utils.Forms.FormFieldType.RadioButtons: 
                        $t = Bridge.getEnumerator(Bridge.cast((entity), GeonBit.UI.Entities.Panel).Children, GeonBit.UI.Entities.Entity);
                        try {
                            while ($t.moveNext()) {
                                var child = $t.Current;
                                if (Bridge.is(child, GeonBit.UI.Entities.RadioButton) && Bridge.cast(child, GeonBit.UI.Entities.RadioButton).Checked) {
                                    return ApplyDefaultVal((Bridge.as(child, GeonBit.UI.Entities.RadioButton)).TextParagraph.Text);
                                }
                            }
                        } finally {
                            if (Bridge.is($t, System.IDisposable)) {
     ...
     * @param   {GeonBit.UI.Entities.Entity}    arg
     * @return  {void}
     */
     ...
     *
     * @public
     * @class GeonBit.UI.Utils.Forms.FormFieldData
     */
    Bridge.define("GeonBit.UI.Utils.Forms.FormFieldData", {
        fields: {
            /**
             * Field type.
             *
             * @instance
             * @public
             * @memberof GeonBit.UI.Utils.Forms.FormFieldData
             * @type GeonBit.UI.Utils.Forms.FormFieldType
             */
            Type: 0,
            /**
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Utils.Forms.FormFieldData
             * @memberof GeonBit.UI.Utils.Forms.FormFieldData
             * @param   {GeonBit.UI.Utils.Forms.FormFieldType}    type     Field type.
     ...
     *
     * @public
     * @class GeonBit.UI.Utils.Forms.FormFieldType
     */
    Bridge.define("GeonBit.UI.Utils.Forms.FormFieldType", {
        $kind: "enum",
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Utils.Forms.FormFieldType
                 * @constant
                 * @default 0
                 * @type GeonBit.UI.Utils.Forms.FormFieldType
                 */
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.Utils.MessageBox
     */
    Bridge.define("GeonBit.UI.Utils.MessageBox", {
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Utils.MessageBox
                 * @type Microsoft.Xna.Framework.Vector2
                 */
            ...
            props: {
                ...
                IsMsgBoxOpened: {
                    get: function () {
                        return GeonBit.UI.Utils.MessageBox.OpenedMsgBoxesCount > 0;
                    }
                }
            },
            ctors: {
            ...
            methods: {
                 ...
                 * @static
                 * @public
                 * @this GeonBit.UI.Utils.MessageBox
                 * @memberof GeonBit.UI.Utils.MessageBox
                ...
                ShowMsgBox: function (header, text, options, extraEntities, size, onDone, parent) {
                    ...
                    var buttonsPanel = new GeonBit.UI.Entities.Panel.$ctor1(new Microsoft.Xna.Framework.Vector2.$ctor2(0, 70), GeonBit.UI.Entities.PanelSkin.None, System.Nullable.getValue(size).Y === -1 ? GeonBit.UI.Entities.Anchor.Auto : GeonBit.UI.Entities.Anchor.BottomCenter);
                    ...
                    try {
                        while ($t2.moveNext()) {
                            ...
                            // add button entity
                            var button = new GeonBit.UI.Entities.Button.$ctor1(option.v.Title, 0, GeonBit.UI.Entities.Anchor.AutoInline, btnSize, void 0);
     ...
     *
     * @public
     * @class GeonBit.UI.Utils.MessageBox.MessageBoxHandle
     */
    Bridge.define("GeonBit.UI.Utils.MessageBox.MessageBoxHandle", {
        $kind: "nested class",
        fields: {
            /**
             * Message box panel.
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Utils.MessageBox.MessageBoxHandle
             * @type GeonBit.UI.Entities.Panel
             */
            Panel: null,
            /**
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Utils.MessageBox.MessageBoxHandle
             * @memberof GeonBit.UI.Utils.MessageBox.MessageBoxHandle
             * @return  {void}
             */
            Close: function () {
     ...
     *
     * @public
     * @class GeonBit.UI.Utils.MessageBox.MsgBoxOption
     */
    Bridge.define("GeonBit.UI.Utils.MessageBox.MsgBoxOption", {
        $kind: "nested class",
        fields: {
            /**
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Utils.MessageBox.MsgBoxOption
             * @type string
             */
            Title: null,
            /**
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Utils.MessageBox.MsgBoxOption
             * @memberof GeonBit.UI.Utils.MessageBox.MsgBoxOption
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.Utils.PanelsGrid
     */
    Bridge.define("GeonBit.UI.Utils.PanelsGrid", {
        statics: {
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this GeonBit.UI.Utils.PanelsGrid
                 * @memberof GeonBit.UI.Utils.PanelsGrid
                 * @param   {number}                               amount        How many panels to create.
                 * @param   {GeonBit.UI.Entities.Entity}           parent        Optional parent entity to add panels to.
                 * @param   {?Microsoft.Xna.Framework.Vector2}     columnSize    Size of every column. If not set will be 1f / amount with auto-set height.
                 * @param   {GeonBit.UI.Entities.PanelSkin}        skin          Panels skin to use (default to None, making them invisible.
                 * @return  {Array.<GeonBit.UI.Entities.Panel>}                  Array with generated panels.
                 */
                GenerateColums$1: function (amount, parent, columnSize, skin) {
                    ...
                    var retList = new (System.Collections.Generic.List$1(GeonBit.UI.Entities.Panel)).ctor();
                    ...
                    for (var i = 0; i < amount; i = (i + 1) | 0) {
                        var currPanel = new GeonBit.UI.Entities.Panel.$ctor1(System.Nullable.getValue(columnSize).$clone(), skin, GeonBit.UI.Entities.Anchor.AutoInlineNoBreak);
                ...
                GenerateColums: function (panelSizes, parent, skin) {
                    ...
                    try {
                        while ($t.moveNext()) {
                            ...
                            var currPanel = new GeonBit.UI.Entities.Panel.$ctor1(currSize.$clone(), skin, GeonBit.UI.Entities.Anchor.AutoInlineNoBreak);
                            currPanel.Padding = Microsoft.Xna.Framework.Vector2.Zero.$clone();
                            retList.add(currPanel);
                            if (parent != null) {
                                parent.AddChild(currPanel);
    ...
    /**
     * @public
     * @class GeonBit.UI.Utils.PresentationParametersWrapper
     */
    Bridge.define("GeonBit.UI.Utils.PresentationParametersWrapper", {
        props: {
            /**
             * @instance
             * @public
             * @memberof GeonBit.UI.Utils.PresentationParametersWrapper
     ...
     * @abstract
     * @public
     * @class GeonBit.UI.Utils.SimpleFileMenu
     */
    Bridge.define("GeonBit.UI.Utils.SimpleFileMenu", {
        statics: {
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this GeonBit.UI.Utils.SimpleFileMenu
                 * @memberof GeonBit.UI.Utils.SimpleFileMenu
                 * @param   {GeonBit.UI.Utils.SimpleFileMenu.MenuLayout}    layout    Layout to create file menu for.
                 * @param   {GeonBit.UI.Entities.PanelSkin}                 skin      Skin to use for panels and dropdown of this file menu.
                 * @return  {GeonBit.UI.Entities.Panel}                               Menu root panel.
                 */
                Create: function (layout, skin) {
                    var $t, $t1;
                    if (skin === void 0) { skin = 2; }
                    // create the root panel
                    var rootPanel = new GeonBit.UI.Entities.Panel.$ctor1(new Microsoft.Xna.Framework.Vector2.$ctor2(0, GeonBit.UI.Entities.DropDown.SelectedPanelHeight), skin, GeonBit.UI.Entities.Anchor.TopLeft);
                    ...
                    try {
                        while ($t.moveNext()) {
                            ...
                            var dropdown = new GeonBit.UI.Entities.DropDown.$ctor1(new Microsoft.Xna.Framework.Vector2.$ctor2(menu.Width, -1), GeonBit.UI.Entities.Anchor.AutoInline, null, GeonBit.UI.Entities.PanelSkin.None, skin, false);
     ...
     *
     * @public
     * @class GeonBit.UI.Utils.SimpleFileMenu.MenuLayout
     */
    Bridge.define("GeonBit.UI.Utils.SimpleFileMenu.MenuLayout", {
        $kind: "nested class",
        props: {
            /**
             * Menus layout.
             *
             * @instance
             * @memberof GeonBit.UI.Utils.SimpleFileMenu.MenuLayout
             * @function Layout
             * @type System.Collections.Generic.List$1
             */
            Layout: null
        ...
        ctors: {
            init: function () {
                this.Layout = new (System.Collections.Generic.List$1(GeonBit.UI.Utils.SimpleFileMenu.MenuLayout.Menu)).ctor();
            }
        },
        methods: {
            /**
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Utils.SimpleFileMenu.MenuLayout
             * @memberof GeonBit.UI.Utils.SimpleFileMenu.MenuLayout
            ...
            AddMenu: function (title, width) {
                var $t;
                var newMenu = ($t = new GeonBit.UI.Utils.SimpleFileMenu.MenuLayout.Menu(), $t.Title = title, $t.Width = width, $t);
            ...
            AddItemToMenu: function (menuTitle, item, onClick) {
                ...
                throw new GeonBit.UI.Exceptions.NotFoundException.$ctor1("Menu with title '" + (menuTitle || "") + "' is not defined!");
            }
        }
    });
     ...
     *
     * @class GeonBit.UI.Utils.SimpleFileMenu.MenuLayout.Menu
     */
    Bridge.define("GeonBit.UI.Utils.SimpleFileMenu.MenuLayout.Menu", {
        $kind: "nested class",
        fields: {
            /**
             * Menu title.
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Utils.SimpleFileMenu.MenuLayout.Menu
             * @type string
             */
            Title: null,
            /**
     ...
     *
     * @public
     * @class GeonBit.UI.Animators.FadeOutAnimator
     * @augments GeonBit.UI.Animators.IAnimator
     */
    Bridge.define("GeonBit.UI.Animators.FadeOutAnimator", {
        inherits: [GeonBit.UI.Animators.IAnimator],
        fields: {
            _timeLeft: 0,
            /**
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Animators.FadeOutAnimator
             * @default 1.0
             * @type number
             */
            SpeedFactor: 0
        ...
        methods: {
             ...
             * @public
             * @override
             * @this GeonBit.UI.Animators.FadeOutAnimator
             * @memberof GeonBit.UI.Animators.FadeOutAnimator
             * @return  {void}
             */
            Update: function () {
                // update animation and calc new opacity
                var dt = GeonBit.UI.UserInterface.Active.CurrGameTime.ElapsedGameTime.getTotalSeconds();
     ...
     *
     * @public
     * @class GeonBit.UI.Animators.FloatUpDownAnimator
     * @augments GeonBit.UI.Animators.IAnimator
     */
    Bridge.define("GeonBit.UI.Animators.FloatUpDownAnimator", {
        inherits: [GeonBit.UI.Animators.IAnimator],
        fields: {
            _maxDuration: null,
            _timeLeft: null,
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Animators.FloatUpDownAnimator
             * @default 2.0
             * @type number
             */
            SpeedFactor: 0,
        ...
        methods: {
             ...
             * @public
             * @override
             * @this GeonBit.UI.Animators.FloatUpDownAnimator
             * @memberof GeonBit.UI.Animators.FloatUpDownAnimator
             * @return  {void}
             */
            Update: function () {
     ...
     *
     * @public
     * @class GeonBit.UI.Animators.TextWaveAnimator
     * @augments GeonBit.UI.Animators.IAnimator
     */
    Bridge.define("GeonBit.UI.Animators.TextWaveAnimator", {
        inherits: [GeonBit.UI.Animators.IAnimator],
        fields: {
            _currPosition: 0,
            /**
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Animators.TextWaveAnimator
             * @default 10.0
             * @type number
             */
            SpeedFactor: 0,
        ...
        props: {
            ...
            IsDone: {
                get: function () {
                    return !this.Loop && Bridge.Int.clip32(this._currPosition) > (Bridge.as(this.TargetEntity, GeonBit.UI.Entities.RichParagraph)).Text.length;
                }
            }
        },
        ctors: {
        ...
        methods: {
             ...
             * @public
             * @override
             * @this GeonBit.UI.Animators.TextWaveAnimator
             * @memberof GeonBit.UI.Animators.TextWaveAnimator
             * @param   {GeonBit.UI.Entities.Entity}    entity    Entity to test.
             * @return  {boolean}                                 True if compatible, false otherwise.
             */
            CheckEntityCompatibility: function (entity) {
                return Bridge.is(entity, GeonBit.UI.Entities.RichParagraph);
            },
            /**
             * Do animation.
             *
            ...
            Update: function () {
                ...
                var paragraph = Bridge.as(this.TargetEntity, GeonBit.UI.Entities.RichParagraph);
             ...
             */
            OnAttached: function () {
                (Bridge.as(this.TargetEntity, GeonBit.UI.Entities.RichParagraph)).PerCharacterManipulators = Bridge.fn.combine((Bridge.as(this.TargetEntity, GeonBit.UI.Entities.RichParagraph)).PerCharacterManipulators, Bridge.fn.cacheBind(this, this.PerCharacterManipulationFunc));
                this.Reset();
            },
            /**
             * Called right before detached from an entity.
             ...
             */
            OnDetach: function () {
                (Bridge.as(this.TargetEntity, GeonBit.UI.Entities.RichParagraph)).PerCharacterManipulators = Bridge.fn.remove((Bridge.as(this.TargetEntity, GeonBit.UI.Entities.RichParagraph)).PerCharacterManipulators, Bridge.fn.cacheBind(this, this.PerCharacterManipulationFunc));
            },
            /**
             * Reset animation.
             *
             ...
             * @this GeonBit.UI.Animators.TextWaveAnimator
             * @memberof GeonBit.UI.Animators.TextWaveAnimator
             * @param   {GeonBit.UI.Entities.RichParagraph}    paragraph       
     ...
     *
     * @public
     * @class GeonBit.UI.Animators.TypeWriterAnimator
     * @augments GeonBit.UI.Animators.IAnimator
     */
    Bridge.define("GeonBit.UI.Animators.TypeWriterAnimator", {
        inherits: [GeonBit.UI.Animators.IAnimator],
        fields: {
            _text: null,
            _currPosition: 0,
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Animators.TypeWriterAnimator
             * @default 10.0
             * @type number
             */
            SpeedFactor: 0
        ...
        methods: {
             ...
             * @public
             * @override
             * @this GeonBit.UI.Animators.TypeWriterAnimator
             * @memberof GeonBit.UI.Animators.TypeWriterAnimator
             * @param   {GeonBit.UI.Entities.Entity}    entity    Entity to test.
             * @return  {boolean}                                 True if compatible, false otherwise.
             */
            CheckEntityCompatibility: function (entity) {
                return Bridge.is(entity, GeonBit.UI.Entities.Paragraph);
            },
            /**
             * Do animation.
             *
            ...
            Update: function () {
                ...
                if (this._timeForNextChar <= 0.0) {
                    ...
                    if (Bridge.is(this.TargetEntity, GeonBit.UI.Entities.RichParagraph)) {
                        var openingDenote = GeonBit.UI.Entities.RichParagraphStyleInstruction._styleInstructionsOpening;
                        var closingDenote = GeonBit.UI.Entities.RichParagraphStyleInstruction._styleInstructionsClosing;
                ...
                Bridge.cast((this.TargetEntity), GeonBit.UI.Entities.Paragraph).Text = this._text.substr(0, this._currPosition);
            },
            /**
             * Reset animation.
             *
     ...
     *
     * @public
     * @class GeonBit.UI.DefaultInputProvider
     * @implements  GeonBit.UI.IMouseInput
     * @implements  GeonBit.UI.IKeyboardInput
     */
    Bridge.define("GeonBit.UI.DefaultInputProvider", {
        inherits: [GeonBit.UI.IMouseInput,GeonBit.UI.IKeyboardInput],
        fields: {
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.DefaultInputProvider
             * @default 0.6
             * @type number
             */
            KeysTypeCooldown: 0,
        ...
        alias: [
            "MouseWheel", "GeonBit$UI$IMouseInput$MouseWheel",
            "MouseWheelChange", "GeonBit$UI$IMouseInput$MouseWheelChange",
            "Update", "GeonBit$UI$IKeyboardInput$Update",
            "Update", "GeonBit$UI$IMouseInput$Update",
            "UpdateMousePosition", "GeonBit$UI$IMouseInput$UpdateMousePosition",
            "TransformMousePosition", "GeonBit$UI$IMouseInput$TransformMousePosition",
            "GetTextInput", "GeonBit$UI$IKeyboardInput$GetTextInput",
            "MousePosition", "GeonBit$UI$IMouseInput$MousePosition",
            "MousePositionDiff", "GeonBit$UI$IMouseInput$MousePositionDiff",
            "MouseButtonDown", "GeonBit$UI$IMouseInput$MouseButtonDown",
            "AnyMouseButtonDown", "GeonBit$UI$IMouseInput$AnyMouseButtonDown",
            "MouseButtonReleased", "GeonBit$UI$IMouseInput$MouseButtonReleased",
            "AnyMouseButtonReleased", "GeonBit$UI$IMouseInput$AnyMouseButtonReleased",
            "MouseButtonPressed", "GeonBit$UI$IMouseInput$MouseButtonPressed",
            "AnyMouseButtonPressed", "GeonBit$UI$IMouseInput$AnyMouseButtonPressed",
            "MouseButtonClick", "GeonBit$UI$IMouseInput$MouseButtonClick",
            "AnyMouseButtonClicked", "GeonBit$UI$IMouseInput$AnyMouseButtonClicked"
        ],
        ctors: {
            init: function () {
                ...
                this._currCharacterInput = GeonBit.UI.SpecialChars.Null;
             ...
             * @instance
             * @public
             * @this GeonBit.UI.DefaultInputProvider
             * @memberof GeonBit.UI.DefaultInputProvider
             * @return  {void}
             */
            ctor: function () {
        ...
        methods: {
            ...
            Update: function (gameTime) {
                ...
                if (this._currCharacterInput !== GeonBit.UI.SpecialChars.Null && !this._newKeyboardState.IsKeyDown(this._currCharacterInputKey)) {
                    this._currCharacterInput = GeonBit.UI.SpecialChars.Null;
                }
            ...
            NewKeyTextInput: function (key) {
                ...
                switch (key) {
                    case Microsoft.Xna.Framework.Input.Keys.Space: 
                        this._currCharacterInput = GeonBit.UI.SpecialChars.Space;
                        return;
                    case Microsoft.Xna.Framework.Input.Keys.Left: 
                        this._currCharacterInput = GeonBit.UI.SpecialChars.ArrowLeft;
                        return;
                    case Microsoft.Xna.Framework.Input.Keys.Right: 
                        this._currCharacterInput = GeonBit.UI.SpecialChars.ArrowRight;
                        return;
                    case Microsoft.Xna.Framework.Input.Keys.Up: 
                        this._currCharacterInput = GeonBit.UI.SpecialChars.ArrowUp;
                        return;
                    case Microsoft.Xna.Framework.Input.Keys.Down: 
                        this._currCharacterInput = GeonBit.UI.SpecialChars.ArrowDown;
                        return;
                    case Microsoft.Xna.Framework.Input.Keys.Delete: 
                        this._currCharacterInput = GeonBit.UI.SpecialChars.Delete;
                        return;
                    case Microsoft.Xna.Framework.Input.Keys.Back: 
                        this._currCharacterInput = GeonBit.UI.SpecialChars.Backspace;
                        return;
            ...
            GetTextInput: function (txt, lineWidth, pos) {
                ...
                if (this._currCharacterInput === GeonBit.UI.SpecialChars.Null) {
                    return txt;
                }
                ...
                switch (this._currCharacterInput) {
                    case GeonBit.UI.SpecialChars.ArrowLeft: 
                        if (((pos.v = (pos.v - 1) | 0)) < 0) {
                            pos.v = 0;
                        }
                        return txt;
                    case GeonBit.UI.SpecialChars.ArrowRight: 
                        if (((pos.v = (pos.v + 1) | 0)) > txt.length) {
                            pos.v = txt.length;
                        }
                        return txt;
                    case GeonBit.UI.SpecialChars.ArrowUp: 
                        pos.v = (pos.v - lineWidth) | 0;
                        if (pos.v < 0) {
                            pos.v = 0;
                        }
                        return txt;
                    case GeonBit.UI.SpecialChars.ArrowDown: 
                        pos.v = (pos.v + lineWidth) | 0;
                        if (pos.v > txt.length) {
                            pos.v = txt.length;
                        }
                        return txt;
                    case GeonBit.UI.SpecialChars.Backspace: 
                        pos.v = (pos.v - 1) | 0;
                        return (pos.v < txt.length && pos.v >= 0 && txt.length > 0) ? System.String.remove(txt, pos.v, 1) : txt;
                    case GeonBit.UI.SpecialChars.Delete: 
             ...
             * @this GeonBit.UI.DefaultInputProvider
             * @memberof GeonBit.UI.DefaultInputProvider
             * @param   {GeonBit.UI.MouseButton}    button    Mouse button to check.
             * @return  {boolean}
             */
            ...
            AnyMouseButtonDown: function () {
                return this.MouseButtonDown(GeonBit.UI.MouseButton.Left) || this.MouseButtonDown(GeonBit.UI.MouseButton.Right) || this.MouseButtonDown(GeonBit.UI.MouseButton.Middle);
            },
            /**
            ...
            AnyMouseButtonReleased: function () {
                return this.MouseButtonReleased(GeonBit.UI.MouseButton.Left) || this.MouseButtonReleased(GeonBit.UI.MouseButton.Right) || this.MouseButtonReleased(GeonBit.UI.MouseButton.Middle);
            },
            /**
            ...
            AnyMouseButtonPressed: function () {
                return this.MouseButtonPressed(GeonBit.UI.MouseButton.Left) || this.MouseButtonPressed(GeonBit.UI.MouseButton.Right) || this.MouseButtonPressed(GeonBit.UI.MouseButton.Middle);
            },
            /**
            ...
            AnyMouseButtonClicked: function () {
                return this.MouseButtonClick(GeonBit.UI.MouseButton.Left) || this.MouseButtonClick(GeonBit.UI.MouseButton.Right) || this.MouseButtonClick(GeonBit.UI.MouseButton.Middle);
            },
            /**
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.Button
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.Button", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.Button
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null,
                /**
            ...
            ctors: {
                init: function () {
                    this.DefaultStyle = new GeonBit.UI.Entities.StyleSheet();
                    this.DefaultParagraphStyle = new GeonBit.UI.Entities.StyleSheet();
                },
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.Button);
                }
            }
        },
        fields: {
             ...
             * @public
             * @memberof GeonBit.UI.Entities.Button
             * @type GeonBit.UI.Entities.Paragraph
             */
        ...
        props: {
            ...
            Opacity: {
                get: function () {
                    return Bridge.ensureBaseProperty(this, "Opacity").$GeonBit$UI$Entities$Entity$Opacity;
                },
                set: function (value) {
                    Bridge.ensureBaseProperty(this, "Opacity").$GeonBit$UI$Entities$Entity$Opacity = value;
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.Button
             * @memberof GeonBit.UI.Entities.Button
             * @param   {string}                              text      Text for the button label.
             * @param   {GeonBit.UI.Entities.ButtonSkin}      skin      Button skin (texture to use).
             * @param   {GeonBit.UI.Entities.Anchor}          anchor    Position anchor.
            ...
            $ctor1: function (text, skin, anchor, size, offset) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Entity.ctor.call(this, size, anchor, offset);
                // store style
                this._skin = skin;

                // update styles
                this.UpdateStyle(GeonBit.UI.Entities.Button.DefaultStyle);

                if (!GeonBit.UI.UserInterface.Active._isDeserializing) {
                    // create and set button paragraph
                    this.ButtonParagraph = GeonBit.UI.UserInterface.DefaultParagraph(text, GeonBit.UI.Entities.Anchor.Center, void 0, void 0, void 0, void 0);
                    this.ButtonParagraph._hiddenInternalEntity = true;
                    this.ButtonParagraph.UpdateStyle(GeonBit.UI.Entities.Button.DefaultParagraphStyle);
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.Button.$ctor1.call(this, "");
            }
        },
        methods: {
            /**
             ...
             */
            InitAfterDeserialize: function () {
                GeonBit.UI.Entities.Entity.prototype.InitAfterDeserialize.call(this);
                this.ButtonParagraph = Bridge.as(this.Find$1("_button_caption"), GeonBit.UI.Entities.Paragraph);
                this.ButtonParagraph._hiddenInternalEntity = true;
            },
            /**
            ...
            SetCustomSkin: function (defaultTexture, mouseHoverTexture, mouseDownTexture, frameWidth) {
                ...
                this._customSkin[System.Array.index(GeonBit.UI.Entities.EntityState.Default, this._customSkin)] = defaultTexture;
                this._customSkin[System.Array.index(GeonBit.UI.Entities.EntityState.MouseHover, this._customSkin)] = mouseHoverTexture;
                this._customSkin[System.Array.index(GeonBit.UI.Entities.EntityState.MouseDown, this._customSkin)] = mouseDownTexture;
            ...
            DoOnClick: function () {
                ...
                // call base handler
                GeonBit.UI.Entities.Entity.prototype.DoOnClick.call(this);
            },
            /**
             * Draw the entity.
             *
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                if (this.Checked) {
                    state = GeonBit.UI.Entities.EntityState.MouseDown;
                }

                // get texture based on skin and state
                var texture = this._customSkin == null ? GeonBit.UI.Resources.ButtonTextures.getItem$1(this._skin, state) : this._customSkin[System.Array.index(state, this._customSkin)];

                // get frame width
                var data = GeonBit.UI.Resources.ButtonData[System.Array.index(this._skin, GeonBit.UI.Resources.ButtonData)];
                ...
                if (frameSize.Length() > 0) {
                    ...
                    GeonBit.UI.UserInterface.Active.DrawUtils.DrawSurface(spriteBatch, texture, this._destRect.$clone(), frameSize.$clone(), 1, this.FillColor.$clone(), scale);
                } else {
                    GeonBit.UI.UserInterface.Active.DrawUtils.DrawImage(spriteBatch, texture, this._destRect.$clone(), this.FillColor.$clone(), 1);
                }

                // call base draw function
                GeonBit.UI.Entities.Entity.prototype.DrawEntity.call(this, spriteBatch, phase);
            }
        }
    });
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.CheckBox
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.CheckBox", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                CHECKBOX_SIZE: null,
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.CheckBox
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null,
                /**
            ...
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.CheckBox);
                }
            }
        },
        fields: {
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.CheckBox
             * @memberof GeonBit.UI.Entities.CheckBox
            ...
            $ctor1: function (text, anchor, size, offset, isChecked) {
                ...
                this.UpdateStyle(GeonBit.UI.Entities.CheckBox.DefaultStyle);

                // create and set checkbox paragraph
                if (!GeonBit.UI.UserInterface.Active._isDeserializing) {
                    this.TextParagraph = GeonBit.UI.UserInterface.DefaultParagraph(text, GeonBit.UI.Entities.Anchor.CenterLeft, void 0, void 0, void 0, void 0);
                    this.TextParagraph.UpdateStyle(GeonBit.UI.Entities.CheckBox.DefaultParagraphStyle);
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.CheckBox.$ctor1.call(this, "");
            }
        },
        methods: {
            /**
            ...
            InitAfterDeserialize: function () {
                GeonBit.UI.Entities.Entity.prototype.InitAfterDeserialize.call(this);
                this.TextParagraph = Bridge.as(this.Find$1("_checkbox_text"), GeonBit.UI.Entities.Paragraph);
                this.TextParagraph._hiddenInternalEntity = true;
            },
            /**
            ...
            GetTexture: function () {
                var state = this._entityState;
                if (state !== GeonBit.UI.Entities.EntityState.MouseDown && this.Checked) {
                    state = GeonBit.UI.Entities.EntityState.MouseDown;
                }
                return GeonBit.UI.Resources.CheckBoxTextures.getItem(state);
            },
            /**
             * Draw the entity.
             *
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                var actualSize = Microsoft.Xna.Framework.Vector2.op_Multiply$1(GeonBit.UI.Entities.CheckBox.CHECKBOX_SIZE.$clone(), this.GlobalScale);
                ...
                dest = GeonBit.UI.UserInterface.Active.DrawUtils.ScaleRect(dest.$clone(), this.Scale);

                // source rect
                var src = new Microsoft.Xna.Framework.Rectangle.$ctor2(0, 0, texture.Width, texture.Height);

                // draw checkbox
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw$1(texture, dest.$clone(), src.$clone(), this.FillColor.$clone());
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.ColoredRectangle
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.ColoredRectangle", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.ColoredRectangle
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.ColoredRectangle);
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.ColoredRectangle
             * @memberof GeonBit.UI.Entities.ColoredRectangle
            ...
            $ctor3: function (fillColor, outlineColor, outlineWidth, size, anchor, offset) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Entity.ctor.call(this, size, anchor, offset);
                this.UpdateStyle(GeonBit.UI.Entities.ColoredRectangle.DefaultStyle);
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.ColoredRectangle.$ctor3.call(this, Microsoft.Xna.Framework.Color.White);
            },
            /**
        ...
        methods: {
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                if (outlineWidth > 0) {
                    ...
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(GeonBit.UI.Resources.WhiteTexture, outlineDest.$clone(), this.OutlineColor.$clone());
                }
                ...
                // draw the rectangle
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(GeonBit.UI.Resources.WhiteTexture, this._destRect.$clone(), fill.$clone());
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.DropDown
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.DropDown", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.DropDown
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null,
                /**
            ...
            ctors: {
                init: function () {
                    this.DefaultStyle = new GeonBit.UI.Entities.StyleSheet();
                    this.DefaultParagraphStyle = new GeonBit.UI.Entities.StyleSheet();
                    this.DefaultSelectedParagraphStyle = new GeonBit.UI.Entities.StyleSheet();
                    this.SelectedPanelHeight = 67;
                    this.ArrowSize = 30;
                },
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.DropDown);
                }
            }
        },
        fields: {
        ...
        props: {
             ...
             * @memberof GeonBit.UI.Entities.DropDown
             * @function SelectList
             * @type GeonBit.UI.Entities.SelectList
             */
            SelectList: {
                get: function () {
             ...
             * @type GeonBit.UI.Entities.Image
             */
            ArrowDownImage: {
                get: function () {
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.DropDown
             * @memberof GeonBit.UI.Entities.DropDown
             ...
             * @param   {GeonBit.UI.Entities.Anchor}          anchor       Position anchor.
             * @param   {?Microsoft.Xna.Framework.Vector2}    offset       Offset from anchor position.
             * @param   {GeonBit.UI.Entities.PanelSkin}       skin         Panel skin to use for this DropDown list and header.
             * @param   {?GeonBit.UI.Entities.PanelSkin}      listSkin     An optional skin to use for the dropdown list only (if you want a different skin for the list).
            ...
            $ctor1: function (size, anchor, offset, skin, listSkin, showArrow) {
                ...
                if (!GeonBit.UI.UserInterface.Active._isDeserializing) {
                    ...
                    this._selectedTextPanel = new GeonBit.UI.Entities.Panel.$ctor1(new Microsoft.Xna.Framework.Vector2.$ctor2(0, GeonBit.UI.Entities.DropDown.SelectedPanelHeight), skin, GeonBit.UI.Entities.Anchor.TopLeft);
                    this._selectedTextParagraph = GeonBit.UI.UserInterface.DefaultParagraph("", GeonBit.UI.Entities.Anchor.CenterLeft, void 0, void 0, void 0, void 0);
                    this._selectedTextParagraph.UseActualSizeForCollision = false;
                    this._selectedTextParagraph.UpdateStyle(GeonBit.UI.Entities.SelectList.DefaultParagraphStyle);
                    this._selectedTextParagraph.UpdateStyle(GeonBit.UI.Entities.DropDown.DefaultParagraphStyle);
                    this._selectedTextParagraph.UpdateStyle(GeonBit.UI.Entities.DropDown.DefaultSelectedParagraphStyle);
                    ...
                    this._arrowDownImage = new GeonBit.UI.Entities.Image.$ctor1(GeonBit.UI.Resources.ArrowDown, new Microsoft.Xna.Framework.Vector2.$ctor2(GeonBit.UI.Entities.DropDown.ArrowSize, GeonBit.UI.Entities.DropDown.ArrowSize), GeonBit.UI.Entities.ImageDrawMode.Stretch, GeonBit.UI.Entities.Anchor.CenterRight, new Microsoft.Xna.Framework.Vector2.$ctor2(-10, 0));
                    ...
                    this._selectList = new GeonBit.UI.Entities.SelectList.$ctor2(new Microsoft.Xna.Framework.Vector2.$ctor2(0.0, size.Y), GeonBit.UI.Entities.Anchor.TopCenter, Microsoft.Xna.Framework.Vector2.Zero.$clone(), ($t = listSkin, $t != null ? $t : skin));

                    // update list offset and space before
                    this._selectList.Offset = new Microsoft.Xna.Framework.Vector2.$ctor2(0, GeonBit.UI.Entities.DropDown.SelectedPanelHeight);
                    ...
                    this._selectList = new GeonBit.UI.Entities.SelectList.$ctor2(new Microsoft.Xna.Framework.Vector2.$ctor2(0.0, size.Y), GeonBit.UI.Entities.Anchor.TopCenter, Microsoft.Xna.Framework.Vector2.Zero.$clone(), ($t1 = listSkin, $t1 != null ? $t1 : skin));
                }
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.DropDown.$ctor1.call(this, new Microsoft.Xna.Framework.Vector2.$ctor2(0, 200));
            }
        },
        methods: {
            /**
            ...
            InitEvents: function () {
                ...
                this._selectList.OnValueChange = Bridge.fn.bind(this, $asm.$.GeonBit.UI.Entities.DropDown.f1);

                // on click, always hide the selectlist
                this._selectList.OnClick = Bridge.fn.bind(this, $asm.$.GeonBit.UI.Entities.DropDown.f2);

                // hide the list by default
                this._selectList.Visible = false;

                // setup the callback to show / hide the list when clicking the dropbox
                this._selectedTextPanel.OnClick = Bridge.fn.bind(this, $asm.$.GeonBit.UI.Entities.DropDown.f3);

                // set starting text
                this._selectedTextParagraph.Text = (($t = this.SelectedValue, $t != null ? $t : this.DefaultText));

                // update styles
                this._selectList.UpdateStyle(GeonBit.UI.Entities.DropDown.DefaultStyle);
            ...
            InitAfterDeserialize: function () {
                ...
                this._selectedTextPanel = this.Find(GeonBit.UI.Entities.Panel, "_selectedTextPanel");
                this._selectedTextPanel._hiddenInternalEntity = true;

                this._arrowDownImage = this._selectedTextPanel.Find(GeonBit.UI.Entities.Image, "_arrowDownImage");
                this._arrowDownImage._hiddenInternalEntity = true;

                this._selectList = this.Find(GeonBit.UI.Entities.SelectList, "_selectList");
                this._selectList._hiddenInternalEntity = true;

                this._selectedTextParagraph = Bridge.as(this._selectedTextPanel.Find$1("_selectedTextParagraph"), GeonBit.UI.Entities.Paragraph);
            ...
            IsTouching: function (point) {
                ...
                if (this.ListVisible) {
                    ...
                    rect.Height = (rect.Height + GeonBit.UI.Entities.DropDown.SelectedPanelHeight) | 0;
                    rect.Y = (rect.Y - GeonBit.UI.Entities.DropDown.SelectedPanelHeight) | 0;
                } else {
                    this._selectedTextPanel.UpdateDestinationRectsIfDirty();
            ...
            OnDropDownVisibilityChange: function () {
                ...
                // update arrow image
                this._arrowDownImage.Texture = this.ListVisible ? GeonBit.UI.Resources.ArrowUp : GeonBit.UI.Resources.ArrowDown;

                // focus on selectlist
                this._selectList.IsFocused = true;
                GeonBit.UI.UserInterface.Active.ActiveEntity = this._selectList;
            ...
            DoAfterUpdate: function () {
                ...
                if (this.ListVisible) {
                    ...
                    if (this.MouseInput.GeonBit$UI$IMouseInput$AnyMouseButtonPressed() && !this.IsTouching(mousePosition.$clone())) {
                        this.ListVisible = false;
                    }
                }

                // call base do-before-update
                GeonBit.UI.Entities.Entity.prototype.DoAfterUpdate.call(this);
    ...
    Bridge.ns("GeonBit.UI.Entities.DropDown", $asm.$);

    Bridge.apply($asm.$.GeonBit.UI.Entities.DropDown, {
        f1: function (entity) {
            var $t;
            // hide list
            this.ListVisible = false;
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.Paragraph
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.Paragraph", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.Paragraph
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null,
                /**
            ...
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.Paragraph);
                }
            }
        },
        fields: {
        ...
        props: {
            ...
            TextStyle: {
                ...
                set: function (value) {
                    this.SetStyleProperty("FontStyle", new GeonBit.UI.DataTypes.StyleProperty.$ctor4(value));
                }
            },
            /**
            ...
            AlignToCenter: {
                ...
                set: function (value) {
                    this.SetStyleProperty("ForceAlignCenter", new GeonBit.UI.DataTypes.StyleProperty.$ctor3(value));
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.Paragraph
             * @memberof GeonBit.UI.Entities.Paragraph
            ...
            $ctor2: function (text, anchor, size, offset, scale) {
                ...
                GeonBit.UI.Entities.Entity.ctor.call(this, size, anchor, offset);
                this.Text = text;
                this.UpdateStyle(GeonBit.UI.Entities.Paragraph.DefaultStyle);
                if (scale != null) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.Scale, new GeonBit.UI.DataTypes.StyleProperty.$ctor5(System.Nullable.getValue(scale)));
                }
            ...
            $ctor1: function (text, anchor, color, scale, size, offset) {
                ...
                GeonBit.UI.Entities.Paragraph.$ctor2.call(this, text, anchor, size, offset);
                this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.FillColor, new GeonBit.UI.DataTypes.StyleProperty.$ctor1(color.$clone()));
                if (scale != null) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.Scale, new GeonBit.UI.DataTypes.StyleProperty.$ctor5(System.Nullable.getValue(scale)));
                }
                this.UpdateFontPropertiesIfNeeded();
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.Paragraph.$ctor2.call(this, "");
            }
        },
        methods: {
            /**
            ...
            GetCharacterActualSize: function () {
                ...
                var scale = this.Scale * GeonBit.UI.Entities.Paragraph.BaseSize * this.GlobalScale;
            ...
            GetCurrFont: function () {
                return this.FontOverride || GeonBit.UI.Resources.Fonts[System.Array.index(this.TextStyle, GeonBit.UI.Resources.Fonts)];
            },
            /**
             * Update dest rect and internal dest rect.
             This is called internally whenever a change is made to the entity or its parent.
            ...
            UpdateDestinationRects: function () {
                // call base function
                GeonBit.UI.Entities.Entity.prototype.UpdateDestinationRects.call(this);
            ...
            UpdateFontPropertiesIfNeeded: function () {
                ...
                if (!Bridge.referenceEquals(font, this._currFont)) {
                    ...
                    if ((this.SingleCharacterSize.X * 2) !== this._currFont.MeasureString("!.").X) {
                        throw new GeonBit.UI.Exceptions.InvalidValueException.$ctor1("Cannot use non-monospace fonts!");
                    }
                }
            },
            /**
            ...
            CalcTextActualRectWithWrap: function () {
                ...
                // calc actual scale
                var actualScale = this.Scale * GeonBit.UI.Entities.Paragraph.BaseSize * this.GlobalScale;
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                if (this.BackgroundColor.A > 0) {
                    ...
                    var backColor = GeonBit.UI.UserInterface.Active.DrawUtils.FixColorOpacity(this.BackgroundColor.$clone());
                    ...
                    // draw background color
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(GeonBit.UI.Resources.WhiteTexture, rect.$clone(), backColor.$clone());
                }
                ...
                // get fill color
                var fillCol = GeonBit.UI.UserInterface.Active.DrawUtils.FixColorOpacity(this.FillColor.$clone());

                // draw text itself
                spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$DrawString(this._currFont, this._processedText, this._position.$clone(), fillCol.$clone(), 0, this._fontOrigin.$clone(), this._actualScale, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0.5);
             ...
             * @this GeonBit.UI.Entities.Paragraph
             * @memberof GeonBit.UI.Entities.Paragraph
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}    spriteBatch     Spritebatch to use.
             * @param   {number}                                  outlineWidth    Outline width.
             * @return  {void}
             */
            DrawTextOutline: function (spriteBatch, outlineWidth) {
                // get outline color
                var outlineColor = GeonBit.UI.UserInterface.Active.DrawUtils.FixColorOpacity(this.OutlineColor.$clone());
             ...
             * @this GeonBit.UI.Entities.Paragraph
             * @memberof GeonBit.UI.Entities.Paragraph
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}           spriteBatch     Sprite batch to use.
            ...
            DrawTextOutline$1: function (spriteBatch, text, outlineWidth, font, scale, position, outlineColor, origin) {
                ...
                if (outlineWidth <= GeonBit.UI.Entities.Paragraph.MaxOutlineWidthToOptimize) {
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$DrawString(font, text, Microsoft.Xna.Framework.Vector2.op_Addition(position.$clone(), Microsoft.Xna.Framework.Vector2.op_Multiply$1(Microsoft.Xna.Framework.Vector2.One.$clone(), outlineWidth)), outlineColor.$clone(), 0, origin.$clone(), scale, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0.5);
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$DrawString(font, text, Microsoft.Xna.Framework.Vector2.op_Subtraction(position.$clone(), Microsoft.Xna.Framework.Vector2.op_Multiply$1(Microsoft.Xna.Framework.Vector2.One.$clone(), outlineWidth)), outlineColor.$clone(), 0, origin.$clone(), scale, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0.5);
                } else {
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$DrawString(font, text, Microsoft.Xna.Framework.Vector2.op_Addition(position.$clone(), Microsoft.Xna.Framework.Vector2.op_Multiply$1(Microsoft.Xna.Framework.Vector2.UnitX.$clone(), outlineWidth)), outlineColor.$clone(), 0, origin.$clone(), scale, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0.5);
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$DrawString(font, text, Microsoft.Xna.Framework.Vector2.op_Subtraction(position.$clone(), Microsoft.Xna.Framework.Vector2.op_Multiply$1(Microsoft.Xna.Framework.Vector2.UnitX.$clone(), outlineWidth)), outlineColor.$clone(), 0, origin.$clone(), scale, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0.5);
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$DrawString(font, text, Microsoft.Xna.Framework.Vector2.op_Addition(position.$clone(), Microsoft.Xna.Framework.Vector2.op_Multiply$1(Microsoft.Xna.Framework.Vector2.UnitY.$clone(), outlineWidth)), outlineColor.$clone(), 0, origin.$clone(), scale, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0.5);
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$DrawString(font, text, Microsoft.Xna.Framework.Vector2.op_Subtraction(position.$clone(), Microsoft.Xna.Framework.Vector2.op_Multiply$1(Microsoft.Xna.Framework.Vector2.UnitY.$clone(), outlineWidth)), outlineColor.$clone(), 0, origin.$clone(), scale, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0.5);
                }
            }
        }
    });
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.HorizontalLine
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.HorizontalLine", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                FRAME_WIDTH: null,
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.HorizontalLine
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.HorizontalLine);
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.HorizontalLine
             * @memberof GeonBit.UI.Entities.HorizontalLine
             * @param   {GeonBit.UI.Entities.Anchor}          anchor    Position anchor.
             * @param   {?Microsoft.Xna.Framework.Vector2}    offset    Offset from anchor position.
             * @return  {void}
            ...
            $ctor1: function (anchor, offset) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Entity.ctor.call(this, Microsoft.Xna.Framework.Vector2.Zero, anchor, offset);
                // locked by default, so we won't do events etc.
                this.Locked = true;

                // update style
                this.UpdateStyle(GeonBit.UI.Entities.HorizontalLine.DefaultStyle);

                // get line texture and set default height
                var texture = GeonBit.UI.Resources.HorizontalLineTexture;
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.HorizontalLine.$ctor1.call(this, GeonBit.UI.Entities.Anchor.Auto);
            }
        },
        methods: {
            /**
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                // draw panel
                GeonBit.UI.UserInterface.Active.DrawUtils.DrawSurface(spriteBatch, texture, this._destRect.$clone(), GeonBit.UI.Entities.HorizontalLine.FRAME_WIDTH.$clone(), 1, this.FillColor.$clone());
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.Image
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.Image", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.Image
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.Image);
                }
            }
        },
        fields: {
        ...
        props: {
            ...
            TextureName: {
                ...
                set: function (value) {
                    this.Texture = GeonBit.UI.Resources._content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, value);
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.Image
             * @memberof GeonBit.UI.Entities.Image
             ...
             * @param   {GeonBit.UI.Entities.ImageDrawMode}             drawMode    How to draw the image (see ImageDrawMode for more info).
             * @param   {GeonBit.UI.Entities.Anchor}                    anchor      Poisition anchor.
             * @param   {?Microsoft.Xna.Framework.Vector2}              offset      Offset from anchor position.
             * @return  {void}
             */
            $ctor1: function (texture, size, drawMode, anchor, offset) {
                ...
                // update style
                this.UpdateStyle(GeonBit.UI.Entities.Image.DefaultStyle);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.Image.$ctor1.call(this, null);
            }
        },
        methods: {
            /**
            ...
            GetTextureCoordsAt: function (pos) {
                ...
                if (this.DrawMode !== GeonBit.UI.Entities.ImageDrawMode.Stretch) {
                    throw new GeonBit.UI.Exceptions.InvalidStateException.$ctor1("Cannot get texture coords on image that is not in stretched mode!");
                }

                // make sure in boundaries
                if (!this.IsTouching(pos.$clone())) {
                    throw new GeonBit.UI.Exceptions.InvalidValueException.$ctor1("Position to get coords for must be inside entity boundaries!");
                }
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                switch (this.DrawMode) {
                    case GeonBit.UI.Entities.ImageDrawMode.Panel: 
                        GeonBit.UI.UserInterface.Active.DrawUtils.DrawSurface(spriteBatch, this.Texture, this._destRect.$clone(), this.FrameWidth.$clone(), this.Scale, this.FillColor.$clone());
                        break;
                    case GeonBit.UI.Entities.ImageDrawMode.Stretch: 
                        GeonBit.UI.UserInterface.Active.DrawUtils.DrawImage(spriteBatch, this.Texture, this._destRect.$clone(), this.FillColor.$clone(), this.Scale, System.Nullable.lift1("$clone", this.SourceRectangle));
                        break;
                }
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.LineSpace
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.LineSpace", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.LineSpace
                 * @default 8.0
                 * @type number
                 */
                SpaceSize: 0
            ...
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.LineSpace);
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.LineSpace
             * @memberof GeonBit.UI.Entities.LineSpace
            ...
            $ctor1: function (spacesCount) {
                var $t;
                this.$initialize();
                GeonBit.UI.Entities.Entity.ctor.call(this, Microsoft.Xna.Framework.Vector2.One, GeonBit.UI.Entities.Anchor.Auto, Microsoft.Xna.Framework.Vector2.Zero);
                ...
                this.SpaceAfter = new Microsoft.Xna.Framework.Vector2.$ctor2(0, GeonBit.UI.Entities.LineSpace.SpaceSize * this.GlobalScale * spacesCount);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.LineSpace.$ctor1.call(this, 1);
            }
        },
        methods: {
            /**
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.PanelBase
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.PanelBase", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.PanelBase
                 * @default 50.0
                 * @type number
                 */
            ...
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.PanelBase);
                }
            }
        },
        fields: {
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.PanelBase
             * @memberof GeonBit.UI.Entities.PanelBase
             * @param   {Microsoft.Xna.Framework.Vector2}     size      Panel size.
             * @param   {GeonBit.UI.Entities.PanelSkin}       skin      Panel skin (texture to use). Use PanelSkin.None for invisible panels.
             * @param   {GeonBit.UI.Entities.Anchor}          anchor    Position anchor.
             * @param   {?Microsoft.Xna.Framework.Vector2}    offset    Offset from anchor position.
             * @return  {void}
             */
            $ctor1: function (size, skin, anchor, offset) {
                ...
                GeonBit.UI.Entities.Entity.ctor.call(this, size, anchor, offset);
                this._skin = skin;
                this.UpdateStyle(GeonBit.UI.Entities.Panel.DefaultStyle);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.PanelBase.$ctor1.call(this, new Microsoft.Xna.Framework.Vector2.$ctor2(500, 500));
            }
        },
        methods: {
            /**
             ...
             * @this GeonBit.UI.Entities.PanelBase
             * @memberof GeonBit.UI.Entities.PanelBase
             * @param   {GeonBit.UI.Utils.ISpriteBatchWrapper}    spriteBatch    Spritebatch to use when drawing this panel.
             * @return  {void}
             */
            Draw: function (spriteBatch) {
                ...
                GeonBit.UI.Entities.Entity.prototype.Draw.call(this, spriteBatch);
            },
            /**
            ...
            SetHeightBasedOnChildren: function () {
                ...
                var maxHeight = GeonBit.UI.Entities.PanelBase.MinAutoAdjustHeight;
                var didAdjustHeight = false;
                $t = Bridge.getEnumerator(this._children);
                try {
                    while ($t.moveNext()) {
                        var child = $t.Current;
                        if (child.Size.Y !== 0 && !child.Draggable && child.Visible && (child.Anchor === GeonBit.UI.Entities.Anchor.TopCenter || child.Anchor === GeonBit.UI.Entities.Anchor.TopLeft || child.Anchor === GeonBit.UI.Entities.Anchor.TopRight || child.Anchor === GeonBit.UI.Entities.Anchor.Auto || child.Anchor === GeonBit.UI.Entities.Anchor.AutoCenter || child.Anchor === GeonBit.UI.Entities.Anchor.AutoInline || child.Anchor === GeonBit.UI.Entities.Anchor.AutoInlineNoBreak)) {
                ...
                if ((this.Size.Y !== maxHeight)) {
                    this.Size = new Microsoft.Xna.Framework.Vector2.$ctor2(this.Size.X, maxHeight / GeonBit.UI.UserInterface.Active.GlobalScale);
                    this.UpdateDestinationRects();
                    $t1 = Bridge.getEnumerator(this._children);
                    try {
                        while ($t1.moveNext()) {
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                if (this._skin !== GeonBit.UI.Entities.PanelSkin.None) {
                    // get texture based on skin
                    var texture = this._customTexture || GeonBit.UI.Resources.PanelTextures.getItem(this._skin);
                    var data = GeonBit.UI.Resources.PanelData[System.Array.index(this._skin, GeonBit.UI.Resources.PanelData)];
                    var frameSize = ($t = this._customFrame, $t != null ? $t : new Microsoft.Xna.Framework.Vector2.$ctor2(data.FrameWidth, data.FrameHeight));

                    // draw panel
                    GeonBit.UI.UserInterface.Active.DrawUtils.DrawSurface(spriteBatch, texture, this._destRect.$clone(), frameSize.$clone(), 1.0, this.FillColor.$clone(), this.Scale);
                }
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.PanelTabs
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.PanelTabs", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.PanelTabs
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
            ...
            ctors: {
                init: function () {
                    this.DefaultButtonStyle = new GeonBit.UI.Entities.StyleSheet();
                    this.DefaultButtonParagraphStyle = new GeonBit.UI.Entities.StyleSheet();
                },
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.PanelTabs);
                }
            }
        },
        fields: {
             ...
             * @private
             * @memberof GeonBit.UI.Entities.PanelTabs
             * @type GeonBit.UI.Entities.TabData
             */
            _activeTab: null
        },
        props: {
        ...
        ctors: {
            init: function () {
                this._tabs = new (System.Collections.Generic.List$1(GeonBit.UI.Entities.TabData)).ctor();
            },
            /**
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.PanelTabs
             * @memberof GeonBit.UI.Entities.PanelTabs
             * @param   {GeonBit.UI.Entities.PanelSkin}    buttonsBackground    Optional buttons background panel.
             * @return  {void}
             */
            ctor: function (buttonsBackground) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Entity.ctor.call(this, new Microsoft.Xna.Framework.Vector2.$ctor2(0, 0), GeonBit.UI.Entities.Anchor.TopCenter, Microsoft.Xna.Framework.Vector2.Zero);
                // update style
                this.UpdateStyle(GeonBit.UI.Entities.Entity.DefaultStyle);
                ...
                if (!GeonBit.UI.UserInterface.Active._isDeserializing) {
                    ...
                    this._internalRoot = new GeonBit.UI.Entities.Panel.$ctor1(Microsoft.Xna.Framework.Vector2.Zero.$clone(), GeonBit.UI.Entities.PanelSkin.None, GeonBit.UI.Entities.Anchor.TopCenter);
                    ...
                    this._buttonsPanel = new GeonBit.UI.Entities.Panel.$ctor1(Microsoft.Xna.Framework.Vector2.Zero.$clone(), buttonsBackground, GeonBit.UI.Entities.Anchor.TopCenter);
                    ...
                    this._panelsPanel = new GeonBit.UI.Entities.Panel.$ctor1(Microsoft.Xna.Framework.Vector2.Zero.$clone(), GeonBit.UI.Entities.PanelSkin.None, GeonBit.UI.Entities.Anchor.TopCenter, new Microsoft.Xna.Framework.Vector2.$ctor2(0, 0));
        ...
        methods: {
            ...
            InitAfterDeserialize: function () {
                ...
                // get internal panels
                this._internalRoot = this.Find(GeonBit.UI.Entities.Panel, "_internalRoot");
                this._buttonsPanel = this._internalRoot.Find(GeonBit.UI.Entities.Panel, "_buttonsPanel");
                this._panelsPanel = this._internalRoot.Find(GeonBit.UI.Entities.Panel, "_panelsPanel");
                this._panelsPanel._hiddenInternalEntity = true;
                this._buttonsPanel._hiddenInternalEntity = true;
                this._internalRoot._hiddenInternalEntity = true;

                // rebuild tabs
                var buttons = new (System.Collections.Generic.List$1(GeonBit.UI.Entities.Entity)).$ctor1(this._buttonsPanel._children);
                this._buttonsPanel.ClearChildren();
                var panels = new (System.Collections.Generic.List$1(GeonBit.UI.Entities.Entity)).$ctor1(this._panelsPanel._children);
                this._panelsPanel.ClearChildren();
                for (var i = 0; i < panels.Count; i = (i + 1) | 0) {
                    this.AddTab$1(Bridge.as(panels.getItem(i), GeonBit.UI.Entities.Panel), Bridge.as(buttons.getItem(i), GeonBit.UI.Entities.Button));
                }
            },
            /**
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                var sizeX = Bridge.Int.clip32(Bridge.Math.round(Bridge.Int.clip32(Bridge.Math.round(this._buttonsPanel.GetActualDestRect().Width / System.Array.getCount(buttons, GeonBit.UI.Entities.Entity), 0, 6)) / this.GlobalScale, 0, 6));
                $t = Bridge.getEnumerator(buttons, GeonBit.UI.Entities.Entity);
                try {
                    while ($t.moveNext()) {
            ...
            SelectTab: function (name) {
                ...
                throw new GeonBit.UI.Exceptions.NotFoundException.$ctor1("Tab not found!");
            },
            /**
             ...
             * @param   {GeonBit.UI.Entities.PanelSkin}    panelSkin    Panel skin to use for this panel.
             * @return  {GeonBit.UI.Entities.TabData}                   The new tab we created - contains the panel and the button to switch it.
             */
            AddTab: function (name, panelSkin) {
                if (panelSkin === void 0) { panelSkin = -1; }
                var newPanel = new GeonBit.UI.Entities.Panel.$ctor1(Microsoft.Xna.Framework.Vector2.Zero.$clone(), panelSkin, GeonBit.UI.Entities.Anchor.TopCenter);
                var newButton = new GeonBit.UI.Entities.Button.$ctor1(name, GeonBit.UI.Entities.ButtonSkin.Default, GeonBit.UI.Entities.Anchor.AutoInlineNoBreak, new Microsoft.Xna.Framework.Vector2.$ctor2(-1, -1));
             ...
             * @this GeonBit.UI.Entities.PanelTabs
             * @memberof GeonBit.UI.Entities.PanelTabs
             * @param   {GeonBit.UI.Entities.Panel}      newPanel     Panel instance to add as a tab.
             * @param   {GeonBit.UI.Entities.Button}     newButton    Button to activate this tab.
             * @return  {GeonBit.UI.Entities.TabData}                 The new tab we created - contains the panel and the button to switch it.
             */
            AddTab$1: function (newPanel, newButton) {
                ...
                var newTab = new GeonBit.UI.Entities.TabData(name, newPanel, newButton);

                // link tab data to panel
                newTab.panel.AttachedData = newTab;

                // set button styles
                newTab.button.UpdateStyle(GeonBit.UI.Entities.PanelTabs.DefaultButtonStyle);
                newTab.button.ButtonParagraph.UpdateStyle(GeonBit.UI.Entities.PanelTabs.DefaultButtonParagraphStyle);
                ...
                newTab.button.OnValueChange = Bridge.fn.bind(this, function (entity) {
                    ...
                    var self = Bridge.cast((entity), GeonBit.UI.Entities.Button);
                    ...
                    var selfPanel = this._panelsPanel.Find(GeonBit.UI.Entities.Panel, "tab-panel-" + (name || ""));
                    ...
                    if (self.Checked) {
                        this._activeTab = Bridge.cast(selfPanel.AttachedData, GeonBit.UI.Entities.TabData);
                    }
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.Slider
     * @augments GeonBit.UI.Entities.Entity
     */
    Bridge.define("GeonBit.UI.Entities.Slider", {
        inherits: [GeonBit.UI.Entities.Entity],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.Slider
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.Slider);
                }
            }
        },
        fields: {
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.Slider
             * @memberof GeonBit.UI.Entities.Slider
             ...
             * @param   {GeonBit.UI.Entities.SliderSkin}      skin      Slider skin (texture).
             * @param   {GeonBit.UI.Entities.Anchor}          anchor    Position anchor.
             * @param   {?Microsoft.Xna.Framework.Vector2}    offset    Offset from anchor position.
             * @return  {void}
             */
            $ctor2: function (min, max, size, skin, anchor, offset) {
                ...
                // update default style
                this.UpdateStyle(GeonBit.UI.Entities.Slider.DefaultStyle);
            },
            /**
            ...
            $ctor1: function (min, max, skin, anchor, offset) {
                ...
                GeonBit.UI.Entities.Slider.$ctor2.call(this, min, max, GeonBit.UI.Entities.Entity.USE_DEFAULT_SIZE.$clone(), skin, anchor, offset);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.Slider.$ctor1.call(this, 0, 10);
            }
        },
        methods: {
            /**
            ...
            DoWhileMouseDown: function () {
                ...
                // call base handler
                GeonBit.UI.Entities.Entity.prototype.DoWhileMouseDown.call(this);
            },
            /**
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                var texture = GeonBit.UI.Resources.SliderTextures.getItem(this._skin);
                var markTexture = GeonBit.UI.Resources.SliderMarkTextures.getItem(this._skin);

                // get slider metadata
                var data = GeonBit.UI.Resources.SliderData[System.Array.index(this._skin, GeonBit.UI.Resources.SliderData)];
                var frameWidth = data.FrameWidth;

                // draw slider body
                GeonBit.UI.UserInterface.Active.DrawUtils.DrawSurface(spriteBatch, texture, this._destRect.$clone(), new Microsoft.Xna.Framework.Vector2.$ctor2(frameWidth, 0.0), 1, this.FillColor.$clone());
                ...
                GeonBit.UI.UserInterface.Active.DrawUtils.DrawImage(spriteBatch, markTexture, markDest.$clone(), this.FillColor.$clone());
            ...
            DoOnMouseWheelScroll: function () {
                if (this._isMouseOver) {
                    this.Value = (this._value + Bridge.Int.mul(this.MouseInput.GeonBit$UI$IMouseInput$MouseWheelChange, this.GetStepSize())) | 0;
                }
            }
        }
    });
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.StyleSheet
     * @augments System.Collections.Generic.Dictionary$2
     */
    Bridge.define("GeonBit.UI.Entities.StyleSheet", {
        inherits: [System.Collections.Generic.Dictionary$2(System.String,GeonBit.UI.DataTypes.StyleProperty)],
        statics: {
            fields: {
                stateAsString: null,
            ...
            ctors: {
                init: function () {
                    ...
                    this._identifiersCache = new (System.Collections.Generic.Dictionary$2(System.Collections.Generic.KeyValuePair$2(System.String,GeonBit.UI.Entities.EntityState), System.String))(null, new GeonBit.UI.Entities.StyleSheet.StringEntityStateKvpComparer());
                },
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.StyleSheet);
                }
            }
        },
        methods: {
             ...
             * @instance
             * @private
             * @this GeonBit.UI.Entities.StyleSheet
             * @memberof GeonBit.UI.Entities.StyleSheet
             * @param   {string}                             property    
             * @param   {GeonBit.UI.Entities.EntityState}    state
             * @return  {string}
             */
            getPropertyFullId: function (property, state) {
                var $t;
                // get identifier from cache
                var pair = new (System.Collections.Generic.KeyValuePair$2(System.String,GeonBit.UI.Entities.EntityState)).$ctor1(property, state);
                if (GeonBit.UI.Entities.StyleSheet._identifiersCache.containsKey(pair)) {
                    return GeonBit.UI.Entities.StyleSheet._identifiersCache.get(pair);
                }

                // build and return new identifier
                var fullPropertyIdentifier = new System.Text.StringBuilder(GeonBit.UI.Entities.StyleSheet.stateAsString[System.Array.index(state, GeonBit.UI.Entities.StyleSheet.stateAsString)]);
                fullPropertyIdentifier.append(String.fromCharCode(46));
                fullPropertyIdentifier.append(property);
                return ($t = fullPropertyIdentifier.toString(), GeonBit.UI.Entities.StyleSheet._identifiersCache.set(pair, $t), $t);
            },
            /**
             * Return stylesheet property for a given state.
             *
            ...
            getStyleProperty: function (property, state, fallbackToDefault) {
                ...
                var ret = { v : new GeonBit.UI.DataTypes.StyleProperty() };
                var gotVal = this.tryGetValue(this.getPropertyFullId(property, state), ret);

                // if not found, try default
                if (!gotVal && (state !== GeonBit.UI.Entities.EntityState.Default) && fallbackToDefault) {
                    return this.getStyleProperty(property, GeonBit.UI.Entities.EntityState.Default);
                }
             ...
             * @this GeonBit.UI.Entities.StyleSheet
             * @memberof GeonBit.UI.Entities.StyleSheet
             * @param   {GeonBit.UI.Entities.StyleSheet}    other    Other StyleSheet to update from.
             * @return  {void}
             */
     ...
     *
     * @private
     * @class GeonBit.UI.Entities.StyleSheet.StringEntityStateKvpComparer
     * @implements  System.Collections.Generic.IEqualityComparer$1
     */
    Bridge.define("GeonBit.UI.Entities.StyleSheet.StringEntityStateKvpComparer", {
        inherits: [System.Collections.Generic.IEqualityComparer$1(System.Collections.Generic.KeyValuePair$2(System.String,GeonBit.UI.Entities.EntityState))],
        $kind: "nested struct",
        statics: {
            methods: {
                getDefaultValue: function () { return new GeonBit.UI.Entities.StyleSheet.StringEntityStateKvpComparer(); }
            }
        },
        alias: [
            "equals2", ["System$Collections$Generic$IEqualityComparer$1$System$Collections$Generic$KeyValuePair$2$System$String$GeonBit$UI$Entities$EntityState$equals2", "System$Collections$Generic$IEqualityComparer$1$equals2"],
            "getHashCode2", ["System$Collections$Generic$IEqualityComparer$1$System$Collections$Generic$KeyValuePair$2$System$String$GeonBit$UI$Entities$EntityState$getHashCode2", "System$Collections$Generic$IEqualityComparer$1$getHashCode2"]
        ],
        ctors: {
            ctor: function () {
                this.$initialize();
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.StyleSheet.StringEntityStateKvpComparer
             * @memberof GeonBit.UI.Entities.StyleSheet.StringEntityStateKvpComparer
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.TextValidators.OnlySingleSpaces
     * @augments GeonBit.UI.Entities.TextValidators.ITextValidator
     */
    Bridge.define("GeonBit.UI.Entities.TextValidators.OnlySingleSpaces", {
        inherits: [GeonBit.UI.Entities.TextValidators.ITextValidator],
        statics: {
            ctors: {
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.TextValidators.OnlySingleSpaces);
                }
            }
        },
        methods: {
             ...
             * @public
             * @override
             * @this GeonBit.UI.Entities.TextValidators.OnlySingleSpaces
             * @memberof GeonBit.UI.Entities.TextValidators.OnlySingleSpaces
             * @param   {System.String}    text       New text input value.
             * @param   {string}           oldText    Previous text input value.
             * @return  {boolean}                     If TextInput value is legal.
             */
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.TextValidators.SlugValidator
     * @augments GeonBit.UI.Entities.TextValidators.ITextValidator
     */
    Bridge.define("GeonBit.UI.Entities.TextValidators.SlugValidator", {
        inherits: [GeonBit.UI.Entities.TextValidators.ITextValidator],
        statics: {
            fields: {
                _slugNoSpaces: null,
            ...
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.TextValidators.SlugValidator);
                }
            }
        },
        fields: {
        ...
        props: {
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Entities.TextValidators.SlugValidator
            ...
            AllowSpaces: {
                ...
                set: function (value) {
                    ...
                    this._regex = this._allowSpaces ? GeonBit.UI.Entities.TextValidators.SlugValidator._slugWithSpaces : GeonBit.UI.Entities.TextValidators.SlugValidator._slugNoSpaces;
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.TextValidators.SlugValidator
             * @memberof GeonBit.UI.Entities.TextValidators.SlugValidator
            ...
            $ctor1: function (allowSpaces) {
                this.$initialize();
                GeonBit.UI.Entities.TextValidators.ITextValidator.ctor.call(this);
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.TextValidators.SlugValidator.$ctor1.call(this, false);
            }
        },
        methods: {
            /**
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.TextValidators.TextValidatorEnglishCharsOnly
     * @augments GeonBit.UI.Entities.TextValidators.ITextValidator
     */
    Bridge.define("GeonBit.UI.Entities.TextValidators.TextValidatorEnglishCharsOnly", {
        inherits: [GeonBit.UI.Entities.TextValidators.ITextValidator],
        statics: {
            fields: {
                _slugNoSpaces: null,
            ...
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.TextValidators.TextValidatorEnglishCharsOnly);
                }
            }
        },
        fields: {
        ...
        props: {
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Entities.TextValidators.TextValidatorEnglishCharsOnly
             * @function AllowSpaces
             * @type boolean
             */
            AllowSpaces: {
                ...
                set: function (value) {
                    this._allowSpaces = value;
                    this._regex = this._allowSpaces ? GeonBit.UI.Entities.TextValidators.TextValidatorEnglishCharsOnly._slugWithSpaces : GeonBit.UI.Entities.TextValidators.TextValidatorEnglishCharsOnly._slugNoSpaces;
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.TextValidators.TextValidatorEnglishCharsOnly
             * @memberof GeonBit.UI.Entities.TextValidators.TextValidatorEnglishCharsOnly
             * @param   {boolean}    allowSpaces    If true, will allow spaces.
             * @return  {void}
             */
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.TextValidators.TextValidatorEnglishCharsOnly.$ctor1.call(this, false);
            }
        },
        methods: {
            /**
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.TextValidators.TextValidatorMakeTitle
     * @augments GeonBit.UI.Entities.TextValidators.ITextValidator
     */
    Bridge.define("GeonBit.UI.Entities.TextValidators.TextValidatorMakeTitle", {
        inherits: [GeonBit.UI.Entities.TextValidators.ITextValidator],
        statics: {
            ctors: {
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.TextValidators.TextValidatorMakeTitle);
                }
            }
        },
        methods: {
             ...
             * @public
             * @override
             * @this GeonBit.UI.Entities.TextValidators.TextValidatorMakeTitle
             * @memberof GeonBit.UI.Entities.TextValidators.TextValidatorMakeTitle
             * @param   {System.String}    text       New text input value.
             * @param   {string}           oldText    Previous text input value.
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.TextValidators.TextValidatorNumbersOnly
     * @augments GeonBit.UI.Entities.TextValidators.ITextValidator
     */
    Bridge.define("GeonBit.UI.Entities.TextValidators.TextValidatorNumbersOnly", {
        inherits: [GeonBit.UI.Entities.TextValidators.ITextValidator],
        statics: {
            ctors: {
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.TextValidators.TextValidatorNumbersOnly);
                }
            }
        },
        fields: {
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Entities.TextValidators.TextValidatorNumbersOnly
             * @type boolean
             */
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.TextValidators.TextValidatorNumbersOnly
             * @memberof GeonBit.UI.Entities.TextValidators.TextValidatorNumbersOnly
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.TextValidators.TextValidatorNumbersOnly.$ctor1.call(this, false);
            }
        },
        methods: {
            /**
    ...
    Bridge.define("GeonBit.UI.ResolutionMouseProvider", {
        inherits: [GeonBit.UI.IMouseInput],
        fields: {
            _newMouseState: null,
            _oldMouseState: null,
            _newMousePos: null,
        ...
        ctors: {
            init: function () {
                this._newMouseState = new GeonBit.UI.ResolutionMouseProvider.State();
                this._oldMouseState = new GeonBit.UI.ResolutionMouseProvider.State();
                this._newMousePos = new Microsoft.Xna.Framework.Vector2();
                this._oldMousePos = new Microsoft.Xna.Framework.Vector2();
            }
        },
    ...
    /**
     * @public
     * @class GeonBit.UI.Utils.DefaultGraphicDeviceWrapper
     * @augments GeonBit.UI.Utils.GraphicDeviceWrapper
     */
    Bridge.define("GeonBit.UI.Utils.DefaultGraphicDeviceWrapper", {
        inherits: [GeonBit.UI.Utils.GraphicDeviceWrapper],
        fields: {
            graphicDevice: null
        },
        props: {
             ...
             * @instance
             * @public
             * @memberof GeonBit.UI.Utils.DefaultGraphicDeviceWrapper
             ...
             * @type GeonBit.UI.Utils.PresentationParametersWrapper
             */
        ...
        ctors: {
            init: function () {
                this.PresentationParameters = new GeonBit.UI.Utils.PresentationParametersWrapper();
            }
        },
        methods: {
            /**
             ...
             * @public
             * @override
             * @this GeonBit.UI.Utils.DefaultGraphicDeviceWrapper
             * @memberof GeonBit.UI.Utils.DefaultGraphicDeviceWrapper
             * @param   {Microsoft.Xna.Framework.Color}    color
             * @return  {void}
             */
    ...
    Bridge.define("GeonBit.UI.Utils.DefaultSpriteBatchWrapper", {
        inherits: [GeonBit.UI.Utils.ISpriteBatchWrapper],
        props: {
            Spritebatch: null,
            GraphicsDevice: null
        },
        alias: [
            "Begin", "GeonBit$UI$Utils$ISpriteBatchWrapper$Begin",
            "End", "GeonBit$UI$Utils$ISpriteBatchWrapper$End",
            "Draw", "GeonBit$UI$Utils$ISpriteBatchWrapper$Draw",
            "Draw$1", "GeonBit$UI$Utils$ISpriteBatchWrapper$Draw$1",
            "DrawString", "GeonBit$UI$Utils$ISpriteBatchWrapper$DrawString",
            "GraphicsDevice", "GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice"
        ],
        methods: {
    ...
    Bridge.define("GeonBit.UI.Utils.DefaultStylesReader", {
        inherits: [Microsoft.Xna.Framework.Content.ContentTypeReader$1(GeonBit.UI.DataTypes.DefaultStyles)],
        methods: {
            Read$1: function (reader, existingInstance) {
                var result = new GeonBit.UI.DataTypes.DefaultStyles();
    ...
    Bridge.define("GeonBit.UI.Utils.MeshBatchWrapper", {
        inherits: [GeonBit.UI.Utils.ISpriteBatchWrapper],
        fields: {
            glyphsCache: null
        },
        ...
        ctors: {
            init: function () {
                ...
                this.GraphicsDevice = new GeonBit.UI.Utils.ScreenGraphicDeviceWrapper();
            }
        },
        methods: {
            Begin: function (sortMode, blendState, samplerState, depthStencilState, rasterizerState, effect, transformMatrix) {
    ...
    Bridge.define("GeonBit.UI.Utils.ScreenGraphicDeviceWrapper", {
        inherits: [GeonBit.UI.Utils.GraphicDeviceWrapper],
        props: {
            ViewRectangle: null,
            Viewport: {
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.Header
     * @augments GeonBit.UI.Entities.Paragraph
     */
    Bridge.define("GeonBit.UI.Entities.Header", {
        inherits: [GeonBit.UI.Entities.Paragraph],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.Header
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.Header);
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.Header
             * @memberof GeonBit.UI.Entities.Header
            ...
            $ctor1: function (text, anchor, offset) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Paragraph.$ctor2.call(this, text, anchor, void 0, offset, void 0);
                this.UpdateStyle(GeonBit.UI.Entities.Header.DefaultStyle);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.Header.$ctor1.call(this, "");
            }
        }
    });
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.Icon
     * @augments GeonBit.UI.Entities.Image
     */
    Bridge.define("GeonBit.UI.Entities.Icon", {
        inherits: [GeonBit.UI.Entities.Image],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.Icon
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null,
                /**
            ...
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.Icon);
                }
            }
        },
        fields: {
        ...
        props: {
            ...
            IconType: {
                ...
                set: function (value) {
                    this.Texture = GeonBit.UI.Resources.IconTextures.getItem(value);
                    this._icon = value;
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.Icon
             * @memberof GeonBit.UI.Entities.Icon
             * @param   {GeonBit.UI.Entities.IconType}        icon          A pre-defined icon to draw.
             * @param   {GeonBit.UI.Entities.Anchor}          anchor        Position anchor.
            ...
            $ctor1: function (icon, anchor, scale, background, offset) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Image.$ctor1.call(this, null, GeonBit.UI.Entities.Entity.USE_DEFAULT_SIZE.$clone(), GeonBit.UI.Entities.ImageDrawMode.Stretch, anchor, offset);
                ...
                this.SetStyleProperty("BackgroundColor", new GeonBit.UI.DataTypes.StyleProperty.$ctor1(Microsoft.Xna.Framework.Color.White.$clone()));

                // if have background, add default space-after
                if (background) {
                    this.SpaceAfter = Microsoft.Xna.Framework.Vector2.op_Multiply$1(Microsoft.Xna.Framework.Vector2.One.$clone(), GeonBit.UI.Entities.Icon.BackgroundSize);
                }

                // update default style
                this.UpdateStyle(GeonBit.UI.Entities.Icon.DefaultStyle);
            },
            /**
             * Create default icon.
             *
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.Icon.$ctor1.call(this, GeonBit.UI.Entities.IconType.Apple);
            }
        },
        methods: {
            /**
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                if (this.DrawBackground) {
                    ...
                    switch (phase) {
                        case GeonBit.UI.Entities.DrawPhase.Base: 
                            backColor = this.GetActiveStyle("BackgroundColor").asColor.$clone();
                            break;
                        case GeonBit.UI.Entities.DrawPhase.Outline: 
                            backColor = this.OutlineColor.$clone();
                            break;
                        case GeonBit.UI.Entities.DrawPhase.Shadow: 
                    ...
                    dest.X = (dest.X - (((Bridge.Int.div(GeonBit.UI.Entities.Icon.BackgroundSize, 2)) | 0))) | 0;
                    dest.Y = (dest.Y - (((Bridge.Int.div(GeonBit.UI.Entities.Icon.BackgroundSize, 2)) | 0))) | 0;
                    dest.Width = (dest.Width + GeonBit.UI.Entities.Icon.BackgroundSize) | 0;
                    dest.Height = (dest.Height + GeonBit.UI.Entities.Icon.BackgroundSize) | 0;

                    // draw background
                    GeonBit.UI.UserInterface.Active.DrawUtils.DrawImage(spriteBatch, GeonBit.UI.Resources.IconBackgroundTexture, dest.$clone(), backColor.$clone());
                }

                // now draw the image itself
                GeonBit.UI.Entities.Image.prototype.DrawEntity.call(this, spriteBatch, phase);
            }
        }
    });
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.Label
     * @augments GeonBit.UI.Entities.Paragraph
     */
    Bridge.define("GeonBit.UI.Entities.Label", {
        inherits: [GeonBit.UI.Entities.Paragraph],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.Label
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.Label);
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.Label
             * @memberof GeonBit.UI.Entities.Label
            ...
            $ctor1: function (text, anchor, size, offset) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Paragraph.$ctor2.call(this, text, anchor, size, offset, void 0);
                this.UpdateStyle(GeonBit.UI.Entities.Label.DefaultStyle);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.Label.$ctor1.call(this, "");
            }
        }
    });
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.Panel
     * @augments GeonBit.UI.Entities.PanelBase
     */
    Bridge.define("GeonBit.UI.Entities.Panel", {
        inherits: [GeonBit.UI.Entities.PanelBase],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.Panel
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.Panel);
                }
            }
        },
        fields: {
             ...
             * @protected
             * @memberof GeonBit.UI.Entities.Panel
             * @type GeonBit.UI.Entities.VerticalScrollbar
             */
            _scrollbar: null,
            /**
        ...
        ctors: {
            init: function () {
                ...
                this._overflowMode = GeonBit.UI.Entities.PanelOverflowBehavior.Overflow;
            },
            /**
             * Create the panel.
             *
             * @instance
             * @public
             * @this GeonBit.UI.Entities.Panel
             * @memberof GeonBit.UI.Entities.Panel
             * @param   {Microsoft.Xna.Framework.Vector2}     size      Panel size.
             * @param   {GeonBit.UI.Entities.PanelSkin}       skin      Panel skin (texture to use). Use PanelSkin.None for invisible panels.
             * @param   {GeonBit.UI.Entities.Anchor}          anchor    Position anchor.
            ...
            $ctor1: function (size, skin, anchor, offset) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.PanelBase.$ctor1.call(this, size, skin, anchor, offset);
                this.UpdateStyle(GeonBit.UI.Entities.Panel.DefaultStyle);
                if (size.Y === -1) {
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.Panel.$ctor1.call(this, new Microsoft.Xna.Framework.Vector2.$ctor2(500, 500));
            }
        },
        methods: {
            /**
            ...
            CalcDestRect: function () {
                ...
                return GeonBit.UI.Entities.PanelBase.prototype.CalcDestRect.call(this);
            },
            /**
             * Special init after deserializing entity from file.
             *
             ...
             */
            InitAfterDeserialize: function () {
                GeonBit.UI.Entities.PanelBase.prototype.InitAfterDeserialize.call(this);
                var scrollbar = this.Find(GeonBit.UI.Entities.VerticalScrollbar, "__scrollbar");
                if (scrollbar != null) {
            ...
            BeforeDrawChildren: function (spriteBatch) {
                ...
                if (this._overflowMode === GeonBit.UI.Entities.PanelOverflowBehavior.Overflow) {
                    this.DisposeRenderTarget();
                } else {
            ...
            SetHeightBasedOnChildren: function () {
                ...
                if (this.PanelOverflowBehavior === GeonBit.UI.Entities.PanelOverflowBehavior.VerticalScroll) {
                    throw new GeonBit.UI.Exceptions.InvalidStateException.$ctor1("Cannot set panel height automatically while having vertical scrollbar!");
                }

                // call base implementation
                return GeonBit.UI.Entities.PanelBase.prototype.SetHeightBasedOnChildren.call(this);
            },
            /**
            ...
            UpdatePanelRenderTarget: function (spriteBatch) {
                ...
                if (this._renderTarget == null || this._renderTarget.Width !== targetRect.Width || this._renderTarget.Height !== targetRect.Height) {
                    // recreate render target
                    this.DisposeRenderTarget();
                    this._renderTarget = new Microsoft.Xna.Framework.Graphics.RenderTarget2D.$ctor2(GeonBit.UI.Utils.GraphicDeviceWrapper.op_Implicit(spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice), targetRect.Width, targetRect.Height, false, spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.PresentationParameters.BackBufferFormat, spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$GraphicsDevice.PresentationParameters.DepthStencilFormat, 0, Microsoft.Xna.Framework.Graphics.RenderTargetUsage.PreserveContents);
                }
                ...
                GeonBit.UI.UserInterface.Active.DrawUtils.PushRenderTarget(this._renderTarget);
                ...
                if (this._overflowMode === GeonBit.UI.Entities.PanelOverflowBehavior.VerticalScroll) {
                    // move items position based on scrollbar
                    this._destRectInternal.Y = (this._destRectInternal.Y - this._scrollbar.Value) | 0;

                    // update scrollbar position
                    this._scrollbar.Anchor = GeonBit.UI.Entities.Anchor.CenterLeft;
             ...
             */
            CalcInternalRect: function () {
                GeonBit.UI.Entities.PanelBase.prototype.CalcInternalRect.call(this);
            ...
            AfterDrawChildren: function (spriteBatch) {
                ...
                if (this._renderTarget != null) {
                    ...
                    GeonBit.UI.UserInterface.Active.DrawUtils.PopRenderTarget();

                    // draw the render target itself
                    GeonBit.UI.UserInterface.Active.DrawUtils.StartDraw(spriteBatch, this.IsDisabled());
                    spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$Draw(this._renderTarget, this.GetRenderTargetRect(), Microsoft.Xna.Framework.Color.White.$clone());
                    GeonBit.UI.UserInterface.Active.DrawUtils.EndDraw(spriteBatch);
            ...
            UpdateOverflowMode: function () {
                ...
                if (this._overflowMode === GeonBit.UI.Entities.PanelOverflowBehavior.VerticalScroll) {
                    ...
                    if (this._scrollbar == null) {
                        // create scrollbar
                        this._scrollbar = ($t = new GeonBit.UI.Entities.VerticalScrollbar.$ctor1(0, 0, GeonBit.UI.Entities.Anchor.TopRight), $t.Padding = Microsoft.Xna.Framework.Vector2.Zero.$clone(), $t.AdjustMaxAutomatically = true, $t.Identifier = "__scrollbar", $t._hiddenInternalEntity = true, $t);
            ...
            UpdateChildren: function (targetEntity, dragTargetEntity, wasEventHandled, scrollVal) {
                ...
                if (!skipChildren) {
                    GeonBit.UI.Entities.PanelBase.prototype.UpdateChildren.call(this, targetEntity, dragTargetEntity, wasEventHandled, scrollVal.$clone());
                } else {
                    $t = Bridge.getEnumerator(this._children);
                    try {
                        while ($t.moveNext()) {
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.ProgressBar
     * @augments GeonBit.UI.Entities.Slider
     */
    Bridge.define("GeonBit.UI.Entities.ProgressBar", {
        inherits: [GeonBit.UI.Entities.Slider],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.ProgressBar
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null,
                /**
            ...
            ctors: {
                init: function () {
                    this.DefaultStyle = new GeonBit.UI.Entities.StyleSheet();
                    this.DefaultFillStyle = new GeonBit.UI.Entities.StyleSheet();
                },
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.ProgressBar);
                }
            }
        },
        fields: {
             ...
             * @public
             * @memberof GeonBit.UI.Entities.ProgressBar
             * @type GeonBit.UI.Entities.Label
             */
            Caption: null
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.ProgressBar
             * @memberof GeonBit.UI.Entities.ProgressBar
            ...
            $ctor2: function (min, max, size, anchor, offset) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Slider.$ctor2.call(this, min, max, size, GeonBit.UI.Entities.SliderSkin.Default, anchor, offset);
                // update default styles
                this.UpdateStyle(GeonBit.UI.Entities.ProgressBar.DefaultStyle);

                if (!GeonBit.UI.UserInterface.Active._isDeserializing) {
                    // create the fill part
                    this.Padding = Microsoft.Xna.Framework.Vector2.Zero.$clone();
                    this.ProgressFill = new GeonBit.UI.Entities.Image.$ctor1(GeonBit.UI.Resources.ProgressBarFillTexture, Microsoft.Xna.Framework.Vector2.Zero.$clone(), GeonBit.UI.Entities.ImageDrawMode.Stretch, GeonBit.UI.Entities.Anchor.CenterLeft);
                    this.ProgressFill.UpdateStyle(GeonBit.UI.Entities.ProgressBar.DefaultFillStyle);
                    ...
                    this.Caption = new GeonBit.UI.Entities.Label.$ctor1("", GeonBit.UI.Entities.Anchor.Center);
            ...
            $ctor1: function (min, max, anchor, offset) {
                ...
                GeonBit.UI.Entities.ProgressBar.$ctor2.call(this, min, max, GeonBit.UI.Entities.Entity.USE_DEFAULT_SIZE.$clone(), anchor, offset);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.ProgressBar.$ctor1.call(this, 0, 10);
            }
        },
        methods: {
            /**
             ...
             */
            InitAfterDeserialize: function () {
                GeonBit.UI.Entities.Slider.prototype.InitAfterDeserialize.call(this);
                this.Caption = this.Find(GeonBit.UI.Entities.Label, "_progress_caption", false);
                this.Caption._hiddenInternalEntity = true;
                this.ProgressFill = this.Find(GeonBit.UI.Entities.Image, "_progress_fill");
                this.ProgressFill._hiddenInternalEntity = true;
            },
            /**
             * Draw the entity.
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                var progressbarFrameWidth = GeonBit.UI.Resources.ProgressBarData.FrameWidth;

                // draw progress bar frame
                var barTexture = GeonBit.UI.Resources.ProgressBarTexture;
                GeonBit.UI.UserInterface.Active.DrawUtils.DrawSurface(spriteBatch, barTexture, this._destRect.$clone(), new Microsoft.Xna.Framework.Vector2.$ctor2(progressbarFrameWidth, 0.0), 1, this.FillColor.$clone());
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.RadioButton
     * @augments GeonBit.UI.Entities.CheckBox
     */
    Bridge.define("GeonBit.UI.Entities.RadioButton", {
        inherits: [GeonBit.UI.Entities.CheckBox],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.RadioButton
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null,
                /**
            ...
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.RadioButton);
                }
            }
        },
        fields: {
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.RadioButton
             * @memberof GeonBit.UI.Entities.RadioButton
            ...
            $ctor1: function (text, anchor, size, offset, isChecked) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.CheckBox.$ctor1.call(this, text, anchor, size, offset, isChecked);
                this.UpdateStyle(GeonBit.UI.Entities.RadioButton.DefaultStyle);
                if (this.TextParagraph != null) {
                    this.TextParagraph.UpdateStyle(GeonBit.UI.Entities.RadioButton.DefaultParagraphStyle);
                }
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.RadioButton.$ctor1.call(this, "");
            }
        },
        methods: {
            /**
            ...
            GetTexture: function () {
                ...
                return GeonBit.UI.Resources.RadioTextures.getItem(state);
            },
            /**
             * Handle value change.
            ...
            DoOnValueChange: function () {
                ...
                if (this._parent != null) {
                    ...
                    try {
                        while ($t.moveNext()) {
                            ...
                            if (Bridge.is(entity, GeonBit.UI.Entities.RadioButton)) {
                                var radio = Bridge.cast(entity, GeonBit.UI.Entities.RadioButton);
                                if (radio.Checked) {
                                    radio.Checked = false;
                                }
                            }
                ...
                // call base handler
                GeonBit.UI.Entities.CheckBox.prototype.DoOnValueChange.call(this);
            },
            /**
             * Handle mouse click event. 
            ...
            DoOnClick: function () {
                // call base handler
                GeonBit.UI.Entities.CheckBox.prototype.DoOnClick.call(this);
    ...
    /**
     * @memberof GeonBit.UI.Entities
     * @callback GeonBit.UI.Entities.RichParagraph.PerCharacterManipulationFunc
     * @param   {GeonBit.UI.Entities.RichParagraph}    paragraph       
     * @param   {number}                               currChar        
     * @param   {number}                               index           
     * @param   {Microsoft.Xna.Framework.Color}        fillColor       
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.RichParagraph
     * @augments GeonBit.UI.Entities.Paragraph
     */
    Bridge.define("GeonBit.UI.Entities.RichParagraph", {
        inherits: [GeonBit.UI.Entities.Paragraph],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.RichParagraph
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.RichParagraph);
                }
            }
        },
        fields: {
             ...
             * @public
             * @memberof GeonBit.UI.Entities.RichParagraph
             * @type GeonBit.UI.Entities.RichParagraph.PerCharacterManipulationFunc
             */
        ...
        ctors: {
            init: function () {
                ...
                this._needUpdateStyleInstructions = true;
                this._styleInstructions = new (System.Collections.Generic.Dictionary$2(System.Int32,GeonBit.UI.Entities.RichParagraphStyleInstruction))();
            },
            /**
             * Create the paragraph.
             *
             * @instance
             * @public
             * @this GeonBit.UI.Entities.RichParagraph
             * @memberof GeonBit.UI.Entities.RichParagraph
             * @param   {string}                              text      Paragraph text (accept new line characters).
             * @param   {GeonBit.UI.Entities.Anchor}          anchor    Position anchor.
             * @param   {?Microsoft.Xna.Framework.Vector2}    size      Paragraph size (note: not font size, but the region that will contain the paragraph).
            ...
            $ctor2: function (text, anchor, size, offset, scale) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Paragraph.$ctor2.call(this, text, anchor, size, offset, scale);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.RichParagraph.$ctor2.call(this, "");
            },
            /**
             * Create the paragraph with optional fill color and font size.
             *
            ...
            $ctor1: function (text, anchor, color, scale, size, offset) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Paragraph.$ctor1.call(this, text, anchor, color, scale, size, offset);
            }
        },
        methods: {
            /**
             ...
             */
            InitAfterDeserialize: function () {
                GeonBit.UI.Entities.Paragraph.prototype.InitAfterDeserialize.call(this);
                this._needUpdateStyleInstructions = true;
            },
            /**
            ...
            ParseStyleInstructions: function () {
                ...
                if (System.String.contains(this._text,openingDenote)) {
                    ...
                    var oMatches = GeonBit.UI.Entities.RichParagraphStyleInstruction._styleInstructionsRegex.matches(this._text);
                    ...
                    try {
                        while ($t.moveNext()) {
                            ...
                            this._styleInstructions.set(((oMatch.getIndex() - iLastLength) | 0), GeonBit.UI.Entities.RichParagraphStyleInstruction._instructions.get(key).$clone());
                    ...
                    this._text = GeonBit.UI.Entities.RichParagraphStyleInstruction._styleInstructionsRegex.replace(this._text, "");
                }
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                if (this._styleInstructions.count > 0 || !Bridge.staticEquals(this.PerCharacterManipulators, null)) {
                    ...
                    var ResetToDefaults = Bridge.fn.bind(this, function () {
                        currColor.v = GeonBit.UI.UserInterface.Active.DrawUtils.FixColorOpacity(this.FillColor.$clone());
                        currFont = this._currFont;
                        currOutlineWidth.v = this.OutlineWidth;
                        currOutlineColor.v = GeonBit.UI.UserInterface.Active.DrawUtils.FixColorOpacity(this.OutlineColor.$clone());
                    ...
                    try {
                        while ($t.moveNext()) {
                            ...
                            var styleInstruction = { v : new GeonBit.UI.Entities.RichParagraphStyleInstruction() };
                            if (this._styleInstructions.tryGetValue(iTextIndex, styleInstruction)) {
                                ...
                                if (System.Nullable.hasValue(styleInstruction.v.FillColor)) {
                                    currColor.v = GeonBit.UI.UserInterface.Active.DrawUtils.FixColorOpacity(System.Nullable.getValue(styleInstruction.v.FillColor).$clone());
                                }

                                // set font style
                                if (System.Nullable.hasValue(styleInstruction.v.FontStyle)) {
                                    currFont = GeonBit.UI.Resources.Fonts[System.Array.index(System.Nullable.getValue(styleInstruction.v.FontStyle), GeonBit.UI.Resources.Fonts)];
                                }
                                ...
                                if (System.Nullable.hasValue(styleInstruction.v.OutlineColor)) {
                                    currOutlineColor.v = GeonBit.UI.UserInterface.Active.DrawUtils.FixColorOpacity(System.Nullable.getValue(styleInstruction.v.OutlineColor).$clone());
                                }
                            }
                            ...
                            var currText = GeonBit.UI.Resources.GetStringForChar(currCharacter);
                            ...
                            spriteBatch.GeonBit$UI$Utils$ISpriteBatchWrapper$DrawString(currFont, currText, Microsoft.Xna.Framework.Vector2.op_Addition(currPosition.$clone(), offset.v.$clone()), currColor.v.$clone(), 0, this._fontOrigin.$clone(), this._actualScale, Microsoft.Xna.Framework.Graphics.SpriteEffects.None, 0.5);
                        }
                    } finally {
                        if (Bridge.is($t, System.IDisposable)) {
                            $t.System$IDisposable$Dispose();
                    ...
                    GeonBit.UI.Entities.Paragraph.prototype.DrawEntity.call(this, spriteBatch, phase);
                }
            }
        }
    });
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.SelectList
     * @augments GeonBit.UI.Entities.PanelBase
     */
    Bridge.define("GeonBit.UI.Entities.SelectList", {
        inherits: [GeonBit.UI.Entities.PanelBase],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.SelectList
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultParagraphStyle: null,
                /**
            ...
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.SelectList);
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                ...
                this._paragraphs = new (System.Collections.Generic.List$1(GeonBit.UI.Entities.Paragraph)).ctor();
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.SelectList
             * @memberof GeonBit.UI.Entities.SelectList
             * @param   {Microsoft.Xna.Framework.Vector2}     size      List size.
             * @param   {GeonBit.UI.Entities.Anchor}          anchor    Position anchor.
             * @param   {?Microsoft.Xna.Framework.Vector2}    offset    Offset from anchor position.
             * @param   {GeonBit.UI.Entities.PanelSkin}       skin      SelectList skin, eg which texture to use.
             * @return  {void}
             */
            $ctor2: function (size, anchor, offset, skin) {
                ...
                this.UpdateStyle(GeonBit.UI.Entities.SelectList.DefaultStyle);

                // create the scrollbar
                this._scrollbar = new GeonBit.UI.Entities.VerticalScrollbar.$ctor1(0, 10, GeonBit.UI.Entities.Anchor.CenterRight, new Microsoft.Xna.Framework.Vector2.$ctor2(-8, 0), false);
            ...
            $ctor1: function (anchor, offset) {
                ...
                GeonBit.UI.Entities.SelectList.$ctor2.call(this, GeonBit.UI.Entities.Entity.USE_DEFAULT_SIZE.$clone(), anchor, offset);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.SelectList.$ctor1.call(this, GeonBit.UI.Entities.Anchor.Auto);
            }
        },
        methods: {
            /**
             ...
             * @this GeonBit.UI.Entities.SelectList
             * @memberof GeonBit.UI.Entities.SelectList
             * @param   {GeonBit.UI.Entities.Paragraph}    paragraph    The newly created paragraph once ready (after added to list container).
             * @return  {void}
             */
             ...
             */
            OnBeforeDraw: function (spriteBatch) {
                GeonBit.UI.Entities.PanelBase.prototype.OnBeforeDraw.call(this, spriteBatch);
            ...
            OnResize: function () {
                ...
                while (true) {
                    ...
                    var paragraph = GeonBit.UI.UserInterface.DefaultParagraph(".", GeonBit.UI.Entities.Anchor.Auto, void 0, void 0, void 0, void 0);
                    paragraph.PromiscuousClicksMode = true;
                    paragraph.WrapWords = false;
                    paragraph.UpdateStyle(GeonBit.UI.Entities.SelectList.DefaultParagraphStyle);
                    ...
                    paragraph.AttachedData = new GeonBit.UI.Entities.ParagraphData.$ctor1(this, Bridge.identity(i, (i = (i + 1) | 0))).$clone();
                    ...
                    paragraph.OnClick = Bridge.fn.combine(paragraph.OnClick, $asm.$.GeonBit.UI.Entities.SelectList.f1);
             ...
             * @this GeonBit.UI.Entities.SelectList
             * @memberof GeonBit.UI.Entities.SelectList
             * @param   {GeonBit.UI.Entities.SelectList}    other    Entity to propagate events to.
             * @return  {void}
             */
            PropagateEventsTo$2: function (other) {
                this.PropagateEventsTo(Bridge.cast(other, GeonBit.UI.Entities.Entity));
             ...
             * @this GeonBit.UI.Entities.SelectList
             * @memberof GeonBit.UI.Entities.SelectList
             * @param   {GeonBit.UI.Entities.DropDown}    other    Entity to propagate events to.
             * @return  {void}
             */
            ...
            Select$1: function (value) {
                ...
                if (this._index === -1) {
                    ...
                    throw new GeonBit.UI.Exceptions.NotFoundException.$ctor1("Value to set not found in list!");
                }
            ...
            Select: function (index, relativeToScrollbar) {
                ...
                if (index >= -1 && index >= this._list.Count) {
                    ...
                    throw new GeonBit.UI.Exceptions.NotFoundException.$ctor1("Invalid list index to select!");
                }
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                GeonBit.UI.Entities.PanelBase.prototype.DrawEntity.call(this, spriteBatch, phase);
                ...
                if (selectedParagraphIndex !== -1) {
                    ...
                    if (i1 >= 0 && i1 < this._paragraphs.Count) {
                        ...
                        paragraph.State = GeonBit.UI.Entities.EntityState.MouseDown;
    ...
    Bridge.ns("GeonBit.UI.Entities.SelectList", $asm.$);

    Bridge.apply($asm.$.GeonBit.UI.Entities.SelectList, {
        f1: function (entity) {
            var data = System.Nullable.getValue(Bridge.cast(Bridge.unbox(entity.AttachedData, GeonBit.UI.Entities.ParagraphData), GeonBit.UI.Entities.ParagraphData));
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.TextInput
     * @augments GeonBit.UI.Entities.PanelBase
     */
    Bridge.define("GeonBit.UI.Entities.TextInput", {
        inherits: [GeonBit.UI.Entities.PanelBase],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.TextInput
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null,
                /**
            ...
            ctors: {
                init: function () {
                    this.DefaultStyle = new GeonBit.UI.Entities.StyleSheet();
                    this.DefaultParagraphStyle = new GeonBit.UI.Entities.StyleSheet();
                    this.DefaultPlaceholderStyle = new GeonBit.UI.Entities.StyleSheet();
                    this.CaretBlinkingSpeed = 2.0;
                },
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.TextInput);
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                ...
                this.Validators = new (System.Collections.Generic.List$1(GeonBit.UI.Entities.TextValidators.ITextValidator)).ctor();
            },
            /**
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.TextInput
             * @memberof GeonBit.UI.Entities.TextInput
             ...
             * @param   {GeonBit.UI.Entities.Anchor}          anchor       Position anchor.
             * @param   {?Microsoft.Xna.Framework.Vector2}    offset       Offset from anchor position.
             * @param   {GeonBit.UI.Entities.PanelSkin}       skin         TextInput skin, eg which texture to use.
             * @return  {void}
             */
            $ctor2: function (multiline, size, anchor, offset, skin) {
                ...
                // update default style
                this.UpdateStyle(GeonBit.UI.Entities.TextInput.DefaultStyle);

                // default size of multiline text input is 4 times bigger
                if (multiline) {
                    this.SetStyleProperty(GeonBit.UI.Entities.StylePropertyIds.DefaultSize, new GeonBit.UI.DataTypes.StyleProperty.$ctor2(Microsoft.Xna.Framework.Vector2.op_Multiply(this.EntityDefaultSize.$clone(), new Microsoft.Xna.Framework.Vector2.$ctor2(1, 4))));
                }
                ...
                if (!GeonBit.UI.UserInterface.Active._isDeserializing) {
                    ...
                    this.TextParagraph = GeonBit.UI.UserInterface.DefaultParagraph("", GeonBit.UI.Entities.Anchor.TopLeft, void 0, void 0, void 0, void 0);
                    this.TextParagraph.UpdateStyle(GeonBit.UI.Entities.TextInput.DefaultParagraphStyle);
                    this.TextParagraph._hiddenInternalEntity = true;
                    this.TextParagraph.Identifier = "_TextParagraph";
                    this.AddChild(this.TextParagraph, true);

                    // create the placeholder paragraph
                    this.PlaceholderParagraph = GeonBit.UI.UserInterface.DefaultParagraph("", GeonBit.UI.Entities.Anchor.TopLeft, void 0, void 0, void 0, void 0);
                    this.PlaceholderParagraph.UpdateStyle(GeonBit.UI.Entities.TextInput.DefaultPlaceholderStyle);
                    ...
                    var colorTextParagraph = Bridge.as(this.TextParagraph, GeonBit.UI.Entities.RichParagraph);
            ...
            $ctor1: function (multiline, anchor, offset) {
                ...
                GeonBit.UI.Entities.TextInput.$ctor2.call(this, multiline, GeonBit.UI.Entities.Entity.USE_DEFAULT_SIZE.$clone(), anchor, offset);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.TextInput.$ctor1.call(this, false);
            }
        },
        methods: {
            /**
            ...
            UpdateMultilineState: function () {
                ...
                if (this._multiLine) {
                    this._scrollbar = new GeonBit.UI.Entities.VerticalScrollbar.$ctor1(0, 0, GeonBit.UI.Entities.Anchor.CenterRight, new Microsoft.Xna.Framework.Vector2.$ctor2(-8, 0), false);
                    this._scrollbar.Value = 0;
                    this._scrollbar.Visible = false;
                    this._scrollbar._hiddenInternalEntity = true;
                ...
                this.TextParagraph.Anchor = ($t = this._multiLine ? GeonBit.UI.Entities.Anchor.TopLeft : GeonBit.UI.Entities.Anchor.CenterLeft, this.PlaceholderParagraph.Anchor = $t, $t);
            },
            /**
             * Special init after deserializing entity from file.
             *
            ...
            InitAfterDeserialize: function () {
                ...
                this.TextParagraph = Bridge.as(this.Find$1("_TextParagraph"), GeonBit.UI.Entities.Paragraph);
                this.TextParagraph._hiddenInternalEntity = true;

                // set scrollbar
                this._scrollbar = this.Find(GeonBit.UI.Entities.VerticalScrollbar, "__inputScrollbar");
                if (this._scrollbar != null) {
                    this._scrollbar._hiddenInternalEntity = true;
                }

                // set placeholder paragraph
                this.PlaceholderParagraph = Bridge.as(this.Find$1("_PlaceholderParagraph"), GeonBit.UI.Entities.Paragraph);
                this.PlaceholderParagraph._hiddenInternalEntity = true;
            ...
            DoOnClick: function () {
                ...
                GeonBit.UI.Entities.PanelBase.prototype.DoOnClick.call(this);
            ...
            DoBeforeUpdate: function () {
                // animate caret
                this._caretAnim += GeonBit.UI.UserInterface.Active.CurrGameTime.ElapsedGameTime.getTotalSeconds() * GeonBit.UI.Entities.TextInput.CaretBlinkingSpeed;
                ...
                if (this.IsFocused) {
                    ...
                    this._value = this.KeyboardInput.GeonBit$UI$IKeyboardInput$GetTextInput(this._value, this.TextParagraph.MaxCharactersInLine, pos);
                ...
                // call base do-before-update
                GeonBit.UI.Entities.PanelBase.prototype.DoBeforeUpdate.call(this);
            },
            /**
             * Called every time this entity is focused / unfocused.
             *
            ...
            DoOnFocusChange: function () {
                ...
                GeonBit.UI.Entities.PanelBase.prototype.DoOnFocusChange.call(this);
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.VerticalScrollbar
     * @augments GeonBit.UI.Entities.Slider
     */
    Bridge.define("GeonBit.UI.Entities.VerticalScrollbar", {
        inherits: [GeonBit.UI.Entities.Slider],
        statics: {
            fields: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof GeonBit.UI.Entities.VerticalScrollbar
                 * @type GeonBit.UI.Entities.StyleSheet
                 */
                DefaultStyle: null
            },
            ctors: {
                ...
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.VerticalScrollbar);
                }
            }
        },
        fields: {
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.VerticalScrollbar
             * @memberof GeonBit.UI.Entities.VerticalScrollbar
            ...
            $ctor1: function (min, max, anchor, offset, adjustMaxAutomatically) {
                ...
                this.$initialize();
                GeonBit.UI.Entities.Slider.$ctor2.call(this, 0, 0, GeonBit.UI.Entities.Entity.USE_DEFAULT_SIZE.$clone(), GeonBit.UI.Entities.SliderSkin.Default, anchor, offset);
                ...
                // update default style
                this.UpdateStyle(GeonBit.UI.Entities.VerticalScrollbar.DefaultStyle);
            },
            /**
             ...
             */
            ctor: function () {
                GeonBit.UI.Entities.VerticalScrollbar.$ctor1.call(this, 0, 10);
            }
        },
        methods: {
            /**
            ...
            DoOnMouseReleased: function () {
                ...
                // call base function
                GeonBit.UI.Entities.Slider.prototype.DoOnMouseReleased.call(this);
            },
            /**
            ...
            DrawEntity: function (spriteBatch, phase) {
                ...
                if (!Bridge.referenceEquals(GeonBit.UI.UserInterface.Active.ActiveEntity, this)) {
                    this.CalcAutoMaxValue();
                }

                // get textures based on type
                var texture = GeonBit.UI.Resources.VerticalScrollbarTexture;
                var markTexture = GeonBit.UI.Resources.VerticalScrollbarMarkTexture;
                var FrameHeight = GeonBit.UI.Resources.VerticalScrollbarData.FrameHeight;

                // draw scrollbar body
                GeonBit.UI.UserInterface.Active.DrawUtils.DrawSurface(spriteBatch, texture, this._destRect.$clone(), new Microsoft.Xna.Framework.Vector2.$ctor2(0.0, FrameHeight), 1, this.FillColor.$clone());
            ...
            DoAfterUpdate: function () {
                ...
                if (this._isInteractable && (Bridge.referenceEquals(GeonBit.UI.UserInterface.Active.ActiveEntity, this) || Bridge.referenceEquals(GeonBit.UI.UserInterface.Active.ActiveEntity, this._parent) || (GeonBit.UI.UserInterface.Active.ActiveEntity != null && GeonBit.UI.UserInterface.Active.ActiveEntity.IsDeepChildOf(this._parent)))) {
                    if (this.MouseInput.GeonBit$UI$IMouseInput$MouseWheelChange !== 0) {
                        this.Value = (this._value - Bridge.Int.mul(this.MouseInput.GeonBit$UI$IMouseInput$MouseWheelChange, this.GetStepSize())) | 0;
                    }
                }
     ...
     *
     * @public
     * @class GeonBit.UI.Entities.RootPanel
     * @augments GeonBit.UI.Entities.Panel
     */
    Bridge.define("GeonBit.UI.Entities.RootPanel", {
        inherits: [GeonBit.UI.Entities.Panel],
        statics: {
            ctors: {
                ctor: function () {
                    GeonBit.UI.Entities.Entity.MakeSerializable(GeonBit.UI.Entities.RootPanel);
                }
            }
        },
        ctors: {
             ...
             * @instance
             * @public
             * @this GeonBit.UI.Entities.RootPanel
             * @memberof GeonBit.UI.Entities.RootPanel
             * @return  {void}
             */
            ctor: function () {
                this.$initialize();
                GeonBit.UI.Entities.Panel.$ctor1.call(this, Microsoft.Xna.Framework.Vector2.Zero, GeonBit.UI.Entities.PanelSkin.None, GeonBit.UI.Entities.Anchor.Center, Microsoft.Xna.Framework.Vector2.Zero);
                this.Padding = Microsoft.Xna.Framework.Vector2.Zero.$clone();
        ...
        methods: {
             ...
             */
            CalcDestRect: function () {
                var width = GeonBit.UI.UserInterface.Active.ScreenWidth;
                var height = GeonBit.UI.UserInterface.Active.ScreenHeight;
