 ...
 */
Bridge.assembly("MyONez", function ($asm, globals) {
    "use strict";

    Bridge.define("MyONez.ContentPaths", {
        statics: {
            fields: {
                content: null
            },
    ...
    Bridge.define("MyONez.ContentPaths.Effects", {
        $kind: "nested class",
        statics: {
            fields: {
                spriteEffect: null
            ...
            ctors: {
                init: function () {
                    this.spriteEffect = "effects/SpriteEffect";
                }
            }
        }
    });
    ...
    Bridge.define("MyONez.Core", {
        ...
        ctors: {
            init: function () {
                this.globalManagerList = new MyONez.GlobalManagers.GlobalManagerList();
            ...
            ctor: function (width, height, isFullScreen, windowTitle, contentDirectory) {
                ...
                if (windowTitle === void 0) { windowTitle = "MyONez"; }
                ...
                MyONez.Core.Instance = this;

                this.Screen = ($t = new MyONez.XnaManagers.GlobalGraphicsDeviceManager(this), $t.PreferredBackBufferWidth = width, $t.PreferredBackBufferHeight = height, $t.IsFullScreen = isFullScreen, $t.SynchronizeWithVerticalRetrace = false, $t.PreferredDepthStencilFormat = Microsoft.Xna.Framework.Graphics.DepthFormat.None, $t);
                ...
                this.Content = ($t = new MyONez.XnaManagers.GlobalContentManager(), $t.RootDirectory = contentDirectory, $t);
                this.IsMouseVisible = true;
                this.IsFixedTimeStep = false;
                this.TargetElapsedTime = new System.TimeSpan(0, 0, 0, 0, 16);

                // setup systems
                this.globalManagerList.Add(new MyONez.GlobalManagers.Coroutines.CoroutineGlobalManager());
                this.globalManagerList.Add(new MyONez.GlobalManagers.Tweens.TweenGlobalManager());
                this.globalManagerList.Add(new MyONez.GlobalManagers.Timers.TimerGlobalManager());
            }
        },
        methods: {
            OnGraphicsDeviceReset: function (sender, e) {
                if (this.graphicsDeviceChangeTimer != null) {
                    ...
                    this.GetGlobalManager(MyONez.GlobalManagers.Timers.TimerGlobalManager).Schedule(0.05, false, Bridge.fn.bind(this, $asm.$.MyONez.Core.f1));
                }
            },
            ...
            SwitchScene: function (newScene) {
                var transition = new MyONez.Graphics.Transitions.QuickTransition();
            ...
            SwitchScene$2: function (transition) {
                ...
                if (Bridge.staticEquals(transition.SceneLoadAction, null)) {
                    transition.SceneLoadAction = Bridge.fn.bind(this, $asm.$.MyONez.Core.f2);
                }

                this.SceneTransition = transition;

                this.GetGlobalManager(MyONez.GlobalManagers.Coroutines.CoroutineGlobalManager).StartCoroutine(this.SceneTransition.OnBeginTransition());
            },
    ...
    Bridge.ns("MyONez.Core", $asm.$);

    Bridge.apply($asm.$.MyONez.Core, {
        f1: function (t) {
    ...
    Bridge.define("MyONez.Debug.Assert", {
        statics: {
            methods: {
                 ...
                 * @static
                 * @public
                 * @this MyONez.Debug.Assert
                 * @memberof MyONez.Debug.Assert
    ...
    Bridge.define("MyONez.Debug.Logger", {
        statics: {
            methods: {
                Log$2: function (type, format, args) {
                    if (args === void 0) { args = []; }
                    switch (type) {
                        case MyONez.Debug.Logger.LogType.Error: 
                            break;
                        case MyONez.Debug.Logger.LogType.Warn: 
                            break;
                        case MyONez.Debug.Logger.LogType.Log: 
                            break;
                        case MyONez.Debug.Logger.LogType.Info: 
                            break;
                        case MyONez.Debug.Logger.LogType.Trace: 
                            break;
                        default: 
                ...
                Log: function (obj) {
                    MyONez.Debug.Logger.Log$2(MyONez.Debug.Logger.LogType.Log, "{0}", [obj]);
                },
                Log$1: function (format, args) {
                    if (args === void 0) { args = []; }
                    MyONez.Debug.Logger.Log$2(MyONez.Debug.Logger.LogType.Log, format, args);
                },
                Error: function (format, args) {
                    if (args === void 0) { args = []; }
                    MyONez.Debug.Logger.Log$2(MyONez.Debug.Logger.LogType.Error, format, args);
                },
                ...
                Warn: function (format, args) {
                    if (args === void 0) { args = []; }
                    MyONez.Debug.Logger.Log$2(MyONez.Debug.Logger.LogType.Warn, format, args);
                },
                ...
                Info: function (format, args) {
                    if (args === void 0) { args = []; }
                    MyONez.Debug.Logger.Log$2(MyONez.Debug.Logger.LogType.Info, format, args);
                },
                Trace: function (format, args) {
                    if (args === void 0) { args = []; }
                    MyONez.Debug.Logger.Log$2(MyONez.Debug.Logger.LogType.Trace, format, args);
                }
            }
        }
    });

    Bridge.define("MyONez.Debug.Logger.LogType", {
        $kind: "nested enum",
        statics: {
            fields: {
                Error: 0,
     ...
     *
     * @public
     * @class MyONez.ECS.Components.AnimationSpriteComponent
     * @augments LocomotorECS.Component
     */
    Bridge.define("MyONez.ECS.Components.AnimationSpriteComponent", {
    ...
    Bridge.define("MyONez.ECS.Components.CameraComponent", {
        inherits: [LocomotorECS.Component],
        props: {
            Camera: null
        }
    ...
    Bridge.define("MyONez.ECS.Components.CameraShakeComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            Camera: null,
            ShakeDegredation: 0,
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this MyONez.ECS.Components.CameraShakeComponent
    ...
    Bridge.define("MyONez.ECS.Components.ColorComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            color: null
        },
    ...
    Bridge.define("MyONez.ECS.Components.ColorCyclerComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
             ...
             * @instance
             * @public
             * @memberof MyONez.ECS.Components.ColorCyclerComponent
             * @default 1.0
             * @type number
             */
            Amplitude: 0,
        ...
        ctors: {
            init: function () {
                ...
                this.Amplitude = 1.0;
                this.ColorChannel = MyONez.ECS.Components.ColorCyclerComponent.ColorChannels.All;
                this.Frequency = 0.5;
                this.Offset = 0.0;
                this.Phase = 0.0;
                this.WaveFunction = MyONez.ECS.Components.ColorCyclerComponent.WaveFunctions.Sin;
            }
        }
    });

    Bridge.define("MyONez.ECS.Components.ColorCyclerComponent.ColorChannels", {
        $kind: "nested enum",
        statics: {
            fields: {
                None: 0,
    ...
    Bridge.define("MyONez.ECS.Components.ColorCyclerComponent.WaveFunctions", {
        $kind: "nested enum",
        statics: {
            fields: {
                Sin: 0,
     ...
     *
     * @public
     * @class MyONez.ECS.Components.CursorOverComponent
     * @augments LocomotorECS.Component
     */
    Bridge.define("MyONez.ECS.Components.CursorOverComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            IsMouseOver: false,
            OverRegion: null
        ...
        ctors: {
            init: function () {
                this.OverRegion = new MyONez.Maths.RectangleF();
            }
        }
    });

    Bridge.define("MyONez.ECS.Components.DepthLayerComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            depth: 0
        },
    ...
    Bridge.define("MyONez.ECS.Components.FinalRenderComponent", {
        inherits: [LocomotorECS.Component],
        props: {
            Batch: null
        },
        ctors: {
            init: function () {
                this.Batch = new MyONez.Graphics.Meshes.MeshBatch();
            }
        }
    });

    Bridge.define("MyONez.ECS.Components.FollowCameraComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
             ...
             * @instance
             * @public
             * @memberof MyONez.ECS.Components.FollowCameraComponent
             * @default 0.2
             * @type number
             */
            FollowLerp: 0
    ...
    Bridge.define("MyONez.ECS.Components.FollowCursorComponent", {
        inherits: [LocomotorECS.Component]
    });
     ...
     *
     * @public
     * @class MyONez.ECS.Components.InputGamePadComponent
     * @augments LocomotorECS.Component
     */
    Bridge.define("MyONez.ECS.Components.InputGamePadComponent", {
        inherits: [LocomotorECS.Component],
        statics: {
            fields: {
                DEFAULT_DEADZONE: 0
        ...
        fields: {
             ...
             * @instance
             * @public
             * @memberof MyONez.ECS.Components.InputGamePadComponent
             * @default false
             * @type boolean
             */
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this MyONez.ECS.Components.InputGamePadComponent
             * @memberof MyONez.ECS.Components.InputGamePadComponent
     ...
     *
     * @public
     * @class MyONez.ECS.Components.InputKeyboardComponent
     * @augments LocomotorECS.Component
     */
    Bridge.define("MyONez.ECS.Components.InputKeyboardComponent", {
        inherits: [LocomotorECS.Component],
        props: {
            IsShiftDown: {
                get: function () {
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this MyONez.ECS.Components.InputKeyboardComponent
             * @memberof MyONez.ECS.Components.InputKeyboardComponent
     ...
     *
     * @public
     * @class MyONez.ECS.Components.InputMouseComponent
     * @augments LocomotorECS.Component
     */
    Bridge.define("MyONez.ECS.Components.InputMouseComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
        ...
        props: {
             ...
             * @public
             * @readonly
             * @memberof MyONez.ECS.Components.InputMouseComponent
     ...
     *
     * @public
     * @class MyONez.ECS.Components.InputTouchComponent
     * @augments LocomotorECS.Component
     */
    Bridge.define("MyONez.ECS.Components.InputTouchComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
     ...
     *
     * @public
     * @class MyONez.ECS.Components.InputVirtualComponent
     * @augments LocomotorECS.Component
     */
    Bridge.define("MyONez.ECS.Components.InputVirtualComponent", {
        inherits: [LocomotorECS.Component],
        props: {
        ...
        ctors: {
            init: function () {
                this.InputConfiguration = new (System.Collections.Generic.List$1(MyONez.ECS.EntitySystems.VirtualInput.VirtualInput)).ctor();
            }
        }
    });

    Bridge.define("MyONez.ECS.Components.MaterialComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            Material: null
        },
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.Component.ctor.call(this);
                this.Material = new MyONez.Graphics.Materials.Material();
            },
    ...
    Bridge.define("MyONez.ECS.Components.ParentComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            parent: null
        },
    ...
    Bridge.define("MyONez.ECS.Components.PositionComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            position: null
        },
    ...
    Bridge.define("MyONez.ECS.Components.RenderLayerComponent", {
        inherits: [LocomotorECS.Component],
        props: {
            Layer: 0
        },
    ...
    Bridge.define("MyONez.ECS.Components.RenderOrderComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            order: 0
        },
    ...
    Bridge.define("MyONez.ECS.Components.RotateComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            rotation: 0
        },
    ...
    Bridge.define("MyONez.ECS.Components.ScaleComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            scale: null
        },
    ...
    Bridge.define("MyONez.ECS.Components.SpriteComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            Drawable: null
        },
        ctors: {
            ...
            $ctor2: function (texture) {
                MyONez.ECS.Components.SpriteComponent.$ctor3.call(this, new MyONez.Graphics.Drawable.SubtextureDrawable.ctor(texture));
            },
            $ctor4: function (texture) {
                MyONez.ECS.Components.SpriteComponent.$ctor3.call(this, new MyONez.Graphics.Drawable.SubtextureDrawable.$ctor5(texture));
            },
            $ctor1: function (color) {
                MyONez.ECS.Components.SpriteComponent.$ctor3.call(this, new MyONez.Graphics.Drawable.PrimitiveDrawable(color.$clone()));
            }
        }
    });

    Bridge.define("MyONez.ECS.Components.SpriteEffectsComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            SpriteEffects: 0
        },
    ...
    Bridge.define("MyONez.ECS.EntitySystems.Animation.AnimationCompletionBehavior", {
        $kind: "enum",
        statics: {
            fields: {
    ...
    /** @namespace MyONez.ECS.EntitySystems.Animation */

    /**
     * houses the information that a SpriteT requires for animation
     *
     * @public
     * @class MyONez.ECS.EntitySystems.Animation.SpriteAnimation
     */
    Bridge.define("MyONez.ECS.EntitySystems.Animation.SpriteAnimation", {
        fields: {
        ...
        props: {
             ...
             * @instance
             * @public
             * @memberof MyONez.ECS.EntitySystems.Animation.SpriteAnimation
             * @function FPS
             * @type number
             */
            FPS: {
        ...
        ctors: {
            init: function () {
                this.Delay = 0.0;
                this.fps = 10;
                this.Frames = new (System.Collections.Generic.List$1(MyONez.Graphics.Drawable.SubtextureDrawable)).ctor();
                this.isDirty = true;
                this.loop = true;
            },
            ctor: function () {
        ...
        methods: {
             ...
             * @instance
             * @private
             * @this MyONez.ECS.EntitySystems.Animation.SpriteAnimation
             * @memberof MyONez.ECS.EntitySystems.Animation.SpriteAnimation
    ...
    Bridge.define("MyONez.ECS.EntitySystems.AnimationSpriteUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.AnimationSpriteComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                LocomotorECS.EntityProcessingSystem.prototype.DoAction$1.call(this, entity, gameTime);
                var animation = entity.GetComponent(MyONez.ECS.Components.AnimationSpriteComponent);

                if (!animation.IsPlaying) {
                    return;
                }

                var sprite = entity.GetComponent(MyONez.ECS.Components.SpriteComponent);
                if (sprite == null) {
                    sprite = new MyONez.ECS.Components.SpriteComponent.ctor();
                    entity.AddComponent$1(MyONez.ECS.Components.SpriteComponent, sprite);
                }
                ...
                animation.TotalElapsedTime = MyONez.Maths.Mathf.Clamp$1(animation.TotalElapsedTime, 0.0, animation.ExecutingAnimation.TotalDuration);
                animation.CompletedIterations = MyONez.Maths.Mathf.FloorToInt(animation.TotalElapsedTime / animation.ExecutingAnimation.IterationDuration);
                ...
                if (animation.TotalElapsedTime < animation.ExecutingAnimation.IterationDuration) {
                    ...
                    if (!animation.ExecutingAnimation.Loop && elapsedTime === 0) {
                        ...
                        switch (animation.ExecutingAnimation.CompletionBehavior) {
                            case MyONez.ECS.EntitySystems.Animation.AnimationCompletionBehavior.RemainOnFinalFrame: 
                                return;
                            case MyONez.ECS.EntitySystems.Animation.AnimationCompletionBehavior.RevertToFirstFrame: 
                                sprite.Drawable = animation.ExecutingAnimation.Frames.getItem(0);
                                return;
                            case MyONez.ECS.EntitySystems.Animation.AnimationCompletionBehavior.HideSprite: 
                ...
                var desiredFrame = MyONez.Maths.Mathf.FloorToInt(elapsedTime / animation.ExecutingAnimation.SecondsPerFrame);
    ...
    Bridge.define("MyONez.ECS.EntitySystems.CameraShakeUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.CameraShakeComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var shake = entity.GetComponent(MyONez.ECS.Components.CameraShakeComponent);
                ...
                if (Math.abs(shake.ShakeIntensity) > 0.0) {
                    ...
                    if (shake.ShakeOffset.X !== 0.0 || shake.ShakeOffset.Y !== 0.0) {
                        ...
                        shake.ShakeOffset.X = shake.ShakeOffset.X + MyONez.Maths.Random.NextFloat() - 0.5;
                        shake.ShakeOffset.Y = shake.ShakeOffset.Y + MyONez.Maths.Random.NextFloat() - 0.5;
                    }
     ...
     *
     * @public
     * @class MyONez.ECS.EntitySystems.ColorCyclerUpdateSystem
     * @augments LocomotorECS.EntityProcessingSystem
     */
    Bridge.define("MyONez.ECS.EntitySystems.ColorCyclerUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.ColorComponent, MyONez.ECS.Components.ColorCyclerComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var color = entity.GetComponent(MyONez.ECS.Components.ColorComponent);
                var colorCycler = entity.GetComponent(MyONez.ECS.Components.ColorCyclerComponent);
                ...
                switch (colorCycler.ColorChannel) {
                    case MyONez.ECS.Components.ColorCyclerComponent.ColorChannels.All: 
                        ...
                        break;
                    case MyONez.ECS.Components.ColorCyclerComponent.ColorChannels.Red: 
                        ...
                        break;
                    case MyONez.ECS.Components.ColorCyclerComponent.ColorChannels.Green: 
                        ...
                        break;
                    case MyONez.ECS.Components.ColorCyclerComponent.ColorChannels.Blue: 
            ...
            EvaluateWaveFunction: function (secondsPassed, colorCycler) {
                ...
                t = t - MyONez.Maths.Mathf.Floor(t); // normalized value (0..1)
                var y = 1.0;

                switch (colorCycler.WaveFunction) {
                    case MyONez.ECS.Components.ColorCyclerComponent.WaveFunctions.Sin: 
                        y = MyONez.Maths.Mathf.Sin(1.0 * t * Microsoft.Xna.Framework.MathHelper.Pi);
                        break;
                    case MyONez.ECS.Components.ColorCyclerComponent.WaveFunctions.Triangle: 
                        if (t < 0.5) {
                            y = 4.0 * t - 1.0;
                        } else {
                            y = -4.0 * t + 3.0;
                        ...
                        break;
                    case MyONez.ECS.Components.ColorCyclerComponent.WaveFunctions.Square: 
                        if (t < 0.5) {
                            y = 1.0;
                        } else {
                            y = -1.0;
                        ...
                        break;
                    case MyONez.ECS.Components.ColorCyclerComponent.WaveFunctions.SawTooth: 
                        y = t;
                        break;
                    case MyONez.ECS.Components.ColorCyclerComponent.WaveFunctions.InvertedSawTooth: 
                        y = 1.0 - t;
                        break;
                    case MyONez.ECS.Components.ColorCyclerComponent.WaveFunctions.Random: 
                        y = 1.0 - MyONez.Maths.Random.NextFloat() * 2.0;
                        break;
                }
    ...
    Bridge.define("MyONez.ECS.EntitySystems.CursorOverMouseSpriteUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        fields: {
            scene: null
        },
        ctors: {
            ctor: function (scene) {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.InputMouseComponent, MyONez.ECS.Components.CursorOverComponent]));
                this.scene = scene;
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var mouse = entity.GetComponent(MyONez.ECS.Components.InputMouseComponent);
                var clickable = entity.GetComponent(MyONez.ECS.Components.CursorOverComponent);

                var mousePosition = { v : this.scene.Camera.ScreenToWorldPoint$1(mouse.MousePosition.$clone()) };
                var entityPosition = MyONez.Maths.TransformationUtils.GetTransformation(entity);
    ...
    Bridge.define("MyONez.ECS.EntitySystems.CursorOverTouchSpriteUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.InputTouchComponent, MyONez.ECS.Components.CursorOverComponent, MyONez.ECS.Components.SpriteComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var sprite = entity.GetComponent(MyONez.ECS.Components.SpriteComponent);
                var touch = entity.GetComponent(MyONez.ECS.Components.InputTouchComponent);
                var clickable = entity.GetComponent(MyONez.ECS.Components.CursorOverComponent);
                ...
                clickable.IsMouseOver = System.Linq.Enumerable.from(touch.CurrentTouches).any(function (a) {
                        return sprite.Drawable.MyONez$Graphics$Drawable$IDrawable$Bounds.Contains$1(touch.GetScaledPosition(a.Position.$clone()));
                    });
            }
        }
    });

    Bridge.define("MyONez.ECS.EntitySystems.FollowCameraUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.FollowCameraComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var follow = entity.GetComponent(MyONez.ECS.Components.FollowCameraComponent);
            ...
            UpdateFollow: function (entity) {
                ...
                var transform = MyONez.Maths.TransformationUtils.GetTransformation(entity);
    ...
    Bridge.define("MyONez.ECS.EntitySystems.FollowCursorUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        fields: {
            scene: null
        },
        ctors: {
            ctor: function (scene) {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.FollowCursorComponent]));
                this.scene = scene;
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var pos = entity.GetOrCreateComponent(MyONez.ECS.Components.PositionComponent);
    ...
    Bridge.define("MyONez.ECS.IScreenResolutionChangedListener", {
        $kind: "interface"
    });

    Bridge.define("MyONez.ECS.EntitySystems.InputKeyboardUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.InputKeyboardComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var text = entity.GetComponent(MyONez.ECS.Components.InputKeyboardComponent);
    ...
    Bridge.define("MyONez.ECS.EntitySystems.InputVirtualUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.InputVirtualComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var inputKeyboard = entity.GetComponent(MyONez.ECS.Components.InputKeyboardComponent);
                ...
                var inputGamePad = entity.GetComponent(MyONez.ECS.Components.InputGamePadComponent);
                var input = entity.GetComponent(MyONez.ECS.Components.InputVirtualComponent);
     ...
     *
     * @public
     * @class MyONez.ECS.EntitySystems.MaterialEffectUpdateSystem
     * @augments LocomotorECS.EntityProcessingSystem
     */
    Bridge.define("MyONez.ECS.EntitySystems.MaterialEffectUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.MaterialComponent, MyONez.ECS.Components.ColorCyclerComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var material = entity.GetComponent(MyONez.ECS.Components.MaterialComponent);
    ...
    Bridge.define("MyONez.ECS.EntitySystems.RenderCollectionUpdateSystem", {
        ...
        statics: {
            ...
            ctors: {
                init: function () {
                    this.comparer = new (MyONez.Utils.Collections.FunctionComparer$1(LocomotorECS.Entity)).$ctor1($asm.$.MyONez.ECS.EntitySystems.RenderCollectionUpdateSystem.f1);
                }
            }
        },
        fields: {
        ...
        ctors: {
            init: function () {
                this.knownComponents = new (System.Collections.Generic.Dictionary$2(LocomotorECS.Entity,MyONez.ECS.Components.RenderOrderComponent))();
                this.needSort = true;
            },
            ctor: function () {
                this.$initialize();
                LocomotorECS.MatcherEntitySystem.$ctor1.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.FinalRenderComponent]));
            }
        },
        methods: {
            OnMatchedEntityAdded: function (entity) {
                LocomotorECS.MatcherEntitySystem.prototype.OnMatchedEntityAdded.call(this, entity);
                var orderComponent = entity.GetComponent(MyONez.ECS.Components.RenderOrderComponent);
            ...
            DoAction: function (gameTime) {
                ...
                if (this.needSort) {
                    this.MatchedEntities.Sort$1(MyONez.ECS.EntitySystems.RenderCollectionUpdateSystem.comparer);
                }
            },
    ...
    Bridge.ns("MyONez.ECS.EntitySystems.RenderCollectionUpdateSystem", $asm.$);

    Bridge.apply($asm.$.MyONez.ECS.EntitySystems.RenderCollectionUpdateSystem, {
        f1: function (a) {
            var $t, $t1;
            return ($t = (($t1 = a.GetComponent(MyONez.ECS.Components.RenderOrderComponent)) != null ? $t1.Order : null), $t != null ? $t : 0);
        }
    });

    Bridge.define("MyONez.ECS.EntitySystems.SpriteMeshGeneratorSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.SpriteComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var depth = ($t4 = (($t5 = entity.GetComponent(MyONez.ECS.Components.DepthLayerComponent)) != null ? $t5.Depth : null), $t4 != null ? $t4 : 0);

                if (sprite.Drawable == null) {
                    entity.RemoveComponent$1(MyONez.ECS.Components.FinalRenderComponent);
                    return;
                }
                ...
                sprite.Drawable.MyONez$Graphics$Drawable$IDrawable$DrawInto(color.$clone(), depth, finalRender.Batch);
    ...
    /** @namespace MyONez.ECS.EntitySystems.VirtualInput */
     ...
     * @abstract
     * @public
     * @class MyONez.ECS.EntitySystems.VirtualInput.VirtualInput
     */
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualInput", {
        fields: {
            Nodes: null,
            Overlap: 0
        },
        ctors: {
            init: function () {
                this.Nodes = new (System.Collections.Generic.List$1(MyONez.ECS.EntitySystems.VirtualInput.VirtualInputNode)).ctor();
            },
     ...
     * @abstract
     * @public
     * @class MyONez.ECS.EntitySystems.VirtualInput.VirtualInputNode
     */
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualInputNode");

    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualInput.OverlapBehavior", {
        $kind: "nested enum",
        statics: {
            fields: {
                /**
    ...
    Bridge.define("MyONez.ECS.Scene", {
        statics: {
            fields: {
            ...
            ctors: {
                init: function () {
                    ...
                    this.defaultSceneResolutionPolicy = MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy.None;
                }
            },
            methods: {
                SetDefaultDesignResolution: function (width, height, sceneResolutionPolicy) {
                    MyONez.ECS.Scene.defaultDesignResolutionSize = new Microsoft.Xna.Framework.Point.$ctor2(width, height);
                    MyONez.ECS.Scene.defaultSceneResolutionPolicy = sceneResolutionPolicy;
                }
            }
        },
        fields: {
             ...
             * @type MyONez.XnaManagers.GlobalContentManager
             */
            Content: null,
            Camera: null,
            ClearColor: null,
        ...
        ctors: {
            init: function () {
                ...
                this.screenResolutionChangedListeners = new (System.Collections.Generic.List$1(MyONez.ECS.IScreenResolutionChangedListener)).ctor();
            ...
            ctor: function () {
                this.$initialize();
                this.Content = new MyONez.XnaManagers.GlobalContentManager();
                this.Camera = new MyONez.Graphics.Cameras.Camera();
                this.entities = new LocomotorECS.EntityList();
                this.entitySystems = new LocomotorECS.EntitySystemList(this.entities);
                this.Renderers = new MyONez.Graphics.Renderers.RendererList();
                this.renderProcessors = new MyONez.Graphics.RenderProcessors.RenderProcessorList(this);

                this.AddEntitySystem(new MyONez.ECS.EntitySystems.InputMouseUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.InputTouchUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.InputGamePadUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.InputKeyboardUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.InputVirtualUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.FollowCursorUpdateSystem(this));
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.CursorOverMouseSpriteUpdateSystem(this));
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.CursorOverTouchSpriteUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.ColorCyclerUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.FollowCameraUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.CameraShakeUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.MaterialEffectUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.AnimationSpriteUpdateSystem());
                this.AddEntitySystem(new MyONez.ECS.EntitySystems.SpriteMeshGeneratorSystem());

                this.AddEntitySystemExecutionOrder(MyONez.ECS.EntitySystems.InputMouseUpdateSystem, MyONez.ECS.EntitySystems.InputVirtualUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.ECS.EntitySystems.InputTouchUpdateSystem, MyONez.ECS.EntitySystems.InputVirtualUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.ECS.EntitySystems.InputGamePadUpdateSystem, MyONez.ECS.EntitySystems.InputVirtualUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.ECS.EntitySystems.InputKeyboardUpdateSystem, MyONez.ECS.EntitySystems.InputVirtualUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.ECS.EntitySystems.InputMouseUpdateSystem, MyONez.ECS.EntitySystems.FollowCursorUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.ECS.EntitySystems.InputTouchUpdateSystem, MyONez.ECS.EntitySystems.FollowCursorUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.ECS.EntitySystems.InputMouseUpdateSystem, MyONez.ECS.EntitySystems.CursorOverMouseSpriteUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.ECS.EntitySystems.InputTouchUpdateSystem, MyONez.ECS.EntitySystems.CursorOverTouchSpriteUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.ECS.EntitySystems.AnimationSpriteUpdateSystem, MyONez.ECS.EntitySystems.SpriteMeshGeneratorSystem);

                var renderCollectionUpdateSystem = new MyONez.ECS.EntitySystems.RenderCollectionUpdateSystem();
                ...
                this.AddRenderProcessor(MyONez.Graphics.RenderProcessors.Impl.EntityRendererProcessor, new MyONez.Graphics.RenderProcessors.Impl.EntityRendererProcessor(false, this, renderCollectionUpdateSystem.Entities, -1));
                this.AddRenderProcessor(MyONez.Graphics.RenderProcessors.Impl.EntityRendererProcessor, new MyONez.Graphics.RenderProcessors.Impl.EntityRendererProcessor(true, this, renderCollectionUpdateSystem.Entities, 2147483645));
                this.AddRenderProcessor(MyONez.Graphics.RenderProcessors.Impl.ScreenShotRenderProcessor, new MyONez.Graphics.RenderProcessors.Impl.ScreenShotRenderProcessor(2147483646));
                this.AddRenderProcessor(MyONez.Graphics.RenderProcessors.Impl.FinalRenderRenderProcessor, new MyONez.Graphics.RenderProcessors.Impl.FinalRenderRenderProcessor(MyONez.Graphics.Graphic.DefaultSamplerState, 2147483647));

                // setup our resolution policy. we'll commit it in begin
                this.resolutionPolicy = MyONez.ECS.Scene.defaultSceneResolutionPolicy;
                this.DesignResolutionSize = MyONez.ECS.Scene.defaultDesignResolutionSize.$clone();
            }
        },
        methods: {
            /**
            ...
            RequestScreenshot: function (callback) {
                var screenShotPostProcessor = this.renderProcessors.Get(MyONez.Graphics.RenderProcessors.Impl.ScreenShotRenderProcessor);
            ...
            UpdateResolutionScaler: function () {
                var $t;
                this.FinalRenderDestinationRect = this.resolutionPolicy.GetFinalRenderDestinationRect(MyONez.Core.Instance.Screen.Width, MyONez.Core.Instance.Screen.Height, this.DesignResolutionSize.$clone());

                this.SceneRenderTarget = this.resolutionPolicy.GetRenderTargetRect(MyONez.Core.Instance.Screen.Width, MyONez.Core.Instance.Screen.Height, this.DesignResolutionSize.$clone());
                ...
                try {
                    while ($t.moveNext()) {
                        ...
                        listener.MyONez$ECS$IScreenResolutionChangedListener$SceneBackBufferSizeChanged(this.FinalRenderDestinationRect.$clone(), this.SceneRenderTarget.$clone());
                    }
                } finally {
                    if (Bridge.is($t, System.IDisposable)) {
                        $t.System$IDisposable$Dispose();
            ...
            AddRenderer: function (T, renderer) {
                ...
                var listener;
                if (((listener = Bridge.as(renderer, MyONez.ECS.IScreenResolutionChangedListener))) != null) {
             ...
             * @this MyONez.ECS.Scene
             * @memberof MyONez.ECS.Scene
             * @param   {MyONez.Graphics.Renderers.Renderer}    renderer
             * @return  {void}
             */
            ...
            AddRenderProcessor: function (T, postProcessor) {
                ...
                var listener;
                if (((listener = Bridge.as(postProcessor, MyONez.ECS.IScreenResolutionChangedListener))) != null) {
                    this.screenResolutionChangedListeners.add(listener);
                    if (this.didSceneBegin) {
                        listener.MyONez$ECS$IScreenResolutionChangedListener$SceneBackBufferSizeChanged(this.FinalRenderDestinationRect.$clone(), this.SceneRenderTarget.$clone());
                    }
            ...
            RemoveRenderProcessor: function (renderProcessor) {
                ...
                var listener;
                if (((listener = Bridge.as(renderProcessor, MyONez.ECS.IScreenResolutionChangedListener))) != null) {
                    this.screenResolutionChangedListeners.remove(listener);
                }
            },
            /**
            ...
            AddEntitySystem: function (processor) {
                ...
                var listener;
                if (((listener = Bridge.as(processor, MyONez.ECS.IScreenResolutionChangedListener))) != null) {
                    this.screenResolutionChangedListeners.add(listener);
                    if (this.didSceneBegin) {
                        listener.MyONez$ECS$IScreenResolutionChangedListener$SceneBackBufferSizeChanged(this.FinalRenderDestinationRect.$clone(), this.SceneRenderTarget.$clone());
                    }
     ...
     * @abstract
     * @public
     * @class MyONez.Utils.Collections.IPoolable
     */
    Bridge.define("MyONez.Utils.Collections.IPoolable", {
        $kind: "interface"
    });

    /** @namespace MyONez.GlobalManagers */

    /**
     * global manager that can be added to Core
     *
     * @public
     * @class MyONez.GlobalManagers.GlobalManager
     */
    Bridge.define("MyONez.GlobalManagers.GlobalManager", {
        fields: {
            enabled: false
        },
        props: {
             ...
             * @instance
             * @public
             * @memberof MyONez.GlobalManagers.GlobalManager
             * @function Enabled
             * @type boolean
             */
            Enabled: {
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this MyONez.GlobalManagers.GlobalManager
             * @memberof MyONez.GlobalManagers.GlobalManager
    ...
    Bridge.define("MyONez.GlobalManagers.Coroutines.DefaultCoroutines", {
        statics: {
            methods: {
                    ...
                    var $enumerator = new Bridge.GeneratorEnumerator(Bridge.fn.bind(this, function () {
                        try {
                            for (;;) {
                                switch ($step) {
                                    case 0: {
                                        globalManager = MyONez.Core.Instance.GetGlobalManager(MyONez.GlobalManagers.Tweens.TweenGlobalManager);
                                        $step = 1;
                                        continue;
                                    }
                                    case 1: {
    ...
    Bridge.define("MyONez.GlobalManagers.GlobalManagerList", {
        fields: {
            globalManagers: null
        },
        props: {
        ...
        ctors: {
            init: function () {
                this.globalManagers = new (System.Collections.Generic.List$1(MyONez.GlobalManagers.GlobalManager)).ctor();
            }
        },
        methods: {
    ...
    /** @namespace MyONez.GlobalManagers.Timers */

    /**
     * private class hiding the implementation of ITimer
     *
     * @public
     * @class MyONez.GlobalManagers.Timers.Timer
     */
    Bridge.define("MyONez.GlobalManagers.Timers.Timer", {
        fields: {
            elapsedTime: 0,
            isDone: false,
            onTime: null,
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this MyONez.GlobalManagers.Timers.Timer
             * @memberof MyONez.GlobalManagers.Timers.Timer
             * @return  {void}
             */
            Stop: function () {
                this.isDone = true;
    ...
    /** @namespace MyONez.GlobalManagers.Tweens.Interfaces */
     ...
     * @abstract
     * @public
     * @class MyONez.GlobalManagers.Tweens.Interfaces.ITween
     */
    Bridge.define("MyONez.GlobalManagers.Tweens.Interfaces.ITween", {
        $kind: "interface"
    });
     ...
     * @abstract
     * @public
     * @class MyONez.GlobalManagers.Tweens.Interfaces.ITweenTarget$1
     */
    Bridge.definei("MyONez.GlobalManagers.Tweens.Interfaces.ITweenTarget$1", function (T) { return {
        $kind: "interface"
    }; });

    Bridge.define("MyONez.GlobalManagers.Tweens.LoopType", {
        $kind: "enum",
        statics: {
            fields: {
                None: 0,
    ...
    Bridge.define("MyONez.GlobalManagers.Tweens.Tweenable", {
        fields: {
            ElapsedTime: 0,
            globalManager: null,
        ...
        ctors: {
            init: function () {
                this.TweenState = MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Complete;
            }
        },
        methods: {
            Initialize: function (globalManager, tween) {
                this.globalManager = globalManager;
                this.TweenState = MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Paused;
                this.CurrentTween = tween;
            },
            Start: function () {
                this.ElapsedTime = 0;
                this.isRunningInReverse = false;
                this.TweenState = MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Running;
                this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Start();
            },
            ...
            IsRunning: function () {
                return this.TweenState === MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Running;
            },
            IsCompleted: function () {
                return this.TweenState === MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Complete;
            },
            Pause: function () {
                this.TweenState = MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Paused;
            },
            ...
            Tick: function (gameTime) {
                if (this.TweenState === MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Paused) {
                    return false;
                }
                ...
                if (!this.isRunningInReverse && this.ElapsedTime >= this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Duration) {
                    elapsedTimeExcess = this.ElapsedTime - this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Duration;
                    this.ElapsedTime = this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Duration;
                    this.TweenState = MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Complete;
                ...
                if (this.ElapsedTime >= 0 && this.ElapsedTime <= this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Duration) {
                    this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue(this.ElapsedTime);
                }
                ...
                if (this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$LoopType !== MyONez.GlobalManagers.Tweens.LoopType.None && this.TweenState === MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Complete && this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Loops > 0) {
                ...
                if (this.TweenState === MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Complete) {
                    this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$NotifyCompleted();

                    // if we have a nextTween add it to TweenManager so that it can start running
                    if (this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$NextTween != null) {
                        this.globalManager.AddTween(this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$NextTween);
                    }
            ...
            Stop: function (bringToCompletion) {
                ...
                if (bringToCompletion) {
                    ...
                    this.ElapsedTime = this.isRunningInReverse ? 0.0 : this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Duration;
                    this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Stop();
                }
            },
            /**
             ...
             * @instance
             * @public
             * @this MyONez.GlobalManagers.Tweens.Tweenable
             * @memberof MyONez.GlobalManagers.Tweens.Tweenable
             * @return  {void}
             */
            ...
            HandleLooping: function (elapsedTimeExcess) {
                this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Loops = (this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Loops - 1) | 0;
                if (this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$LoopType === MyONez.GlobalManagers.Tweens.LoopType.PingPong) {
                    this.ReverseTween();
                }

                if (this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$LoopType === MyONez.GlobalManagers.Tweens.LoopType.RestartFromBeginning || this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Loops % 2 === 0) {
                    this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$NotifyLoopCompleted();
                }

                // if we have loops left to process reset our state back to Running so we can continue processing them
                if (this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$Loops > 0) {
                    this.TweenState = MyONez.GlobalManagers.Tweens.Tweenable.TweenStates.Running;

                    // now we need to set our elapsed time and factor in our elapsedTimeExcess
                    if (this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$LoopType === MyONez.GlobalManagers.Tweens.LoopType.RestartFromBeginning) {
                        this.ElapsedTime = elapsedTimeExcess - this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$DelayBetweenLoops;
                    } else {
                        if (this.isRunningInReverse) {
                            this.ElapsedTime += this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$DelayBetweenLoops - elapsedTimeExcess;
                        } else {
                            this.ElapsedTime = elapsedTimeExcess - this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$DelayBetweenLoops;
                        }
                    }
                    ...
                    if (this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$DelayBetweenLoops === 0.0 && elapsedTimeExcess > 0.0) {
                        this.CurrentTween.MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue(this.ElapsedTime);
                    }
                }
            }
    ...
    Bridge.define("MyONez.GlobalManagers.Tweens.Tweenable.TweenStates", {
        $kind: "nested enum",
        statics: {
            fields: {
                Running: 0,
    ...
    Bridge.define("MyONez.GlobalManagers.Tweens.TweenExt", {
        statics: {
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this MyONez.GlobalManagers.Tweens.TweenExt
                 * @memberof MyONez.GlobalManagers.Tweens.TweenExt
                 * @param   {MyONez.ECS.Components.PositionComponent}             self        
                 * @param   {Microsoft.Xna.Framework.Vector2}                     to          
                 * @param   {number}                                              duration
                 * @return  {MyONez.GlobalManagers.Tweens.Interfaces.ITween$1}                The position to.
                 */
                TweenTo$3: function (self, to, duration) {
                    if (duration === void 0) { duration = 0.3; }
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.Vector2Tween(new MyONez.GlobalManagers.Tweens.TweenTargets.PositionComponentTweenTarget(self), to.$clone(), duration);
                },
                /**
                 ...
                 * @this MyONez.GlobalManagers.Tweens.TweenExt
                 * @memberof MyONez.GlobalManagers.Tweens.TweenExt
                 * @param   {MyONez.ECS.Components.ScaleComponent}                self        
                 * @param   {number}                                              to          
                 * @param   {number}                                              duration
                 * @return  {MyONez.GlobalManagers.Tweens.Interfaces.ITween$1}                The scale to.
                 */
                TweenTo$5: function (self, to, duration) {
                    if (duration === void 0) { duration = 0.3; }
                    return MyONez.GlobalManagers.Tweens.TweenExt.TweenTo$4(self, new Microsoft.Xna.Framework.Vector2.$ctor1(to), duration);
                },
                /**
                 * transform.scale tween
                 *
                ...
                TweenTo$4: function (self, to, duration) {
                    if (duration === void 0) { duration = 0.3; }
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.Vector2Tween(new MyONez.GlobalManagers.Tweens.TweenTargets.ScaleComponentTweenTarget(self), to.$clone(), duration);
                },
                /**
                 ...
                 * @this MyONez.GlobalManagers.Tweens.TweenExt
                 * @memberof MyONez.GlobalManagers.Tweens.TweenExt
                 * @param   {MyONez.ECS.Components.ColorComponent}                self        Self.
                 * @param   {Microsoft.Xna.Framework.Color}                       to          To.
                 * @param   {number}                                              duration    Duration.
                 * @return  {MyONez.GlobalManagers.Tweens.Interfaces.ITween$1}                The color to.
                 */
                TweenTo: function (self, to, duration) {
                    if (duration === void 0) { duration = 0.3; }
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.ColorTween(new MyONez.GlobalManagers.Tweens.TweenTargets.ColorComponentTweenTarget(self), to.$clone(), duration);
                },
                /**
                 ...
                 * @param   {number}                                              to            
                 * @param   {number}                                              duration
                 * @return  {MyONez.GlobalManagers.Tweens.Interfaces.ITween$1}
                 */
                TweenTo$9: function (self, memberName, to, duration) {
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.IntTween(new (MyONez.GlobalManagers.Tweens.TweenTargets.PropertyTweenTarget$1(System.Int32))(self, memberName), to, duration);
                },
                /**
                ...
                TweenTo$10: function (self, memberName, to, duration) {
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.FloatTween(new (MyONez.GlobalManagers.Tweens.TweenTargets.PropertyTweenTarget$1(System.Single))(self, memberName), to, duration);
                },
                /**
                ...
                TweenTo$1: function (self, memberName, to, duration) {
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.ColorTween(new (MyONez.GlobalManagers.Tweens.TweenTargets.PropertyTweenTarget$1(Microsoft.Xna.Framework.Color))(self, memberName), to.$clone(), duration);
                },
                /**
                ...
                TweenTo$6: function (self, memberName, to, duration) {
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.Vector2Tween(new (MyONez.GlobalManagers.Tweens.TweenTargets.PropertyTweenTarget$1(Microsoft.Xna.Framework.Vector2))(self, memberName), to.$clone(), duration);
                },
                /**
                ...
                TweenTo$7: function (self, memberName, to, duration) {
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.Vector3Tween(new (MyONez.GlobalManagers.Tweens.TweenTargets.PropertyTweenTarget$1(Microsoft.Xna.Framework.Vector3))(self, memberName), to.$clone(), duration);
                },
                /**
                 * tweens a Vector3 field or property
                 *
                ...
                TweenTo$8: function (self, memberName, to, duration) {
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.Vector4Tween(new (MyONez.GlobalManagers.Tweens.TweenTargets.PropertyTweenTarget$1(Microsoft.Xna.Framework.Vector4))(self, memberName), to.$clone(), duration);
                },
                /**
                 * tweens a Vector3 field or property
                 *
                ...
                TweenTo$2: function (self, memberName, to, duration) {
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.QuaternionTween(new (MyONez.GlobalManagers.Tweens.TweenTargets.PropertyTweenTarget$1(Microsoft.Xna.Framework.Quaternion))(self, memberName), to.$clone(), duration);
                },
                /**
                 ...
                 * @this MyONez.GlobalManagers.Tweens.TweenExt
                 * @memberof MyONez.GlobalManagers.Tweens.TweenExt
                 * @param   {MyONez.ECS.Components.RotateComponent}               self        Self.
                 * @param   {number}                                              to          To.
                 * @param   {number}                                              duration    Duration.
                 * @return  {MyONez.GlobalManagers.Tweens.Interfaces.ITween$1}                The rotation to.
                 */
                TweenRadiansTo: function (self, to, duration) {
                    if (duration === void 0) { duration = 0.3; }
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.FloatTween(new MyONez.GlobalManagers.Tweens.TweenTargets.RotateComponentTweenTarget(self), to, duration);
                },
                /**
                 ...
                 * @param   {number}                                              to          To.
                 * @param   {number}                                              duration    Duration.
                 * @return  {MyONez.GlobalManagers.Tweens.Interfaces.ITween$1}                The klocal eulers to.
                 */
                TweenDegreesTo: function (self, to, duration) {
                    if (duration === void 0) { duration = 0.3; }
                    return new MyONez.GlobalManagers.Tweens.PrimitiveTweens.FloatTween(new MyONez.GlobalManagers.Tweens.TweenTargets.RotateDegreesComponentTweenTarget(self), to, duration);
                }
            }
        }
    });

    Bridge.define("MyONez.Graphics.Cameras.Camera", {
        fields: {
            position: null,
            rotation: 0,
            zoom: 0,
        ...
        props: {
             ...
             * @instance
             * @public
             * @memberof MyONez.Graphics.Cameras.Camera
            ...
            Zoom: {
                get: function () {
                    ...
                    if (this.zoom < 1) {
                        return MyONez.Maths.Mathf.Map(this.zoom, this.minimumZoom, 1, -1, 0);
                    }
                    return MyONez.Maths.Mathf.Map(this.zoom, 1, this.maximumZoom, 0, 1);
                },
                set: function (value) {
                    var newZoom = MyONez.Maths.Mathf.Clamp$1(value, -1, 1);
                    if (newZoom === 0) {
                        this.zoom = 1.0;
                    } else {
                        if (newZoom < 0) {
                            this.zoom = MyONez.Maths.Mathf.Map(newZoom, -1, 0, this.minimumZoom, 1);
                        } else {
                            this.zoom = MyONez.Maths.Mathf.Map(newZoom, 0, 1, 1, this.maximumZoom);
                        }
                    }
            ...
            Bounds: {
                get: function () {
                    ...
                    var topLeft = this.ScreenToWorldPoint$1(new Microsoft.Xna.Framework.Vector2.$ctor2(MyONez.Core.Instance.GraphicsDevice.Viewport.X + this.inset.Left, MyONez.Core.Instance.GraphicsDevice.Viewport.Y + this.inset.Top));
                    var bottomRight = this.ScreenToWorldPoint$1(new Microsoft.Xna.Framework.Vector2.$ctor2(((MyONez.Core.Instance.GraphicsDevice.Viewport.X + MyONez.Core.Instance.GraphicsDevice.Viewport.Width) | 0) - this.inset.Right, ((MyONez.Core.Instance.GraphicsDevice.Viewport.Y + MyONez.Core.Instance.GraphicsDevice.Viewport.Height) | 0) - this.inset.Bottom));

                    if (this.Rotation !== 0) {
                        // special care for rotated bounds. we need to find our absolute min/max values and create the bounds from that
                        var topRight = this.ScreenToWorldPoint$1(new Microsoft.Xna.Framework.Vector2.$ctor2(((MyONez.Core.Instance.GraphicsDevice.Viewport.X + MyONez.Core.Instance.GraphicsDevice.Viewport.Width) | 0) - this.inset.Right, MyONez.Core.Instance.GraphicsDevice.Viewport.Y + this.inset.Top));
                        var bottomLeft = this.ScreenToWorldPoint$1(new Microsoft.Xna.Framework.Vector2.$ctor2(MyONez.Core.Instance.GraphicsDevice.Viewport.X + this.inset.Left, ((MyONez.Core.Instance.GraphicsDevice.Viewport.Y + MyONez.Core.Instance.GraphicsDevice.Viewport.Height) | 0) - this.inset.Bottom));

                        var minX = MyONez.Maths.Mathf.MinOf$1(topLeft.X, bottomRight.X, topRight.X, bottomLeft.X);
                        var maxX = MyONez.Maths.Mathf.MaxOf$1(topLeft.X, bottomRight.X, topRight.X, bottomLeft.X);
                        var minY = MyONez.Maths.Mathf.MinOf$1(topLeft.Y, bottomRight.Y, topRight.Y, bottomLeft.Y);
                        var maxY = MyONez.Maths.Mathf.MaxOf$1(topLeft.Y, bottomRight.Y, topRight.Y, bottomLeft.Y);
            ...
            ProjectionMatrix: {
                get: function () {
                    if (this.isProjectionMatrixDirty) {
                        Microsoft.Xna.Framework.Matrix.CreateOrthographicOffCenter$2(0, MyONez.Core.Instance.GraphicsDevice.Viewport.Width, MyONez.Core.Instance.GraphicsDevice.Viewport.Height, 0, 0, -1, Bridge.ref(this, "projectionMatrix"));
            ...
            ProjectionMatrix3D: {
                get: function () {
                    var targetHeight = MyONez.Core.Instance.GraphicsDevice.Viewport.Height / this.zoom;
                    var fov = Math.atan(targetHeight / (2.0 * this.PositionZ3D)) * 2.0;
                    return Microsoft.Xna.Framework.Matrix.CreatePerspectiveFieldOfView(fov, MyONez.Core.Instance.GraphicsDevice.Viewport.AspectRatio, this.NearClipPlane3D, this.FarClipPlane3D);
                }
            },
            /**
        ...
        ctors: {
            init: function () {
                this.position = new Microsoft.Xna.Framework.Vector2();
                this.bounds = new MyONez.Maths.RectangleF();
                this.inset = new MyONez.Maths.RectangleF();
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this MyONez.Graphics.Cameras.Camera
             * @memberof MyONez.Graphics.Cameras.Camera
    ...
    Bridge.define("MyONez.Graphics.Drawable.IDrawable", {
        $kind: "interface"
    });

    Bridge.define("MyONez.Graphics.Graphic", {
        statics: {
            fields: {
                pixelTexture: null,
                spriteEffect: null,
                 ...
                 * @static
                 * @public
                 * @memberof MyONez.Graphics.Graphic
            ...
            props: {
                ...
                DefaultWrappedSamplerState: {
                    get: function () {
                        return MyONez.Graphics.Graphic.DefaultSamplerState.Filter === Microsoft.Xna.Framework.Graphics.TextureFilter.Point ? Microsoft.Xna.Framework.Graphics.SamplerState.PointWrap : Microsoft.Xna.Framework.Graphics.SamplerState.LinearWrap;
                    }
                },
                /**
                ...
                SpriteEffect: {
                    get: function () {
                        MyONez.Graphics.Graphic.spriteEffect = MyONez.Graphics.Graphic.spriteEffect || MyONez.Core.Instance.Content.Load(MyONez.Graphics.SpriteEffect, MyONez.Graphics.SpriteEffect.EffectAssetName);
                        return MyONez.Graphics.Graphic.spriteEffect;
                    }
                },
                SpriteBatch: {
                    get: function () {
                        MyONez.Graphics.Graphic.spriteBatch = MyONez.Graphics.Graphic.spriteBatch || new Microsoft.Xna.Framework.Graphics.SpriteBatch(MyONez.Core.Instance.GraphicsDevice);
                        return MyONez.Graphics.Graphic.spriteBatch;
                    }
                }
            },
            ctors: {
            ...
            methods: {
                ...
                Draw: function (finalRenderTarget, clearColor, batch, material) {
                    ...
                    MyONez.Graphics.Graphic.SpriteBatch.End();
                }
            }
        }
    });

    Bridge.define("MyONez.Graphics.Materials.Material", {
        fields: {
            BlendState: null,
        ...
        ctors: {
            init: function () {
                ...
                this.SamplerState = MyONez.Graphics.Graphic.DefaultSamplerState;
            }
        },
        methods: {
    ...
    Bridge.define("MyONez.Graphics.Meshes.IMesh", {
        methods: {
    ...
    Bridge.define("MyONez.Graphics.Meshes.MeshBatch", {
        fields: {
            Meshes: null
        },
        ctors: {
            init: function () {
                this.Meshes = new (System.Collections.Generic.List$1(MyONez.Graphics.Meshes.IMesh)).ctor();
            }
        },
        methods: {
            Draw: function (texture, destRect, srcRect, color, depth) {
                if (depth === void 0) { depth = 0.0; }
                var mesh = MyONez.Utils.Collections.Pool$1(MyONez.Graphics.Meshes.SpriteMesh).Obtain();
                mesh.Build(texture, destRect.$clone(), srcRect.$clone(), color.$clone(), depth);
                this.Meshes.add(mesh);
            },
            Clear: function () {
                for (var i = 0; i < this.Meshes.Count; i = (i + 1) | 0) {
                    MyONez.Utils.Collections.Pool$1(MyONez.Graphics.Meshes.SpriteMesh).Free(Bridge.cast(this.Meshes.getItem(i), MyONez.Graphics.Meshes.SpriteMesh));
                }
    ...
    Bridge.define("MyONez.Graphics.Renderers.RendererList", {
        fields: {
            renderers: null
        },
        props: {
        ...
        ctors: {
            init: function () {
                this.renderers = new (System.Collections.Generic.List$1(MyONez.Graphics.Renderers.Renderer)).ctor();
            }
        },
        methods: {
            NotifyEnd: function () {
    ...
    /** @namespace MyONez.Graphics.RenderProcessors */

    /**
     * Post Processing step for rendering actions after everything done.
     *
     * @public
     * @class MyONez.Graphics.RenderProcessors.RenderProcessor
     * @implements  System.IComparable$1
     */
    Bridge.define("MyONez.Graphics.RenderProcessors.RenderProcessor", {
        inherits: function () { return [System.IComparable$1(MyONez.Graphics.RenderProcessors.RenderProcessor)]; },
        fields: {
            /**
             ...
             * @public
             * @readonly
             * @memberof MyONez.Graphics.RenderProcessors.RenderProcessor
             * @type number
             */
            ExecutionOrder: 0,
            /**
        ...
        alias: ["compareTo", ["System$IComparable$1$MyONez$Graphics$RenderProcessors$RenderProcessor$compareTo", "System$IComparable$1$compareTo"]],
        ctors: {
            init: function () {
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this MyONez.Graphics.RenderProcessors.RenderProcessor
             * @memberof MyONez.Graphics.RenderProcessors.RenderProcessor
             * @param   {MyONez.ECS.Scene}    scene
             * @return  {void}
             */
            ...
            DrawFullScreenQuad: function (texture, renderTarget, effect) {
                ...
                this.Batch.Clear();
                this.Batch.Draw(texture, MyONez.Maths.RectangleF.op_Implicit$1(renderTarget.Bounds.$clone()), MyONez.Maths.RectangleF.op_Implicit$1(texture.Bounds.$clone()), Microsoft.Xna.Framework.Color.White.$clone(), 0);
                MyONez.Graphics.Graphic.Draw(renderTarget, Microsoft.Xna.Framework.Color.Black.$clone(), this.Batch, this.Material);
            }
        }
    });

    Bridge.define("MyONez.Graphics.RenderProcessors.Impl.FinalRenderer.LastState", {
        props: {
            RenderTarget: null,
            RenderTarget2: null,
            Material: null,
    ...
    Bridge.define("MyONez.Graphics.RenderProcessors.RenderProcessorList", {
        fields: {
            postProcessors: null,
        ...
        ctors: {
            init: function () {
                this.postProcessors = new (System.Collections.Generic.List$1(MyONez.Graphics.RenderProcessors.RenderProcessor)).ctor();
            },
            ctor: function (scene) {
                this.$initialize();
                this.Scene = scene;
        ...
        methods: {
            ...
            GetAll: function () {
                return new (System.Collections.ObjectModel.ReadOnlyCollection$1(MyONez.Graphics.RenderProcessors.RenderProcessor))(this.postProcessors);
            },
            NotifyUpdate: function (gameTime) {
    ...
    Bridge.define("MyONez.Graphics.RenderTexture", {
        ...
        ctors: {
            init: function () {
                this.ResizeBehavior = MyONez.Graphics.RenderTexture.RenderTextureResizeBehavior.SizeToSceneRenderTarget;
            },
            ctor: function () {
                MyONez.Graphics.RenderTexture.$ctor4.call(this, MyONez.Core.Instance.Screen.Width, MyONez.Core.Instance.Screen.Height, MyONez.Core.Instance.Screen.BackBufferFormat, MyONez.Core.Instance.Screen.PreferredDepthStencilFormat);
            },
            $ctor1: function (preferredDepthFormat) {
                MyONez.Graphics.RenderTexture.$ctor4.call(this, MyONez.Core.Instance.Screen.Width, MyONez.Core.Instance.Screen.Height, MyONez.Core.Instance.Screen.BackBufferFormat, preferredDepthFormat);
            },
            $ctor2: function (width, height) {
                MyONez.Graphics.RenderTexture.$ctor4.call(this, width, height, MyONez.Core.Instance.Screen.BackBufferFormat, MyONez.Core.Instance.Screen.PreferredDepthStencilFormat);
            },
            $ctor3: function (width, height, preferredDepthFormat) {
                MyONez.Graphics.RenderTexture.$ctor4.call(this, width, height, MyONez.Core.Instance.Screen.BackBufferFormat, preferredDepthFormat);
            },
            $ctor4: function (width, height, preferredFormat, preferredDepthFormat) {
                this.$initialize();
                this.RenderTarget = new Microsoft.Xna.Framework.Graphics.RenderTarget2D.$ctor2(MyONez.Core.Instance.GraphicsDevice, width, height, false, preferredFormat, preferredDepthFormat, 0, Microsoft.Xna.Framework.Graphics.RenderTargetUsage.PreserveContents);
            }
        },
        methods: {
            Dispose: function () {
            ...
            OnSceneBackBufferSizeChanged: function (newWidth, newHeight) {
                switch (this.ResizeBehavior) {
                    case MyONez.Graphics.RenderTexture.RenderTextureResizeBehavior.None: 
                        break;
                    case MyONez.Graphics.RenderTexture.RenderTextureResizeBehavior.SizeToSceneRenderTarget: 
                        this.Resize(newWidth, newHeight);
                        break;
                    case MyONez.Graphics.RenderTexture.RenderTextureResizeBehavior.SizeToScreen: 
                        this.Resize(MyONez.Core.Instance.Screen.Width, MyONez.Core.Instance.Screen.Height);
                        break;
                }
            },
            Resize: function (width, height) {
                ...
                this.RenderTarget = new Microsoft.Xna.Framework.Graphics.RenderTarget2D.$ctor2(MyONez.Core.Instance.GraphicsDevice, width, height, false, MyONez.Core.Instance.Screen.BackBufferFormat, depthFormat, 0, Microsoft.Xna.Framework.Graphics.RenderTargetUsage.PreserveContents);
            }
        }
    });

    Bridge.define("MyONez.Graphics.RenderTexture.RenderTextureResizeBehavior", {
        $kind: "nested enum",
        statics: {
            fields: {
                None: 0,
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy", {
        statics: {
            fields: {
                /**
                 ...
                 * @public
                 * @readonly
                 * @memberof MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy
                 * @type MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy
                 */
                None: null,
                /**
            ...
            ctors: {
                init: function () {
                    this.None = new MyONez.Graphics.ResolutionPolicy.NoneSceneResolutionPolicy();
                    this.ExactFit = new MyONez.Graphics.ResolutionPolicy.ExactFitSceneResolutionPolicy();
                    this.Stretch = new MyONez.Graphics.ResolutionPolicy.StretchSceneResolutionPolicy();
                    this.NoBorder = new MyONez.Graphics.ResolutionPolicy.NoBorderSceneResolutionPolicy();
                    this.NoBorderPixelPerfect = new MyONez.Graphics.ResolutionPolicy.NoBorderPixelPerfectSceneResolutionPolicy();
                    this.ShowAll = new MyONez.Graphics.ResolutionPolicy.ShowAllSceneResolutionPolicy();
                    this.ShowAllPixelPerfect = new MyONez.Graphics.ResolutionPolicy.ShowAllPixelPerfectSceneResolutionPolicy();
                    this.FixedHeight = new MyONez.Graphics.ResolutionPolicy.FixedHeightSceneResolutionPolicy();
                    this.FixedHeightPixelPerfect = new MyONez.Graphics.ResolutionPolicy.FixedHeightPixelPerfectSceneResolutionPolicy();
                    this.FixedWidth = new MyONez.Graphics.ResolutionPolicy.FixedWidthSceneResolutionPolicy();
                    this.FixedWidthPixelPerfect = new MyONez.Graphics.ResolutionPolicy.FixedWidthPixelPerfectSceneResolutionPolicy();
                    this.BestFit = new MyONez.Graphics.ResolutionPolicy.BestFitSceneResolutionPolicy();
                }
            }
        }
    });

    Bridge.define("MyONez.Graphics.SpriteEffect", {
        ...
        statics: {
            ...
            ctors: {
                init: function () {
                    this.EffectAssetName = "effects/SpriteEffect";
                }
            }
        },
        fields: {
    ...
    Bridge.define("MyONez.Graphics.Transitions.IProgressEffect", {
        $kind: "interface"
    });

    Bridge.define("MyONez.Graphics.Transitions.SceneTransition", {
        fields: {
        ...
        ctors: {
            init: function () {
                var $t;
                this.Batch = new MyONez.Graphics.Meshes.MeshBatch();
                this.Material = ($t = new MyONez.Graphics.Materials.Material(), $t.BlendState = Microsoft.Xna.Framework.Graphics.BlendState.NonPremultiplied, $t.SamplerState = MyONez.Graphics.Graphic.DefaultSamplerState, $t.DepthStencilState = Microsoft.Xna.Framework.Graphics.DepthStencilState.None, $t);
            },
            ctor: function () {
                this.$initialize();
                this.PreviousSceneRender = new Microsoft.Xna.Framework.Graphics.RenderTarget2D.$ctor2(MyONez.Core.Instance.GraphicsDevice, MyONez.Core.Instance.Screen.Width, MyONez.Core.Instance.Screen.Height, false, MyONez.Core.Instance.Screen.BackBufferFormat, Microsoft.Xna.Framework.Graphics.DepthFormat.None, 0, Microsoft.Xna.Framework.Graphics.RenderTargetUsage.PreserveContents);
            }
        },
        methods: {
            SetNextScene: function () {
                MyONez.Core.Instance.Scene = this.SceneLoadAction();
            },
            PreRender: function () { },
            Render: function () {
                this.Batch.Clear();
                this.Batch.Draw(this.PreviousSceneRender, MyONez.Maths.RectangleF.op_Implicit$1(this.PreviousSceneRender.Bounds.$clone()), MyONez.Maths.RectangleF.op_Implicit$1(this.PreviousSceneRender.Bounds.$clone()), Microsoft.Xna.Framework.Color.White.$clone(), 0);
            ...
            TransitionComplete: function () {
                var $t;
                MyONez.Core.Instance.SceneTransition = null;
                            ...
                            switch ($step) {
                                ...
                                case 2: {
                                    elapsed = (System.DateTime.subdd(System.DateTime.getNow(), startAt)).getTotalSeconds();
                                        step = MyONez.Maths.Easing.Lerps.Ease$8(easeType, start, end, elapsed, duration);
                                        effect.MyONez$Graphics$Transitions$IProgressEffect$Progress = step;
     ...
     * @abstract
     * @public
     * @class MyONez.Maths.Bezier
     */
    Bridge.define("MyONez.Maths.Bezier", {
        statics: {
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this MyONez.Maths.Bezier
                 * @memberof MyONez.Maths.Bezier
                ...
                GetPoint$1: function (p0, p1, p2, t) {
                    t = MyONez.Maths.Mathf.Clamp01(t);
                    var oneMinusT = 1.0 - t;
                ...
                RecursiveGetOptimizedDrawingPoints: function (start, firstCtrlPoint, secondCtrlPoint, end, points, distanceTolerance) {
                    ...
                    MyONez.Maths.Bezier.RecursiveGetOptimizedDrawingPoints(start.$clone(), pt12.$clone(), pt123.$clone(), pt1234.$clone(), points, distanceTolerance);
                    MyONez.Maths.Bezier.RecursiveGetOptimizedDrawingPoints(pt1234.$clone(), pt234.$clone(), pt34.$clone(), end.$clone(), points, distanceTolerance);
                },
                /**
                 * recursively subdivides a bezier curve until distanceTolerance is met. Flat sections will have less points then
                     curved with this
                ...
                GetOptimizedDrawingPoints: function (start, firstCtrlPoint, secondCtrlPoint, end, distanceTolerance) {
                    ...
                    var points = MyONez.Utils.Collections.Pool$1(System.Collections.Generic.List$1(Microsoft.Xna.Framework.Vector2)).Obtain();
                    points.add(start.$clone());
                    MyONez.Maths.Bezier.RecursiveGetOptimizedDrawingPoints(start.$clone(), firstCtrlPoint.$clone(), secondCtrlPoint.$clone(), end.$clone(), points, distanceTolerance);
     ...
     *
     * @public
     * @class MyONez.Maths.BezierSpline
     */
    Bridge.define("MyONez.Maths.BezierSpline", {
        fields: {
            points: null,
            curveCount: 0
        },
        ...
        methods: {
             ...
             * @instance
             * @private
             * @this MyONez.Maths.BezierSpline
             * @memberof MyONez.Maths.BezierSpline
            ...
            PointIndexAtTime: function (t) {
                ...
                if (t.v >= 1.0) {
                    ...
                    t.v = MyONez.Maths.Mathf.Clamp01(t.v) * this.curveCount;
            ...
            GetPointAtTime: function (t) {
                ...
                return MyONez.Maths.Bezier.GetPoint(this.points.getItem(i).$clone(), this.points.getItem(((i + 1) | 0)).$clone(), this.points.getItem(((i + 2) | 0)).$clone(), this.points.getItem(((i + 3) | 0)).$clone(), t.v);
            },
            /**
            ...
            GetVelocityAtTime: function (t) {
                t = {v:t};
                var i = this.PointIndexAtTime(t);
                return MyONez.Maths.Bezier.GetFirstDerivative(this.points.getItem(i).$clone(), this.points.getItem(((i + 1) | 0)).$clone(), this.points.getItem(((i + 2) | 0)).$clone(), this.points.getItem(((i + 3) | 0)).$clone(), t.v);
            },
            /**
     ...
     * @abstract
     * @public
     * @class MyONez.Maths.Easing.EaseHelper
     */
    Bridge.define("MyONez.Maths.Easing.EaseHelper", {
        statics: {
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this MyONez.Maths.Easing.EaseHelper
                 * @memberof MyONez.Maths.Easing.EaseHelper
                 * @param   {MyONez.Maths.Easing.EaseType}    easeType    Ease type.
                 * @return  {MyONez.Maths.Easing.EaseType}                The ease type.
                 */
                OppositeEaseType: function (easeType) {
                    switch (easeType) {
                        case MyONez.Maths.Easing.EaseType.Linear: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.BackIn: 
                            return MyONez.Maths.Easing.EaseType.BackOut;
                        case MyONez.Maths.Easing.EaseType.BackOut: 
                            return MyONez.Maths.Easing.EaseType.BackIn;
                        case MyONez.Maths.Easing.EaseType.BackInOut: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.BounceIn: 
                            return MyONez.Maths.Easing.EaseType.BounceOut;
                        case MyONez.Maths.Easing.EaseType.BounceOut: 
                            return MyONez.Maths.Easing.EaseType.BounceIn;
                        case MyONez.Maths.Easing.EaseType.BounceInOut: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.CircIn: 
                            return MyONez.Maths.Easing.EaseType.CircOut;
                        case MyONez.Maths.Easing.EaseType.CircOut: 
                            return MyONez.Maths.Easing.EaseType.CircIn;
                        case MyONez.Maths.Easing.EaseType.CircInOut: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.CubicIn: 
                            return MyONez.Maths.Easing.EaseType.CubicOut;
                        case MyONez.Maths.Easing.EaseType.CubicOut: 
                            return MyONez.Maths.Easing.EaseType.CubicIn;
                        case MyONez.Maths.Easing.EaseType.CubicInOut: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.ElasticIn: 
                            return MyONez.Maths.Easing.EaseType.ElasticOut;
                        case MyONez.Maths.Easing.EaseType.ElasticOut: 
                            return MyONez.Maths.Easing.EaseType.ElasticIn;
                        case MyONez.Maths.Easing.EaseType.ElasticInOut: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.Punch: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.ExpoIn: 
                            return MyONez.Maths.Easing.EaseType.ExpoOut;
                        case MyONez.Maths.Easing.EaseType.ExpoOut: 
                            return MyONez.Maths.Easing.EaseType.ExpoIn;
                        case MyONez.Maths.Easing.EaseType.ExpoInOut: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.QuadIn: 
                            return MyONez.Maths.Easing.EaseType.QuadOut;
                        case MyONez.Maths.Easing.EaseType.QuadOut: 
                            return MyONez.Maths.Easing.EaseType.QuadIn;
                        case MyONez.Maths.Easing.EaseType.QuadInOut: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.QuartIn: 
                            return MyONez.Maths.Easing.EaseType.QuartOut;
                        case MyONez.Maths.Easing.EaseType.QuartOut: 
                            return MyONez.Maths.Easing.EaseType.QuartIn;
                        case MyONez.Maths.Easing.EaseType.QuartInOut: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.QuintIn: 
                            return MyONez.Maths.Easing.EaseType.QuintOut;
                        case MyONez.Maths.Easing.EaseType.QuintOut: 
                            return MyONez.Maths.Easing.EaseType.QuintIn;
                        case MyONez.Maths.Easing.EaseType.QuintInOut: 
                            return easeType;
                        case MyONez.Maths.Easing.EaseType.SineIn: 
                            return MyONez.Maths.Easing.EaseType.SineOut;
                        case MyONez.Maths.Easing.EaseType.SineOut: 
                            return MyONez.Maths.Easing.EaseType.SineIn;
                        case MyONez.Maths.Easing.EaseType.SineInOut: 
                            return easeType;
                        default: 
                            return easeType;
                    }
                ...
                Ease: function (easeType, t, duration) {
                    switch (easeType) {
                        case MyONez.Maths.Easing.EaseType.Linear: 
                            return MyONez.Maths.Easing.Easing.Linear.EaseNone(t, duration);
                        case MyONez.Maths.Easing.EaseType.BackIn: 
                            return MyONez.Maths.Easing.Easing.Back.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.BackOut: 
                            return MyONez.Maths.Easing.Easing.Back.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.BackInOut: 
                            return MyONez.Maths.Easing.Easing.Back.EaseInOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.BounceIn: 
                            return MyONez.Maths.Easing.Easing.Bounce.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.BounceOut: 
                            return MyONez.Maths.Easing.Easing.Bounce.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.BounceInOut: 
                            return MyONez.Maths.Easing.Easing.Bounce.EaseInOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.CircIn: 
                            return MyONez.Maths.Easing.Easing.Circular.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.CircOut: 
                            return MyONez.Maths.Easing.Easing.Circular.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.CircInOut: 
                            return MyONez.Maths.Easing.Easing.Circular.EaseInOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.CubicIn: 
                            return MyONez.Maths.Easing.Easing.Cubic.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.CubicOut: 
                            return MyONez.Maths.Easing.Easing.Cubic.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.CubicInOut: 
                            return MyONez.Maths.Easing.Easing.Cubic.EaseInOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.ElasticIn: 
                            return MyONez.Maths.Easing.Easing.Elastic.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.ElasticOut: 
                            return MyONez.Maths.Easing.Easing.Elastic.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.ElasticInOut: 
                            return MyONez.Maths.Easing.Easing.Elastic.EaseInOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.Punch: 
                            return MyONez.Maths.Easing.Easing.Elastic.Punch(t, duration);
                        case MyONez.Maths.Easing.EaseType.ExpoIn: 
                            return MyONez.Maths.Easing.Easing.Exponential.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.ExpoOut: 
                            return MyONez.Maths.Easing.Easing.Exponential.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.ExpoInOut: 
                            return MyONez.Maths.Easing.Easing.Exponential.EaseInOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.QuadIn: 
                            return MyONez.Maths.Easing.Easing.Quadratic.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.QuadOut: 
                            return MyONez.Maths.Easing.Easing.Quadratic.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.QuadInOut: 
                            return MyONez.Maths.Easing.Easing.Quadratic.EaseInOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.QuartIn: 
                            return MyONez.Maths.Easing.Easing.Quartic.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.QuartOut: 
                            return MyONez.Maths.Easing.Easing.Quartic.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.QuartInOut: 
                            return MyONez.Maths.Easing.Easing.Quartic.EaseInOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.QuintIn: 
                            return MyONez.Maths.Easing.Easing.Quintic.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.QuintOut: 
                            return MyONez.Maths.Easing.Easing.Quintic.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.QuintInOut: 
                            return MyONez.Maths.Easing.Easing.Quintic.EaseInOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.SineIn: 
                            return MyONez.Maths.Easing.Easing.Sinusoidal.EaseIn(t, duration);
                        case MyONez.Maths.Easing.EaseType.SineOut: 
                            return MyONez.Maths.Easing.Easing.Sinusoidal.EaseOut(t, duration);
                        case MyONez.Maths.Easing.EaseType.SineInOut: 
                            return MyONez.Maths.Easing.Easing.Sinusoidal.EaseInOut(t, duration);
                        default: 
                            return MyONez.Maths.Easing.Easing.Linear.EaseNone(t, duration);
                    }
                }
    ...
    Bridge.define("MyONez.Maths.Easing.EaseType", {
        $kind: "enum",
        statics: {
            fields: {
                Linear: 0,
     ...
     * @abstract
     * @public
     * @class MyONez.Maths.Easing.Easing
     */
    Bridge.define("MyONez.Maths.Easing.Easing");

    Bridge.define("MyONez.Maths.Easing.Easing.Back", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseIn: function (t, d) {
    ...
    Bridge.define("MyONez.Maths.Easing.Easing.Bounce", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseOut: function (t, d) {
                ...
                EaseIn: function (t, d) {
                    return 1 - MyONez.Maths.Easing.Easing.Bounce.EaseOut(d - t, d);
                },
                EaseInOut: function (t, d) {
                    if (t < d / 2) {
                        return MyONez.Maths.Easing.Easing.Bounce.EaseIn(t * 2, d) * 0.5;
                    }
                    return MyONez.Maths.Easing.Easing.Bounce.EaseOut(t * 2 - d, d) * 0.5 + 0.5;
                }
            }
        }
    });

    Bridge.define("MyONez.Maths.Easing.Easing.Circular", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseIn: function (t, d) {
                    return -(MyONez.Maths.Mathf.Sqrt(1 - ((t = t / d)) * t) - 1);
                },
                EaseOut: function (t, d) {
                    return MyONez.Maths.Mathf.Sqrt(1 - ((t = t / d - 1)) * t);
                },
                EaseInOut: function (t, d) {
                    if (((t = t / (d / 2))) < 1) {
                        return -0.5 * (MyONez.Maths.Mathf.Sqrt(1 - t * t) - 1);
                    }

                    return 0.5 * (MyONez.Maths.Mathf.Sqrt(1 - ((t = t - 2)) * t) + 1);
                }
            }
        }
    });

    Bridge.define("MyONez.Maths.Easing.Easing.Cubic", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseIn: function (t, d) {
    ...
    Bridge.define("MyONez.Maths.Easing.Easing.Elastic", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseIn: function (t, d) {
                    ...
                    var p = d * 0.3;
                    var s = p / 4;
                    return -(1 * MyONez.Maths.Mathf.Pow(2, 10 * ((t = t - 1))) * MyONez.Maths.Mathf.Sin((t * d - s) * (6.28318548) / p));
                },
                EaseOut: function (t, d) {
                    if (t === 0) {
                        return 0;
                    ...
                    var p = d * 0.3;
                    var s = p / 4;
                    return 1 * MyONez.Maths.Mathf.Pow(2, -10 * t) * MyONez.Maths.Mathf.Sin((t * d - s) * (6.28318548) / p) + 1;
                },
                EaseInOut: function (t, d) {
                    if (t === 0) {
                        return 0;
                    ...
                    if (t < 1) {
                        return -0.5 * (MyONez.Maths.Mathf.Pow(2, 10 * ((t = t - 1))) * MyONez.Maths.Mathf.Sin((t * d - s) * (6.28318548) / p));
                    }

                    return MyONez.Maths.Mathf.Pow(2.0, -10.0 * ((t = t - 1.0))) * MyONez.Maths.Mathf.Sin((t * d - s) * (6.28318548) / p) * 0.5 + 1.0;
                },
                Punch: function (t, d) {
                    if (t === 0) {
                        return 0;
                    ...
                    var P = 0.3;
                    return MyONez.Maths.Mathf.Pow(2, -10 * t) * MyONez.Maths.Mathf.Sin(t * (6.28318548) / P);
                }
            }
        }
    });

    Bridge.define("MyONez.Maths.Easing.Easing.Exponential", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseIn: function (t, d) {
                    return t === 0 ? 0 : MyONez.Maths.Mathf.Pow(2, 10 * (t / d - 1));
                },
                EaseOut: function (t, d) {
                    return t === d ? 1 : -MyONez.Maths.Mathf.Pow(2, -10 * t / d) + 1;
                },
                EaseInOut: function (t, d) {
                    if (t === 0) {
                        return 0;
                    ...
                    if (((t = t / (d / 2))) < 1) {
                        return 0.5 * MyONez.Maths.Mathf.Pow(2, 10 * (t - 1));
                    }

                    return 0.5 * (-MyONez.Maths.Mathf.Pow(2, -10 * --t) + 2);
                }
            }
        }
    });

    Bridge.define("MyONez.Maths.Easing.Easing.Linear", {
        $kind: "nested class",
        statics: {
            methods: {
    ...
    Bridge.define("MyONez.Maths.Easing.Easing.Quadratic", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseIn: function (t, d) {
    ...
    Bridge.define("MyONez.Maths.Easing.Easing.Quartic", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseIn: function (t, d) {
    ...
    Bridge.define("MyONez.Maths.Easing.Easing.Quintic", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseIn: function (t, d) {
    ...
    Bridge.define("MyONez.Maths.Easing.Easing.Sinusoidal", {
        $kind: "nested class",
        statics: {
            methods: {
                EaseIn: function (t, d) {
                    return -1 * MyONez.Maths.Mathf.Cos(t / d * (1.57079637)) + 1.0;
                },
                EaseOut: function (t, d) {
                    return MyONez.Maths.Mathf.Sin(t / d * (1.57079637));
                },
                EaseInOut: function (t, d) {
                    return -0.5 * (MyONez.Maths.Mathf.Cos(Microsoft.Xna.Framework.MathHelper.Pi * t / d) - 1);
                }
            }
        }
    });
     ...
     * @abstract
     * @public
     * @class MyONez.Maths.Easing.Lerps
     */
    Bridge.define("MyONez.Maths.Easing.Lerps", {
        statics: {
            methods: {
                 ...
                 * @static
                 * @public
                 * @this MyONez.Maths.Easing.Lerps
                 * @memberof MyONez.Maths.Easing.Lerps
                ...
                LerpTowards$3: function (from, to, remainingFactorPerSecond, deltaTime) {
                    return MyONez.Maths.Easing.Lerps.Lerp$7(from, to, 1.0 - MyONez.Maths.Mathf.Pow(remainingFactorPerSecond, deltaTime));
                },
                LerpTowards: function (from, to, remainingFactorPerSecond, deltaTime) {
                    return MyONez.Maths.Easing.Lerps.Lerp$4(from.$clone(), to.$clone(), 1.0 - MyONez.Maths.Mathf.Pow(remainingFactorPerSecond, deltaTime));
                },
                LerpTowards$2: function (from, to, remainingFactorPerSecond, deltaTime) {
                    return MyONez.Maths.Easing.Lerps.Lerp$5(from.$clone(), to.$clone(), 1.0 - MyONez.Maths.Mathf.Pow(remainingFactorPerSecond, deltaTime));
                },
                ...
                Ease$8: function (easeType, from, to, t, duration) {
                    return MyONez.Maths.Easing.Lerps.Lerp$7(from, to, MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                },
                Ease$5: function (easeType, from, to, t, duration) {
                    return MyONez.Maths.Easing.Lerps.Lerp$4(from.$clone(), to.$clone(), MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                },
                Ease$6: function (easeType, from, to, t, duration) {
                    return MyONez.Maths.Easing.Lerps.Lerp$5(from.$clone(), to.$clone(), MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                },
                Ease$7: function (easeType, from, to, t, duration) {
                    return MyONez.Maths.Easing.Lerps.Lerp$6(from.$clone(), to.$clone(), MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                },
                Ease$2: function (easeType, from, to, t, duration) {
                    return Microsoft.Xna.Framework.Quaternion.Lerp(from.$clone(), to.$clone(), MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                },
                Ease: function (easeType, from, to, t, duration) {
                    return MyONez.Maths.Easing.Lerps.Lerp(from.$clone(), to.$clone(), MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                },
                Ease$1: function (easeType, from, to, t, duration) {
                    return MyONez.Maths.Easing.Lerps.Lerp$1(from, to, MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                },
                Ease$3: function (easeType, from, to, t, duration) {
                    return MyONez.Maths.Easing.Lerps.Lerp$2(from.$clone(), to.$clone(), MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                },
                Ease$4: function (easeType, from, to, t, duration) {
                    return MyONez.Maths.Easing.Lerps.Lerp$3(from, to, MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                },
                EaseAngle: function (easeType, from, to, t, duration) {
                    return MyONez.Maths.Easing.Lerps.AngleLerp(from.$clone(), to.$clone(), MyONez.Maths.Easing.EaseHelper.Ease(easeType, t, duration));
                }
            }
        }
    });
     ...
     * @abstract
     * @public
     * @class MyONez.Maths.Flags
     */
    Bridge.define("MyONez.Maths.Flags", {
        statics: {
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this MyONez.Maths.Flags
                 * @memberof MyONez.Maths.Flags
     ...
     *
     * @public
     * @class MyONez.Maths.IncrementalFloats
     */
    Bridge.define("MyONez.Maths.IncrementalFloats", {
        $kind: "struct",
        statics: {
            methods: {
                getDefaultValue: function () { return new MyONez.Maths.IncrementalFloats(); }
            }
        },
        fields: {
            Remainder: 0
        ...
        methods: {
             ...
             * @instance
             * @public
             * @this MyONez.Maths.IncrementalFloats
             * @memberof MyONez.Maths.IncrementalFloats
             * @param   {number}    amount    Amount.
             * @return  {number}
             */
            Update: function (amount) {
                this.Remainder += amount;
                var motion = MyONez.Maths.Mathf.TruncateToInt(this.Remainder);
            ...
            equals: function (o) {
                if (!Bridge.is(o, MyONez.Maths.IncrementalFloats)) {
                    return false;
                }
                return Bridge.equals(this.Remainder, o.Remainder);
            },
            $clone: function (to) {
                var s = to || new MyONez.Maths.IncrementalFloats();
    ...
    Bridge.define("MyONez.Maths.Mathf", {
        statics: {
            fields: {
                Epsilon: 0,
                Deg2Rad: 0,
            ...
            methods: {
                 ...
                 * @static
                 * @public
                 * @this MyONez.Maths.Mathf
                 * @memberof MyONez.Maths.Mathf
                 * @param   {number}    y    F.
                ...
                Snap: function (value, increment) {
                    return MyONez.Maths.Mathf.Round(value / increment) * increment;
                },
                Snap$1: function (value, increment, offset) {
                    return MyONez.Maths.Mathf.Round((value - offset) / increment) * increment + offset;
                },
                ...
                LerpAngle: function (a, b, t) {
                    var num = MyONez.Maths.Mathf.Repeat(b - a, 360.0);
                    if (num > 180.0) {
                        num -= 360.0;
                    }

                    return a + num * MyONez.Maths.Mathf.Clamp01(t);
                },
                /**
                ...
                Repeat: function (t, length) {
                    return t - MyONez.Maths.Mathf.Floor(t / length) * length;
                },
                /**
                ...
                PingPong: function (t, length) {
                    t = MyONez.Maths.Mathf.Repeat(t, length * 2.0);
                ...
                DeltaAngle: function (current, target) {
                    var num = MyONez.Maths.Mathf.Repeat(target - current, 360.0);
                    if (num > 180.0) {
                        num -= 360.0;
                    }
                ...
                DeltaAngleRadians: function (current, target) {
                    var num = MyONez.Maths.Mathf.Repeat(target - current, 6.28318548);
                ...
                ApproachAngle: function (start, end, shift) {
                    var deltaAngle = MyONez.Maths.Mathf.DeltaAngle(start, end);
                    if (-shift < deltaAngle && deltaAngle < shift) {
                        return end;
                    }
                    return MyONez.Maths.Mathf.Repeat(MyONez.Maths.Mathf.Approach(start, start + deltaAngle, shift), 360.0);
                },
                /**
                ...
                ApproachAngleRadians: function (start, end, shift) {
                    var deltaAngleRadians = MyONez.Maths.Mathf.DeltaAngleRadians(start, end);
                    if (-shift < deltaAngleRadians && deltaAngleRadians < shift) {
                        return end;
                    }
                    return MyONez.Maths.Mathf.Repeat(MyONez.Maths.Mathf.Approach(start, start + deltaAngleRadians, shift), Microsoft.Xna.Framework.MathHelper.TwoPi);
                },
                /**
                ...
                RoundWithRoundedAmount: function (value, roundedAmount) {
                    var rounded = MyONez.Maths.Mathf.Round(value);
                    roundedAmount.v = value - rounded * MyONez.Maths.Mathf.Round(value / rounded);
                    return rounded;
                },
                /**
                ...
                Map10: function (value, min, max) {
                    return 1.0 - MyONez.Maths.Mathf.Map01(value, min, max);
                },
                /**
                ...
                RoundToNearest: function (value, roundToNearest) {
                    return MyONez.Maths.Mathf.Round(value / roundToNearest) * roundToNearest;
                },
                WithinEpsilon: function (floatA, floatB) {
                    return Math.abs(floatA - floatB) < MyONez.Maths.Mathf.Epsilon;
                },
                /**
                ...
                Hypotenuse: function (x, y) {
                    return MyONez.Maths.Mathf.Sqrt(x * x + y * y);
                },
                ...
                AngleBetweenVectors: function (from, to) {
                    return MyONez.Maths.Mathf.Atan2(to.Y - from.Y, to.X - from.X);
                },
                AngleToVector: function (angleRadians, length) {
                    return new Microsoft.Xna.Framework.Vector2.$ctor2(MyONez.Maths.Mathf.Cos(angleRadians) * length, MyONez.Maths.Mathf.Sin(angleRadians) * length);
                },
                /**
                ...
                RotateAround$1: function (position, speed, elapsedSeconds) {
                    ...
                    var x = MyONez.Maths.Mathf.Cos(time);
                    var y = MyONez.Maths.Mathf.Sin(time);
                ...
                RotateAround: function (point, center, angleInDegrees) {
                    ...
                    var cos = MyONez.Maths.Mathf.Cos(angleInDegrees);
                    var sin = MyONez.Maths.Mathf.Sin(angleInDegrees);
                ...
                PointOnCircle: function (circleCenter, radius, angleInDegrees) {
                    ...
                    return ($t = new Microsoft.Xna.Framework.Vector2.ctor(), $t.X = MyONez.Maths.Mathf.Cos(radians) * radius + circleCenter.X, $t.Y = MyONez.Maths.Mathf.Sin(radians) * radius + circleCenter.Y, $t);
                },
                /**
                 * lissajou curve
                 *
                ...
                Lissajou: function (elapsedSeconds, xFrequency, yFrequency, xMagnitude, yMagnitude, phase) {
                    ...
                    var x = MyONez.Maths.Mathf.Sin(elapsedSeconds * xFrequency + phase) * xMagnitude;
                    var y = MyONez.Maths.Mathf.Cos(elapsedSeconds * yFrequency) * yMagnitude;
                ...
                LissajouDamped: function (elapsedSeconds, xFrequency, yFrequency, xMagnitude, yMagnitude, phase, damping, oscillationInterval) {
                    ...
                    var wrappedTime = MyONez.Maths.Mathf.PingPong(elapsedSeconds, oscillationInterval);
                    var damped = MyONez.Maths.Mathf.Pow(Microsoft.Xna.Framework.MathHelper.E, -damping * wrappedTime);

                    var x = damped * MyONez.Maths.Mathf.Sin(elapsedSeconds * xFrequency + phase) * xMagnitude;
                    var y = damped * MyONez.Maths.Mathf.Cos(elapsedSeconds * yFrequency) * yMagnitude;
     ...
     * @abstract
     * @public
     * @class MyONez.Maths.QuadTree.IQuadTreeStorable
     */
    Bridge.define("MyONez.Maths.QuadTree.IQuadTreeStorable", {
        $kind: "interface"
    });

    Bridge.define("MyONez.Maths.Random", {
        statics: {
            fields: {
                seed: 0,
                random: null
            ...
            ctors: {
                init: function () {
                    this.seed = Date.now();
                    this.random = new System.Random.$ctor1(MyONez.Maths.Random.seed);
                }
            },
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this MyONez.Maths.Random
                 * @memberof MyONez.Maths.Random
                 * @return  {number}        Seed.
                 */
                GetSeed: function () {
                    return MyONez.Maths.Random.seed;
                },
                /**
                ...
                SetSeed: function (seed) {
                    MyONez.Maths.Random.seed = seed;
                    MyONez.Maths.Random.random = new System.Random.$ctor1(MyONez.Maths.Random.seed);
                },
                /**
                 ...
                 */
                NextFloat: function () {
                    return MyONez.Maths.Random.random.NextDouble();
                },
                /**
                ...
                NextFloat$1: function (max) {
                    return MyONez.Maths.Random.random.NextDouble() * max;
                },
                /**
                ...
                NextInt: function (max) {
                    return MyONez.Maths.Random.random.Next$1(max);
                },
                /**
                 ...
                 */
                NextAngle: function () {
                    return MyONez.Maths.Random.random.NextDouble() * Microsoft.Xna.Framework.MathHelper.TwoPi;
                },
                /**
                 ...
                 * @this MyONez.Maths.Random
                 * @memberof MyONez.Maths.Random
                 * @return  {Microsoft.Xna.Framework.Color}        The color.
                 */
                NextColor: function () {
                    return new Microsoft.Xna.Framework.Color.$ctor8(MyONez.Maths.Random.NextFloat(), MyONez.Maths.Random.NextFloat(), MyONez.Maths.Random.NextFloat());
                },
                /**
                ...
                Range$1: function (min, max) {
                    return MyONez.Maths.Random.random.Next$2(min, max);
                },
                /**
                ...
                Range$2: function (min, max) {
                    return min + MyONez.Maths.Random.NextFloat$1(max - min);
                },
                /**
                 ...
                 * @this MyONez.Maths.Random
                 * @memberof MyONez.Maths.Random
                 * @param   {Microsoft.Xna.Framework.Vector2}    min    
                 * @param   {Microsoft.Xna.Framework.Vector2}    max
                 * @return  {Microsoft.Xna.Framework.Vector2}
                 */
                Range: function (min, max) {
                    return Microsoft.Xna.Framework.Vector2.op_Addition(min.$clone(), new Microsoft.Xna.Framework.Vector2.$ctor2(MyONez.Maths.Random.NextFloat$1(max.X - min.X), MyONez.Maths.Random.NextFloat$1(max.Y - min.Y)));
                },
                /**
                 ...
                 * @this MyONez.Maths.Random
                 * @memberof MyONez.Maths.Random
                 * @return  {number}        The one to one.
                 */
                MinusOneToOne: function () {
                    return MyONez.Maths.Random.NextFloat$1(2.0) - 1.0;
                },
                /**
                ...
                Chance$1: function (percent) {
                    return MyONez.Maths.Random.NextFloat() < percent;
                },
                /**
                ...
                Chance: function (value) {
                    return MyONez.Maths.Random.NextInt(100) < value;
                },
                /**
                 ...
                 * @param   {Function}    T         The 1st type parameter.
                 * @param   {T}           first     First.
                 * @param   {T}           second    Second.
                 * @return  {T}
                 */
                Choose: function (T, first, second) {
                    if (MyONez.Maths.Random.NextInt(2) === 0) {
                        return first;
                    }
                    return second;
                },
                ...
                Choose$1: function (T, first, second, third) {
                    switch (MyONez.Maths.Random.NextInt(3)) {
                        case 0: 
                            return first;
                        case 1: 
                            return second;
                 ...
                 * @param   {T}           second    Second.
                 * @param   {T}           third     Third.
                 * @param   {T}           fourth    Fourth.
                 * @return  {T}
                 */
                Choose$2: function (T, first, second, third, fourth) {
                    switch (MyONez.Maths.Random.NextInt(4)) {
                        case 0: 
                            return first;
                        case 1: 
                            return second;
     ...
     *
     * @public
     * @class MyONez.Maths.RectangleF
     * @implements  System.IEquatable$1
     */
    Bridge.define("MyONez.Maths.RectangleF", {
        inherits: function () { return [System.IEquatable$1(MyONez.Maths.RectangleF)]; },
        $kind: "struct",
        statics: {
            props: {
                /**
                 ...
                 * @static
                 * @public
                 * @memberof MyONez.Maths.RectangleF
                 * @function Empty
                 * @type MyONez.Maths.RectangleF
                 */
                Empty: null,
            ...
            ctors: {
                init: function () {
                    this.Empty = new MyONez.Maths.RectangleF();
                    this.One = new MyONez.Maths.RectangleF();
                    this.One = new MyONez.Maths.RectangleF.$ctor2(0, 0, 1, 1);
                }
            },
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this MyONez.Maths.RectangleF
                 * @memberof MyONez.Maths.RectangleF
                 * @param   {MyONez.Maths.RectangleF}    value1    The first {@link }.
                 * @param   {MyONez.Maths.RectangleF}    value2    The second {@link }.
                 * @return  {MyONez.Maths.RectangleF}              Overlapping region of the two rectangles.
                 */
                Intersect: function (value1, value2) {
                    value1 = {v:value1};
                    value2 = {v:value2};
                    var rectangle = { v : new MyONez.Maths.RectangleF() };
                    MyONez.Maths.RectangleF.Intersect$1(value1, value2, rectangle);
                 ...
                 * @param   {MyONez.Maths.RectangleF}    value1    The first {@link }.
                 * @param   {MyONez.Maths.RectangleF}    value2    The second {@link }.
                 * @param   {MyONez.Maths.RectangleF}    result    Overlapping region of the two rectangles as an output parameter.
                 * @return  {void}
                 */
                Intersect$1: function (value1, value2, result) {
                    if (value1.v.Intersects(value2.v.$clone())) {
                        ...
                        result.v = new MyONez.Maths.RectangleF.$ctor2(leftSide, topSide, rightSide - leftSide, bottomSide - topSide);
                    } else {
                        result.v = new MyONez.Maths.RectangleF.$ctor2(0, 0, 0, 0);
                    }
                },
                /**
                 ...
                 * @param   {MyONez.Maths.RectangleF}    value1    The first {@link }.
                 * @param   {MyONez.Maths.RectangleF}    value2    The second {@link }.
                 * @return  {MyONez.Maths.RectangleF}              The union of the two rectangles.
                 */
                Union: function (value1, value2) {
                    var x = Math.min(value1.X, value2.X);
                    var y = Math.min(value1.Y, value2.Y);
                    return new MyONez.Maths.RectangleF.$ctor2(x, y, Math.max(value1.Right, value2.Right) - x, Math.max(value1.Bottom, value2.Bottom) - y);
                },
                /**
                 * Creates a new {@link } that completely contains two other rectangles.
                 *
                 ...
                 * @param   {MyONez.Maths.RectangleF}    value1    The first {@link }.
                 * @param   {MyONez.Maths.RectangleF}    value2    The second {@link }.
                 * @param   {MyONez.Maths.RectangleF}    result    The union of the two rectangles as an output parameter.
                 * @return  {void}
                 */
                 ...
                 * @this MyONez.Maths.RectangleF
                 * @memberof MyONez.Maths.RectangleF
                 * @param   {MyONez.Maths.RectangleF}    a    {@link } instance on the left of the equal sign.
                 * @param   {MyONez.Maths.RectangleF}    b    {@link } instance on the right of the equal sign.
                 ...
                 * @this MyONez.Maths.RectangleF
                 * @memberof MyONez.Maths.RectangleF
                 * @param   {MyONez.Maths.RectangleF}    a    {@link } instance on the left of the not equal sign.
                 * @param   {MyONez.Maths.RectangleF}    b    {@link } instance on the right of the not equal sign.
                 * @return  {boolean}                         <pre><code>true</code></pre> if the instances are not equal; <pre><code>false</code></pre> otherwise.
                 */
                ,
                op_Inequality: function (a, b) {
                    return !(MyONez.Maths.RectangleF.op_Equality(a.$clone(), b.$clone()));
                },
                ...
                op_Implicit$1: function (self) {
                    return new MyONez.Maths.RectangleF.$ctor2(self.X, self.Y, self.Width, self.Height);
                },
                getDefaultValue: function () { return new MyONez.Maths.RectangleF(); }
            }
        },
        fields: {
            /**
        ...
        alias: ["equalsT", "System$IEquatable$1$MyONez$Maths$RectangleF$equalsT"],
        ctors: {
            /**
        ...
        methods: {
             ...
             * @this MyONez.Maths.RectangleF
             * @memberof MyONez.Maths.RectangleF
             * @param   {MyONez.Maths.RectangleF}    value    The {@link } to check for inclusion in this {@link }.
             ...
             */
            equals: function (obj) {
                var rect = new MyONez.Maths.RectangleF();
                return System.Nullable.liftne(MyONez.Maths.RectangleF.op_Inequality, ((rect = Bridge.as(obj, MyONez.Maths.RectangleF))), null) && MyONez.Maths.RectangleF.op_Equality(this, rect.$clone());
            },
            /**
             * Compares whether current instance is equal to specified {@link }.
             *
             ...
             * @this MyONez.Maths.RectangleF
             * @memberof MyONez.Maths.RectangleF
             * @param   {MyONez.Maths.RectangleF}    other    The {@link } to compare.
             * @return  {boolean}                             <pre><code>true</code></pre> if the instances are equal; <pre><code>false</code></pre> otherwise.
             */
            equalsT: function (other) {
                return MyONez.Maths.RectangleF.op_Equality(this, other.$clone());
            },
            /**
             ...
             * @this MyONez.Maths.RectangleF
             * @memberof MyONez.Maths.RectangleF
             * @param   {MyONez.Maths.RectangleF}    value    The other rectangle for testing.
             ...
             * @this MyONez.Maths.RectangleF
             * @memberof MyONez.Maths.RectangleF
             * @param   {MyONez.Maths.RectangleF}    other    other.
             * @return  {boolean}
             */
            ...
            $clone: function (to) {
                var s = to || new MyONez.Maths.RectangleF();
                s.X = this.X;
                s.Y = this.Y;
                s.Width = this.Width;
    ...
    Bridge.define("MyONez.Maths.TransformationUtils", {
        statics: {
            methods: {
                GetTransformation: function (entity) {
                    ...
                    var localPosition = ($t = (($t1 = entity.GetComponent(MyONez.ECS.Components.PositionComponent)) != null ? $t1.Position : null), $t != null ? $t : Microsoft.Xna.Framework.Vector2.Zero);
                    var localScale = ($t2 = (($t3 = entity.GetComponent(MyONez.ECS.Components.ScaleComponent)) != null ? $t3.Scale : null), $t2 != null ? $t2 : Microsoft.Xna.Framework.Vector2.One);
                    var localRotation = ($t4 = (($t5 = entity.GetComponent(MyONez.ECS.Components.RotateComponent)) != null ? $t5.Rotation : null), $t4 != null ? $t4 : 0);
                    var localParent = MyONez.Maths.TransformationUtils.GetTransformation(($t6 = entity.GetComponent(MyONez.ECS.Components.ParentComponent)) != null ? $t6.Parent : null);
                    var positionalEntity = entity.Cache.GetOrAddData(MyONez.Maths.TransformationUtils.Transformation, "TransformationUtils", $asm.$.MyONez.Maths.TransformationUtils.f1);
    ...
    Bridge.ns("MyONez.Maths.TransformationUtils", $asm.$);

    Bridge.apply($asm.$.MyONez.Maths.TransformationUtils, {
        f1: function () {
            return new MyONez.Maths.TransformationUtils.Transformation();
        }
    });

    Bridge.define("MyONez.Maths.TransformationUtils.Transformation", {
        $kind: "nested class",
        fields: {
     ...
     *
     * @public
     * @class MyONez.Maths.Triangulator
     */
    Bridge.define("MyONez.Maths.Triangulator", {
        statics: {
            methods: {
                /**
                 ...
                 * @static
                 * @public
                 * @this MyONez.Maths.Triangulator
                 * @memberof MyONez.Maths.Triangulator
                ...
                Triangulate: function (points, arePointsCcw) {
                    ...
                    var triangleIndices = MyONez.Utils.Collections.Pool$1(System.Collections.Generic.List$1(System.Int32)).Obtain();
                    ...
                    while (count > 3 && iterations < 500) {
                        ...
                        if (MyONez.Maths.Triangulator.IsTriangleCcw(a.$clone(), b.$clone(), c.$clone())) {
                            ...
                            do {
                                ...
                                if (MyONez.Maths.Triangulator.TestPointTriangle(points[System.Array.index(k, points)].$clone(), a.$clone(), b.$clone(), c.$clone())) {
                                    isEar = false;
                                    break;
                                }
                ...
                IsTriangleCcw: function (a, center, c) {
                    return MyONez.Maths.Triangulator.Cross(Microsoft.Xna.Framework.Vector2.op_Subtraction(center.$clone(), a.$clone()), Microsoft.Xna.Framework.Vector2.op_Subtraction(c.$clone(), center.$clone())) < 0;
                },
                TestPointTriangle: function (point, a, b, c) {
                    // if point to the right of AB then outside triangle
                    if (MyONez.Maths.Triangulator.Cross(Microsoft.Xna.Framework.Vector2.op_Subtraction(point.$clone(), a.$clone()), Microsoft.Xna.Framework.Vector2.op_Subtraction(b.$clone(), a.$clone())) < 0.0) {
                        return false;
                    }

                    // if point to the right of BC then outside of triangle
                    if (MyONez.Maths.Triangulator.Cross(Microsoft.Xna.Framework.Vector2.op_Subtraction(point.$clone(), b.$clone()), Microsoft.Xna.Framework.Vector2.op_Subtraction(c.$clone(), b.$clone())) < 0.0) {
                        return false;
                    }

                    // if point to the right of ca then outside of triangle
                    if (MyONez.Maths.Triangulator.Cross(Microsoft.Xna.Framework.Vector2.op_Subtraction(point.$clone(), c.$clone()), Microsoft.Xna.Framework.Vector2.op_Subtraction(a.$clone(), c.$clone())) < 0.0) {
                        return false;
                    }
    ...
    /** @namespace MyONez.Utils */

    /**
     * helper class to fetch property delegates
     *
     * @public
     * @class MyONez.Utils.BuildTargetUtils
     */
    Bridge.define("MyONez.Utils.BuildTargetUtils", {
        statics: {
            methods: {
                ...
                GetFieldInfo: function (targetObject, fieldName) {
                    return MyONez.Utils.BuildTargetUtils.GetFieldInfo$1(Bridge.getType(targetObject), fieldName);
                },
                ...
                GetFieldValue: function (targetObject, fieldName) {
                    var fieldInfo = MyONez.Utils.BuildTargetUtils.GetFieldInfo(targetObject, fieldName);
                ...
                GetPropertyValue: function (targetObject, propertyName) {
                    var propInfo = MyONez.Utils.BuildTargetUtils.GetPropertyInfo(targetObject, propertyName);
                    var methodInfo = MyONez.Utils.BuildTargetUtils.GetPropertyGetter(propInfo);
                ...
                GetMethodInfo: function (targetObject, methodName) {
                    return MyONez.Utils.BuildTargetUtils.GetMethodInfo$2(Bridge.getType(targetObject), methodName);
                },
                GetMethodInfo$1: function (targetObject, methodName, parameters) {
                    return MyONez.Utils.BuildTargetUtils.GetMethodInfo$2(Bridge.getType(targetObject), methodName, parameters);
                },
                 ...
                 * @static
                 * @public
                 * @this MyONez.Utils.BuildTargetUtils
                 * @memberof MyONez.Utils.BuildTargetUtils
                 * @param   {Function}         T               
                ...
                SetterForProperty: function (T, targetObject, propertyName) {
                    ...
                    return MyONez.Utils.BuildTargetUtils.CreateDelegate(T, targetObject, propInfo.s);
                },
                /**
                ...
                GetterForProperty: function (T, targetObject, propertyName) {
                    ...
                    return MyONez.Utils.BuildTargetUtils.CreateDelegate(T, targetObject, propInfo.g);
                },
    ...
    Bridge.define("MyONez.Utils.Collections.Deque$1", function (T) { return {
        ...
        statics: {
            fields: {
                 ...
                 * @static
                 * @private
                 * @memberof MyONez.Utils.Collections.Deque$1
                 * @constant
                 * @default 16
                 * @type number
                 */
        ...
        props: {
            ...
            Capacity: {
                ...
                set: function (value) {
                    ...
                    var powOfTwo = MyONez.Maths.Mathf.ClosestPowerOfTwoGreaterThan(value);
                    value = powOfTwo;
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this MyONez.Utils.Collections.Deque$1
             * @memberof MyONez.Utils.Collections.Deque$1
             * @return  {void}
             */
            ctor: function () {
                MyONez.Utils.Collections.Deque$1(T).$ctor2.call(this, MyONez.Utils.Collections.Deque$1(T).DefaultCapacity);
            },
            /**
             * Creates a new instance of the Deque class with
            ...
            $ctor1: function (collection) {
                MyONez.Utils.Collections.Deque$1(T).$ctor2.call(this, System.Array.getCount(collection, T));
        ...
        methods: {
            ...
            copyTo: function (array, arrayIndex) {
                ...
                MyONez.Utils.Collections.Deque$1(T).CheckArgumentsOutOfRange(array.length, arrayIndex, this.Count);
    ...
    Bridge.define("MyONez.Utils.Collections.FunctionComparer$1", function (T) { return {
     ...
     * @abstract
     * @public
     * @class MyONez.Utils.Collections.IPriorityQueue$1
     * @implements  System.Collections.Generic.IEnumerable$1
     */
    Bridge.definei("MyONez.Utils.Collections.IPriorityQueue$1", function (T) { return {
     ...
     * @abstract
     * @public
     * @class MyONez.Utils.Collections.Pool$1
     */
    Bridge.define("MyONez.Utils.Collections.Pool$1", function (T) { return {
        statics: {
            fields: {
                objectQueue: null
            },
            ...
            methods: {
                 ...
                 * @static
                 * @public
                 * @this MyONez.Utils.Collections.Pool$1
                 * @memberof MyONez.Utils.Collections.Pool$1
                 * @param   {number}    cacheCount    new cache count
                 * @return  {void}
                 */
                WarmCache: function (cacheCount) {
                    cacheCount = (cacheCount - MyONez.Utils.Collections.Pool$1(T).objectQueue.Count) | 0;
                    if (cacheCount > 0) {
                        for (var i = 0; i < cacheCount; i = (i + 1) | 0) {
                            MyONez.Utils.Collections.Pool$1(T).objectQueue.Enqueue(Bridge.createInstance(T));
                        }
                    }
                },
                /**
                ...
                TrimCache: function (cacheCount) {
                    while (cacheCount > MyONez.Utils.Collections.Pool$1(T).objectQueue.Count) {
                        MyONez.Utils.Collections.Pool$1(T).objectQueue.Dequeue();
                    }
                },
                /**
                 ...
                 */
                ClearCache: function () {
                    MyONez.Utils.Collections.Pool$1(T).objectQueue.Clear();
                },
                /**
                 ...
                 */
                Obtain: function () {
                    if (MyONez.Utils.Collections.Pool$1(T).objectQueue.Count > 0) {
                        return MyONez.Utils.Collections.Pool$1(T).objectQueue.Dequeue();
                    }
                ...
                Free: function (obj) {
                    var $t;
                    MyONez.Utils.Collections.Pool$1(T).objectQueue.Enqueue(obj);

                    ($t = (Bridge.as(obj, MyONez.Utils.Collections.IPoolable))) != null ? $t.MyONez$Utils$Collections$IPoolable$Reset() : null;
                }
            }
        }
    }; });

    Bridge.define("MyONez.Utils.Collections.PriorityQueueNode", {
        props: {
            /**
             ...
             * @instance
             * @public
             * @memberof MyONez.Utils.Collections.PriorityQueueNode
             * @function Priority
             * @type number
             */
            Priority: 0,
    ...
    Bridge.define("MyONez.XnaManagers.GlobalContentManager", {
        ...
        ctors: {
            init: function () {
                this.PostLoadActions = new (System.Collections.Generic.List$1(MyONez.XnaManagers.IPostLoadAction)).ctor();
            },
            ctor: function () {
                this.$initialize();
                Microsoft.Xna.Framework.Content.ContentManager.$ctor1.call(this, MyONez.Core.Instance.Services, MyONez.Core.Instance.Content.RootDirectory);
            }
        },
        methods: {
            Load: function (T, assetName) {
                ...
                try {
                    while ($t.moveNext()) {
                        ...
                        if (Bridge.Reflection.isAssignableFrom(action.MyONez$XnaManagers$IPostLoadAction$ActionType, T)) {
                            action.MyONez$XnaManagers$IPostLoadAction$Apply(result, this);
                        }
                    }
                } finally {
                    if (Bridge.is($t, System.IDisposable)) {
    ...
    Bridge.define("MyONez.XnaManagers.GlobalGraphicsDeviceManager", {
    ...
    Bridge.define("MyONez.XnaManagers.IPostLoadAction", {
        $kind: "interface"
    });

    Bridge.define("MyONez.ECS.EntitySystems.InputGamePadUpdateSystem", {
        ...
        ctors: {
            ...
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.InputGamePadComponent]));
            }
        },
        methods: {
            SceneBackBufferSizeChanged: function (realRenderTarget, sceneRenderTarget) {
                ...
                Microsoft.Xna.Framework.Input.Touch.TouchPanel.DisplayWidth = MyONez.Core.Instance.GraphicsDevice.Viewport.Width;
                Microsoft.Xna.Framework.Input.Touch.TouchPanel.DisplayHeight = MyONez.Core.Instance.GraphicsDevice.Viewport.Height;
                Microsoft.Xna.Framework.Input.Touch.TouchPanel.DisplayOrientation = MyONez.Core.Instance.GraphicsDevice.PresentationParameters.DisplayOrientation;
            },
            DoAction$1: function (entity, gameTime) {
                LocomotorECS.EntityProcessingSystem.prototype.DoAction$1.call(this, entity, gameTime);

                var gamePad = entity.GetComponent(MyONez.ECS.Components.InputGamePadComponent);
    ...
    Bridge.define("MyONez.ECS.EntitySystems.InputMouseUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem,MyONez.ECS.IScreenResolutionChangedListener],
        props: {
            ResolutionOffset: null,
            ResolutionScale: null
        ...
        ctors: {
            ...
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.InputMouseComponent]));
            }
        },
        methods: {
            SceneBackBufferSizeChanged: function (realRenderTarget, sceneRenderTarget) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.InputTouchUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem,MyONez.ECS.IScreenResolutionChangedListener],
        props: {
            ResolutionOffset: null,
            ResolutionScale: null
        ...
        ctors: {
            ...
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.ECS.Components.InputTouchComponent]));
            }
        },
        methods: {
            SceneBackBufferSizeChanged: function (realRenderTarget, sceneRenderTarget) {
     ...
     *
     * @public
     * @class MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis
     * @augments MyONez.ECS.EntitySystems.VirtualInput.VirtualInput
     */
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualInput],
        props: {
            Value: 0
        },
        ctors: {
            ctor: function (overlap) {
                this.$initialize();
                MyONez.ECS.EntitySystems.VirtualInput.VirtualInput.ctor.call(this, overlap);
            },
        ...
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                MyONez.ECS.EntitySystems.VirtualInput.VirtualInput.prototype.Update.call(this, inputKeyboard, inputMouse, inputTouch, inputGamePad);

                var thisTickValue = 0.0;
                for (var i = 0; i < this.Nodes.Count; i = (i + 1) | 0) {
                    var val = Bridge.cast(this.Nodes.getItem(i), MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node).Value;
            ...
            CheckOverlap: function (value) {
                switch (this.Overlap) {
                    case MyONez.ECS.EntitySystems.VirtualInput.VirtualInput.OverlapBehavior.CancelOut: 
                        {
                            return 0;
                        }
                    case MyONez.ECS.EntitySystems.VirtualInput.VirtualInput.OverlapBehavior.TakeNewer: 
                        {
                            return -value;
                        }
                    case MyONez.ECS.EntitySystems.VirtualInput.VirtualInput.OverlapBehavior.TakeOlder: 
                        {
                            return value;
                        }
                    default: 
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualInputNode],
        $kind: "nested class",
        props: {
            Value: null
        },
     ...
     *
     * @public
     * @class MyONez.ECS.EntitySystems.VirtualInput.VirtualButton
     * @augments MyONez.ECS.EntitySystems.VirtualInput.VirtualInput
     */
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualInput],
        props: {
            IsDown: false,
            IsPressed: false,
        ...
        ctors: {
            ctor: function (overlapBehavior) {
                this.$initialize();
                MyONez.ECS.EntitySystems.VirtualInput.VirtualInput.ctor.call(this, overlapBehavior);
            },
        ...
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                ...
                try {
                    while ($t.moveNext()) {
                        var node = $t.Current;
                        if (Bridge.cast(node, MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node).IsDown) {
                            this.IsDown = true;
                            break;
                        }
                    }
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualInputNode],
        $kind: "nested class",
        props: {
            IsDown: false
     ...
     *
     * @public
     * @class MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick
     * @augments MyONez.ECS.EntitySystems.VirtualInput.VirtualInput
     */
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualInput],
        fields: {
            Normalized: false
        },
        ...
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                ...
                for (var i = 0; i < this.Nodes.Count; i = (i + 1) | 0) {
                    var val = Bridge.cast(this.Nodes.getItem(i), MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node).ValueX;
                ...
                for (var i1 = 0; i1 < this.Nodes.Count; i1 = (i1 + 1) | 0) {
                    var val1 = Bridge.cast(this.Nodes.getItem(i1), MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node).ValueY;
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualInputNode],
        $kind: "nested class",
        props: {
            ValueX: null,
     ...
     *
     * @public
     * @class MyONez.GlobalManagers.Coroutines.Coroutine
     * @implements  MyONez.Utils.Collections.IPoolable
     */
    Bridge.define("MyONez.GlobalManagers.Coroutines.Coroutine", {
        inherits: [MyONez.Utils.Collections.IPoolable],
        fields: {
            Enumerator: null,
            IsDone: false,
        ...
        methods: {
            MyONez$Utils$Collections$IPoolable$Reset: function () {
                this.IsDone = true;
     ...
     *
     * @public
     * @class MyONez.GlobalManagers.Coroutines.CoroutineGlobalManager
     * @augments MyONez.GlobalManagers.GlobalManager
     */
    Bridge.define("MyONez.GlobalManagers.Coroutines.CoroutineGlobalManager", {
        inherits: [MyONez.GlobalManagers.GlobalManager],
        fields: {
            nextFrameCoroutines: null
        },
        ctors: {
            init: function () {
                this.nextFrameCoroutines = new (System.Collections.Generic.List$1(MyONez.GlobalManagers.Coroutines.Coroutine)).ctor();
            }
        },
        methods: {
            StartCoroutine: function (enumerator) {
                enumerator = enumerator || MyONez.GlobalManagers.Coroutines.DefaultCoroutines.Empty();

                // find or create a Coroutine
                var coroutine = MyONez.Utils.Collections.Pool$1(MyONez.GlobalManagers.Coroutines.Coroutine).Obtain();
            ...
            Update: function (gameTime) {
                var $t;
                var unblockedCoroutines = MyONez.Utils.Collections.Pool$1(System.Collections.Generic.List$1(MyONez.GlobalManagers.Coroutines.Coroutine)).Obtain();
                ...
                try {
                    while ($t.moveNext()) {
                        ...
                        if (coroutine.IsDone) {
                            MyONez.Utils.Collections.Pool$1(MyONez.GlobalManagers.Coroutines.Coroutine).Free(coroutine);
                            continue;
                        }
                ...
                unblockedCoroutines.clear();
                MyONez.Utils.Collections.Pool$1(System.Collections.Generic.List$1(MyONez.GlobalManagers.Coroutines.Coroutine)).Free(unblockedCoroutines);
            },
            TickCoroutine: function (coroutine) {
                ...
                var current;
                if (((current = Bridge.as(coroutine.Enumerator.System$Collections$IEnumerator$Current, MyONez.GlobalManagers.Coroutines.Coroutine))) != null) {
    ...
    Bridge.define("MyONez.GlobalManagers.Timers.TimerGlobalManager", {
        inherits: [MyONez.GlobalManagers.GlobalManager],
        fields: {
            timers: null
        },
        ctors: {
            init: function () {
                this.timers = new (System.Collections.Generic.List$1(MyONez.GlobalManagers.Timers.Timer)).ctor();
            }
        },
        methods: {
            Update: function (gameTime) {
                for (var i = (this.timers.Count - 1) | 0; i >= 0; i = (i - 1) | 0) {
                    ...
                    if (timer.Tick(gameTime)) {
                        ...
                        MyONez.Utils.Collections.Pool$1(MyONez.GlobalManagers.Timers.Timer).Free(timer);
                    }
                }
            },
            /**
             ...
             *
             * @instance
             * @this MyONez.GlobalManagers.Timers.TimerGlobalManager
             * @memberof MyONez.GlobalManagers.Timers.TimerGlobalManager
             * @param   {number}                                timeInSeconds    Time in seconds.
             * @param   {boolean}                               repeats          If set to <pre><code>true</code></pre> repeats.
             * @param   {System.Action}                         onTime           On time.
             * @return  {MyONez.GlobalManagers.Timers.Timer}
             */
            Schedule: function (timeInSeconds, repeats, onTime) {
                var timer = MyONez.Utils.Collections.Pool$1(MyONez.GlobalManagers.Timers.Timer).Obtain();
     ...
     * @abstract
     * @public
     * @class MyONez.GlobalManagers.Tweens.Interfaces.ITween$1
     * @implements  MyONez.GlobalManagers.Tweens.Interfaces.ITween
     */
    Bridge.definei("MyONez.GlobalManagers.Tweens.Interfaces.ITween$1", function (T) { return {
        inherits: [MyONez.GlobalManagers.Tweens.Interfaces.ITween],
        $kind: "interface"
    }; });

    Bridge.define("MyONez.GlobalManagers.Tweens.TweenGlobalManager", {
        inherits: [MyONez.GlobalManagers.GlobalManager],
        statics: {
            fields: {
                DefaultEaseType: 0,
                 ...
                 * @static
                 * @public
                 * @memberof MyONez.GlobalManagers.Tweens.TweenGlobalManager
                 * @default false
                 * @type boolean
                 */
            ...
            ctors: {
                init: function () {
                    this.DefaultEaseType = MyONez.Maths.Easing.EaseType.QuartIn;
        ...
        ctors: {
            init: function () {
                this.activeTweens = new (System.Collections.Generic.List$1(MyONez.GlobalManagers.Tweens.Tweenable)).ctor();
            }
        },
        methods: {
            Update: function (gameTime) {
                var list = MyONez.Utils.Collections.Pool$1(System.Collections.Generic.List$1(MyONez.GlobalManagers.Tweens.Tweenable)).Obtain();
                list.clear();
                ...
                list.clear();
                MyONez.Utils.Collections.Pool$1(System.Collections.Generic.List$1(MyONez.GlobalManagers.Tweens.Tweenable)).Free(list);
            },
            /**
             ...
             * @instance
             * @public
             * @this MyONez.GlobalManagers.Tweens.TweenGlobalManager
             * @memberof MyONez.GlobalManagers.Tweens.TweenGlobalManager
             * @param   {MyONez.GlobalManagers.Tweens.Interfaces.ITween}    tween    Tween.
             * @return  {void}
             */
            AddTween: function (tween) {
                var tweenable = MyONez.Utils.Collections.Pool$1(MyONez.GlobalManagers.Tweens.Tweenable).Obtain();
             ...
             * @this MyONez.GlobalManagers.Tweens.TweenGlobalManager
             * @memberof MyONez.GlobalManagers.Tweens.TweenGlobalManager
             * @param   {MyONez.GlobalManagers.Tweens.Interfaces.ITween}    tween
             * @return  {void}
             */
            RemoveTween: function (tween) {
                ...
                MyONez.Utils.Collections.Pool$1(MyONez.GlobalManagers.Tweens.Tweenable).Free(tweenable);
            },
            /**
     ...
     *
     * @class MyONez.GlobalManagers.Tweens.TweenTargets.PropertyTweenTarget$1
     * @implements  MyONez.GlobalManagers.Tweens.Interfaces.ITweenTarget$1
     */
    Bridge.define("MyONez.GlobalManagers.Tweens.TweenTargets.PropertyTweenTarget$1", function (T) { return {
        inherits: [MyONez.GlobalManagers.Tweens.Interfaces.ITweenTarget$1(T)],
        fields: {
            fieldInfo: null,
            getter: null,
            setter: null
        ...
        alias: [
            "TweenedValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$" + Bridge.getTypeAlias(T) + "$TweenedValue",
            "Target", "MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$" + Bridge.getTypeAlias(T) + "$Target"
        ],
        ctors: {
            ctor: function (target, propertyName) {
                ...
                if (((this.fieldInfo = MyONez.Utils.BuildTargetUtils.GetFieldInfo(target, propertyName))) == null) {
                    this.setter = MyONez.Utils.BuildTargetUtils.SetterForProperty(Function, target, propertyName);
                    this.getter = MyONez.Utils.BuildTargetUtils.GetterForProperty(Function, target, propertyName);
                }
    ...
    Bridge.define("MyONez.Graphics.Cameras.ScreenSpaceCamera", {
        inherits: [MyONez.Graphics.Cameras.Camera],
        methods: {
            /**
             ...
             * @protected
             * @override
             * @this MyONez.Graphics.Cameras.ScreenSpaceCamera
             * @memberof MyONez.Graphics.Cameras.ScreenSpaceCamera
             * @return  {void}
             */
            UpdateMatrices: function () { }
        }
    ...
    Bridge.define("MyONez.Graphics.Drawable.SubtextureDrawable", {
        inherits: [MyONez.Graphics.Drawable.IDrawable],
        statics: {
            methods: {
                SubtexturesFromAtlas: function (texture, cellWidth, cellHeight, cellOffset, maxCellsToInclude) {
                    ...
                    var subtextures = new (System.Collections.Generic.List$1(MyONez.Graphics.Drawable.SubtextureDrawable)).ctor();
                    ...
                    for (var y = 0; y < rows; y = (y + 1) | 0) {
                        for (var x = 0; x < cols; x = (x + 1) | 0) {
                            ...
                            subtextures.add(new MyONez.Graphics.Drawable.SubtextureDrawable.$ctor1(texture, new Microsoft.Xna.Framework.Rectangle.$ctor2(Bridge.Int.mul(x, cellWidth), Bridge.Int.mul(y, cellHeight), cellWidth, cellHeight)));
        ...
        props: {
            Texture2D: {
                get: function () {
                    return MyONez.Graphics.RenderTexture.op_Implicit(this.renderTexture) || this.texture;
                }
            },
            SourceRect: {
                get: function () {
            ...
            Bounds: {
                get: function () {
                    return MyONez.Maths.RectangleF.op_Implicit$1(this.SourceRect.$clone());
                }
            }
        },
        alias: [
            "Bounds", "MyONez$Graphics$Drawable$IDrawable$Bounds",
            "DrawInto", "MyONez$Graphics$Drawable$IDrawable$DrawInto",
            "DrawInto$1", "MyONez$Graphics$Drawable$IDrawable$DrawInto$1"
        ],
        ctors: {
            ...
            $ctor1: function (texture, sourceRect) {
                MyONez.Graphics.Drawable.SubtextureDrawable.$ctor3.call(this, texture, sourceRect, null);
            },
            ctor: function (texture) {
                MyONez.Graphics.Drawable.SubtextureDrawable.$ctor3.call(this, texture, null, null);
            },
            $ctor2: function (texture, x, y, width, height) {
                MyONez.Graphics.Drawable.SubtextureDrawable.$ctor1.call(this, texture, new Microsoft.Xna.Framework.Rectangle.$ctor2(x, y, width, height));
            },
            $ctor4: function (texture, x, y, width, height) {
                MyONez.Graphics.Drawable.SubtextureDrawable.$ctor2.call(this, texture, Bridge.Int.clip32(x), Bridge.Int.clip32(y), Bridge.Int.clip32(width), Bridge.Int.clip32(height));
            },
            ...
            $ctor5: function (texture) {
                MyONez.Graphics.Drawable.SubtextureDrawable.$ctor8.call(this, texture, null, null);
            },
            $ctor6: function (texture, sourceRect) {
                MyONez.Graphics.Drawable.SubtextureDrawable.$ctor8.call(this, texture, sourceRect, null);
            },
            $ctor7: function (texture, x, y, width, height) {
                MyONez.Graphics.Drawable.SubtextureDrawable.$ctor6.call(this, texture, new Microsoft.Xna.Framework.Rectangle.$ctor2(x, y, width, height));
            },
            $ctor9: function (texture, x, y, width, height) {
                MyONez.Graphics.Drawable.SubtextureDrawable.$ctor7.call(this, texture, Bridge.Int.clip32(x), Bridge.Int.clip32(y), Bridge.Int.clip32(width), Bridge.Int.clip32(height));
            }
        },
        methods: {
            ...
            DrawInto$1: function (width, height, color, depth, target) {
                ...
                var destination = new MyONez.Maths.RectangleF.$ctor2(-(($t = (System.Nullable.liftne(Microsoft.Xna.Framework.Vector2.op_Inequality, System.Nullable.lift1("$clone", this.Origin), null) ? System.Nullable.getValue(System.Nullable.lift1("$clone", this.Origin)).X : null), $t != null ? $t : this.SourceRect.Width)), -(($t1 = (System.Nullable.liftne(Microsoft.Xna.Framework.Vector2.op_Inequality, System.Nullable.lift1("$clone", this.Origin), null) ? System.Nullable.getValue(System.Nullable.lift1("$clone", this.Origin)).Y : null), $t1 != null ? $t1 : this.SourceRect.Height)), width, height);
                target.Draw(this.Texture2D, destination.$clone(), MyONez.Maths.RectangleF.op_Implicit$1(source.$clone()), color.$clone(), depth);
            },
            toString: function () {
    ...
    Bridge.define("MyONez.Graphics.Drawable.PrimitiveDrawable", {
        inherits: [MyONez.Graphics.Drawable.IDrawable],
        fields: {
            Color: null
        },
        props: {
            ...
            Bounds: {
                get: function () {
                    return new MyONez.Maths.RectangleF.$ctor2(0, 0, 1, 1);
                }
            }
        },
        alias: [
        ...
        methods: {
            ...
            DrawInto$1: function (width, height, color, depth, target) {
                var $t;
                var destination = new MyONez.Maths.RectangleF.$ctor2(0, 0, width, height);
                destination.Location = Microsoft.Xna.Framework.Vector2.op_Subtraction(destination.Location.$clone(), this.Origin.$clone());
                target.Draw(MyONez.Graphics.Graphic.PixelTexture, destination.$clone(), MyONez.Maths.RectangleF.op_Implicit$1(MyONez.Graphics.Graphic.PixelTexture.Bounds.$clone()), ($t = this.Color, $t != null ? $t : color), depth);
            }
        }
    });

    Bridge.define("MyONez.Graphics.Materials.Material$1", function (T) { return {
        inherits: [MyONez.Graphics.Materials.Material],
        props: {
            TypedEffect: {
                get: function () {
        ...
        ctors: {
            ctor: function () {
                this.$initialize();
                MyONez.Graphics.Materials.Material.ctor.call(this);
            },
    ...
    Bridge.define("MyONez.Graphics.Meshes.SpriteMesh", {
        inherits: [MyONez.Graphics.Meshes.IMesh],
        props: {
            Texture: null,
            Effect: 0,
            Depth: 0,
        ...
        ctors: {
            init: function () {
                this.Color = new Microsoft.Xna.Framework.Color();
                this.SrcRect = new MyONez.Maths.RectangleF();
                this.DestRect = new MyONez.Maths.RectangleF();
            }
        },
        methods: {
            ...
            Draw: function (spriteBatch) {
                spriteBatch.Draw$2(this.Texture, MyONez.Maths.RectangleF.op_Implicit(this.DestRect.$clone()), MyONez.Maths.RectangleF.op_Implicit(this.SrcRect.$clone()), this.Color.$clone(), this.Rotation, Microsoft.Xna.Framework.Vector2.Zero.$clone(), this.Effect, this.Depth);
            },
            ...
            ApplyTransformMesh: function (transform) {
                var $t;
                var s = { v : new Microsoft.Xna.Framework.Vector3() };
                var r = { v : new Microsoft.Xna.Framework.Quaternion() };
                var t = { v : new Microsoft.Xna.Framework.Vector3() };
    ...
    Bridge.define("MyONez.Graphics.Meshes.VertexMesh", {
        inherits: [MyONez.Graphics.Meshes.IMesh],
        props: {
            PrimitiveType: 0,
            PrimitiveCount: 0,
        ...
        methods: {
            ...
            ApplyEffectToMesh: function (effect) {
                ...
                var minX = System.Linq.Enumerable.from(mesh.Verts).min($asm.$.MyONez.Graphics.Meshes.VertexMesh.f1);
                var maxX = System.Linq.Enumerable.from(mesh.Verts).max($asm.$.MyONez.Graphics.Meshes.VertexMesh.f1);
                var minY = System.Linq.Enumerable.from(mesh.Verts).min($asm.$.MyONez.Graphics.Meshes.VertexMesh.f2);
                var maxY = System.Linq.Enumerable.from(mesh.Verts).max($asm.$.MyONez.Graphics.Meshes.VertexMesh.f2);
            ...
            GetCenter: function () {
                ...
                return Microsoft.Xna.Framework.Vector3.op_Division$1(new Microsoft.Xna.Framework.Vector3.$ctor3(System.Linq.Enumerable.from(this.Verts).sum($asm.$.MyONez.Graphics.Meshes.VertexMesh.f3), System.Linq.Enumerable.from(this.Verts).sum($asm.$.MyONez.Graphics.Meshes.VertexMesh.f4), System.Linq.Enumerable.from(this.Verts).sum($asm.$.MyONez.Graphics.Meshes.VertexMesh.f5)), count);
            },
            Build: function (texture, destRect, srcRect, color, depth) {
                var $t, $t1, $t2, $t3, $t4, $t5, $t6, $t7, $t8, $t9;
                var mesh = this;
    ...
    Bridge.ns("MyONez.Graphics.Meshes.VertexMesh", $asm.$);

    Bridge.apply($asm.$.MyONez.Graphics.Meshes.VertexMesh, {
        f1: function (a) {
    ...
    Bridge.define("MyONez.Graphics.Renderers.Renderer", {
        inherits: function () { return [System.IComparable$1(MyONez.Graphics.Renderers.Renderer),MyONez.ECS.IScreenResolutionChangedListener]; },
        props: {
            /**
             ...
             * @instance
             * @public
             * @memberof MyONez.Graphics.Renderers.Renderer
             * @function RendererMaterial
             * @type MyONez.Graphics.Materials.Material
             */
             ...
             * @type MyONez.Graphics.Cameras.Camera
             */
            RendererCamera: null,
            /**
             * specifies the order in which the Renderers will be called by the scene
             ...
             * @type MyONez.Graphics.RenderTexture
             */
            RenderTexture: null,
            /**
        ...
        alias: [
            "compareTo", ["System$IComparable$1$MyONez$Graphics$Renderers$Renderer$compareTo", "System$IComparable$1$compareTo"],
            "SceneBackBufferSizeChanged", "MyONez$ECS$IScreenResolutionChangedListener$SceneBackBufferSizeChanged"
        ],
        methods: {
            compareTo: function (other) {
    ...
    Bridge.define("MyONez.Graphics.RenderProcessors.Impl.EntityRendererProcessor", {
        inherits: [MyONez.Graphics.RenderProcessors.RenderProcessor],
        fields: {
            entities: null,
            lastState: null,
        ...
        ctors: {
            init: function () {
                ...
                this.lastState = new MyONez.Graphics.RenderProcessors.Impl.FinalRenderer.LastState();
            },
        ...
        methods: {
            Render: function (source, destination) {
                ...
                MyONez.Graphics.RenderProcessors.RenderProcessor.prototype.Render.call(this, source, destination);
                var graphicsDevice = MyONez.Core.Instance.GraphicsDevice;
                ...
                MyONez.Graphics.Graphic.SpriteBatch.Begin();
                    ...
                    while ($t.moveNext()) {
                        ...
                        try {
                            while ($t1.moveNext()) {
                                ...
                                var finalComponent = entity.v.GetComponent(MyONez.ECS.Components.FinalRenderComponent);

                                if (finalComponent.Batch == null) {
                                    continue;
                                }

                                var material = { v : renderer.RendererMaterial || (($t2 = entity.v.GetComponent(MyONez.ECS.Components.MaterialComponent)) != null ? $t2.Material : null) };
                                var camera = { v : renderer.RendererCamera || (($t3 = entity.v.GetComponent(MyONez.ECS.Components.CameraComponent)) != null ? $t3.Camera : null) || this.scene.Camera };
                                var renderTarget = MyONez.Graphics.RenderTexture.op_Implicit(renderer.RenderTexture) || destination;
                                var renderTarget2 = renderer.RenderTexture2 == null ? null : MyONez.Graphics.RenderTexture.op_Implicit(renderer.RenderTexture2);
    ...
    Bridge.define("MyONez.Graphics.RenderProcessors.Impl.FinalRenderRenderProcessor", {
        ...
        ctors: {
            init: function () {
                this.finalRenderDestinationRect = new MyONez.Maths.RectangleF();
            },
        ...
        methods: {
            SceneBackBufferSizeChanged: function (realRenderTarget, sceneRenderTarget) {
                this.finalRenderDestinationRect = MyONez.Maths.RectangleF.op_Implicit$1(realRenderTarget.$clone());
            },
            Render: function (source, destination) {
                this.Material.SamplerState = this.samplerState;

                this.Batch.Clear();
                this.Batch.Draw(source, this.finalRenderDestinationRect.$clone(), MyONez.Maths.RectangleF.op_Implicit$1(source.Bounds.$clone()), Microsoft.Xna.Framework.Color.White.$clone(), 0);
    ...
    Bridge.define("MyONez.Graphics.RenderProcessors.Impl.ScreenShotRenderProcessor", {
        inherits: [MyONez.Graphics.RenderProcessors.RenderProcessor],
        props: {
            Action: null
        },
        ...
        methods: {
            Render: function (source, destination) {
                ...
                var tex = new Microsoft.Xna.Framework.Graphics.Texture2D.ctor(MyONez.Core.Instance.GraphicsDevice, source.Width, source.Height);
    ...
    Bridge.define("MyONez.Graphics.RenderProcessors.RenderProcessor$1", function (T) { return {
        inherits: [MyONez.Graphics.RenderProcessors.RenderProcessor],
        props: {
            TypedEffect: {
                get: function () {
        ...
        ctors: {
            ctor: function (executionOrder, typedEffect) {
                ...
                this.$initialize();
                MyONez.Graphics.RenderProcessors.RenderProcessor.ctor.call(this, executionOrder, typedEffect);
                this.TypedEffect = typedEffect;
            }
        }
    }; });

    Bridge.define("MyONez.Graphics.ResolutionPolicy.BestFitSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        props: {
            BleedSize: null
        },
        ctors: {
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.ExactFitSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                var resolutionScaleX = screenWidth / designSize.X;
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.FixedHeightPixelPerfectSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                ...
                if (designSize.X / designSize.Y < screenAspectRatio) {
                    ...
                    pixelPerfectScale = MyONez.Maths.Mathf.CeilToInt(floatScale);
                } else {
                    var floatScale1 = screenHeight / designSize.Y;
                    pixelPerfectScale = MyONez.Maths.Mathf.CeilToInt(floatScale1);
                }
                ...
                result.Width = MyONez.Maths.Mathf.CeilToInt(designSize.X * resolutionScaleX);
                result.Height = MyONez.Maths.Mathf.CeilToInt(Bridge.Int.mul(designSize.Y, pixelPerfectScale));
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.FixedHeightSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                var resolutionScaleX = screenWidth / designSize.X;
            ...
            GetRenderTargetRect: function (screenWidth, screenHeight, designSize) {
                ...
                var newWidth = MyONez.Maths.Mathf.CeilToInt(screenWidth / resolutionScaleX);
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.FixedWidthPixelPerfectSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                var screenAspectRatio = screenWidth / screenHeight;
                ...
                result.Width = MyONez.Maths.Mathf.CeilToInt(Bridge.Int.mul(designSize.X, pixelPerfectScale));
                result.Height = MyONez.Maths.Mathf.CeilToInt(designSize.Y * resolutionScaleY);
                result.X = (Bridge.Int.div((((screenWidth - result.Width) | 0)), 2)) | 0;
                result.Y = (Bridge.Int.div((((screenHeight - result.Height) | 0)), 2)) | 0;
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.FixedWidthSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                var resolutionScaleX = screenWidth / designSize.X;
            ...
            GetRenderTargetRect: function (screenWidth, screenHeight, designSize) {
                ...
                var newHeight = MyONez.Maths.Mathf.CeilToInt(screenHeight / resolutionScaleY);
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.NoBorderPixelPerfectSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                var screenAspectRatio = screenWidth / screenHeight;
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.NoBorderSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                var resolutionScaleX = screenWidth / designSize.X;
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.NoneSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.ShowAllPixelPerfectSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                var screenAspectRatio = screenWidth / screenHeight;
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.ShowAllSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                var resolutionScaleX = screenWidth / designSize.X;
    ...
    Bridge.define("MyONez.Graphics.ResolutionPolicy.StretchSceneResolutionPolicy", {
        inherits: [MyONez.Graphics.ResolutionPolicy.SceneResolutionPolicy],
        methods: {
            GetFinalRenderDestinationRect: function (screenWidth, screenHeight, designSize) {
                return new Microsoft.Xna.Framework.Rectangle.$ctor2(0, 0, screenWidth, screenHeight);
    ...
    Bridge.define("MyONez.Graphics.Transitions.QuickTransition", {
    ...
    Bridge.define("MyONez.Maths.QuadTree.QuadTree$1", function (T) { return {
        ...
        props: {
             ...
             * @instance
             * @public
             * @memberof MyONez.Maths.QuadTree.QuadTree$1
             * @function QuadTreeRoot
             * @type MyONez.Maths.QuadTree.QuadTreeNode$1
             */
            QuadTreeRoot: null,
            /**
        ...
        ctors: {
            init: function () {
                this.wrappedDictionary = new (System.Collections.Generic.Dictionary$2(T,MyONez.Maths.QuadTree.QuadTreeObject$1(T)))();
            },
            /**
             ...
             * @instance
             * @public
             * @this MyONez.Maths.QuadTree.QuadTree$1
             * @memberof MyONez.Maths.QuadTree.QuadTree$1
            ...
            ctor: function (rect) {
                this.$initialize();
                this.QuadTreeRoot = new (MyONez.Maths.QuadTree.QuadTreeNode$1(T)).ctor(rect.$clone());
            },
            /**
             * Creates a QuadTree for the specified area.
             *
            ...
            $ctor1: function (x, y, width, height) {
                this.$initialize();
                this.QuadTreeRoot = new (MyONez.Maths.QuadTree.QuadTreeNode$1(T)).ctor(new Microsoft.Xna.Framework.Rectangle.$ctor2(x, y, width, height));
            }
        },
        methods: {
            /**
             ...
             */
            add: function (item) {
                var wrappedObject = new (MyONez.Maths.QuadTree.QuadTreeObject$1(T))(item);
     ...
     *
     * @public
     * @class MyONez.Maths.QuadTree.QuadTreeNode$1
     * @param   {Function}    [name]    Any object implementing IQuadStorable.
     */
    Bridge.define("MyONez.Maths.QuadTree.QuadTreeNode$1", function (T) { return {
        statics: {
            fields: {
                MaxObjectsPerNode: 0
            },
        ...
        props: {
             ...
             * @instance
             * @public
             * @memberof MyONez.Maths.QuadTree.QuadTreeNode$1
             * @function QuadRect
             * @type Microsoft.Xna.Framework.Rectangle
             */
            QuadRect: null,
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this MyONez.Maths.QuadTree.QuadTreeNode$1
             * @memberof MyONez.Maths.QuadTree.QuadTreeNode$1
            ...
            $ctor1: function (parent, rect) {
                MyONez.Maths.QuadTree.QuadTreeNode$1(T).ctor.call(this, rect);
                this.Parent = parent;
            }
        },
        methods: {
             ...
             * @this MyONez.Maths.QuadTree.QuadTreeNode$1
             * @memberof MyONez.Maths.QuadTree.QuadTreeNode$1
             * @param   {MyONez.Maths.QuadTree.QuadTreeObject$1}    item    The item to add.
             * @return  {void}
             */
            Add: function (item) {
                if (this.objects == null) {
                    this.objects = new (System.Collections.Generic.List$1(MyONez.Maths.QuadTree.QuadTreeObject$1(T))).ctor();
                }
             ...
             * @this MyONez.Maths.QuadTree.QuadTreeNode$1
             * @memberof MyONez.Maths.QuadTree.QuadTreeNode$1
             * @param   {MyONez.Maths.QuadTree.QuadTreeObject$1}    item    The object to remove.
             * @return  {void}
             */
            Remove: function (item) {
                if (this.objects != null) {
            ...
            Subdivide: function () {
                ...
                this.TopLeftChild = new (MyONez.Maths.QuadTree.QuadTreeNode$1(T)).$ctor1(this, new Microsoft.Xna.Framework.Rectangle.$ctor2(this.QuadRect.Left, this.QuadRect.Top, size.X, size.Y));
                this.TopRightChild = new (MyONez.Maths.QuadTree.QuadTreeNode$1(T)).$ctor1(this, new Microsoft.Xna.Framework.Rectangle.$ctor2(mid.X, this.QuadRect.Top, size.X, size.Y));
                this.BottomLeftChild = new (MyONez.Maths.QuadTree.QuadTreeNode$1(T)).$ctor1(this, new Microsoft.Xna.Framework.Rectangle.$ctor2(this.QuadRect.Left, mid.Y, size.X, size.Y));
                this.BottomRightChild = new (MyONez.Maths.QuadTree.QuadTreeNode$1(T)).$ctor1(this, new Microsoft.Xna.Framework.Rectangle.$ctor2(mid.X, mid.Y, size.X, size.Y));
             ...
             * @this MyONez.Maths.QuadTree.QuadTreeNode$1
             * @memberof MyONez.Maths.QuadTree.QuadTreeNode$1
             * @param   {MyONez.Maths.QuadTree.QuadTreeObject$1}    item    The object to get a child for.
             * @return  {MyONez.Maths.QuadTree.QuadTreeNode$1}
             */
            GetDestinationTree: function (item) {
                // If a child can't contain an object, it will live in this Quad
                var destTree = this;

                if (this.TopLeftChild.QuadRect.Contains$1(item.Data.MyONez$Maths$QuadTree$IQuadTreeStorable$Bounds.$clone())) {
                    destTree = this.TopLeftChild;
                } else {
                    if (this.TopRightChild.QuadRect.Contains$1(item.Data.MyONez$Maths$QuadTree$IQuadTreeStorable$Bounds.$clone())) {
                        destTree = this.TopRightChild;
                    } else {
                        if (this.BottomLeftChild.QuadRect.Contains$1(item.Data.MyONez$Maths$QuadTree$IQuadTreeStorable$Bounds.$clone())) {
                            destTree = this.BottomLeftChild;
                        } else {
                            if (this.BottomRightChild.QuadRect.Contains$1(item.Data.MyONez$Maths$QuadTree$IQuadTreeStorable$Bounds.$clone())) {
            ...
            Relocate: function (item) {
                ...
                if (this.QuadRect.Contains$1(item.Data.MyONez$Maths$QuadTree$IQuadTreeStorable$Bounds.$clone())) {
             ...
             * @this MyONez.Maths.QuadTree.QuadTreeNode$1
             * @memberof MyONez.Maths.QuadTree.QuadTreeNode$1
             * @param   {MyONez.Maths.QuadTree.QuadTreeObject$1}    item     The item to remove.
             ...
             * @this MyONez.Maths.QuadTree.QuadTreeNode$1
             * @memberof MyONez.Maths.QuadTree.QuadTreeNode$1
             * @param   {MyONez.Maths.QuadTree.QuadTreeObject$1}    item    The item to insert.
             * @return  {void}
             */
            Insert: function (item) {
                ...
                if (this.objects == null || this.TopLeftChild == null && ((this.objects.Count + 1) | 0) <= MyONez.Maths.QuadTree.QuadTreeNode$1(T).MaxObjectsPerNode) {
            ...
            GetObjects$1: function (searchRect, results) {
                ...
                if (results.v != null) {
                    if (searchRect.Contains$1(this.QuadRect.$clone())) {
                        ...
                        if (this.objects != null) {
                            for (var i = 0; i < this.objects.Count; i = (i + 1) | 0) {
                                if (searchRect.Intersects(this.objects.getItem(i).Data.MyONez$Maths$QuadTree$IQuadTreeStorable$Bounds.$clone())) {
             ...
             * @this MyONez.Maths.QuadTree.QuadTreeNode$1
             * @memberof MyONez.Maths.QuadTree.QuadTreeNode$1
             * @param   {MyONez.Maths.QuadTree.QuadTreeObject$1}    item    The item that has moved
             * @return  {void}
             */
            Move: function (item) {
                if (item.Owner != null) {
     ...
     *
     * @class MyONez.Maths.QuadTree.QuadTreeObject$1
     * @param   {Function}    [name]
     */
    Bridge.define("MyONez.Maths.QuadTree.QuadTreeObject$1", function (T) { return {
        fields: {
            /**
             ...
             * @instance
             * @public
             * @memberof MyONez.Maths.QuadTree.QuadTreeObject$1
             * @type T
             */
        ...
        ctors: {
             ...
             * @instance
             * @public
             * @this MyONez.Maths.QuadTree.QuadTreeObject$1
             * @memberof MyONez.Maths.QuadTree.QuadTreeObject$1
     ...
     *
     * @public
     * @class MyONez.Utils.Collections.PriorityQueue$1
     * @implements  MyONez.Utils.Collections.IPriorityQueue$1
     * @param   {Function}    [name]    The values in the queue.  Must extend the FastPriorityQueueNode class
     */
    Bridge.define("MyONez.Utils.Collections.PriorityQueue$1", function (T) { return {
        inherits: [MyONez.Utils.Collections.IPriorityQueue$1(T)],
        statics: {
            methods: {
                /**
                 ...
                 * @static
                 * @private
                 * @this MyONez.Utils.Collections.PriorityQueue$1
                 * @memberof MyONez.Utils.Collections.PriorityQueue$1
                 * @param   {T}          higher    
                 * @param   {T}          lower
                 * @return  {boolean}
                 */
        ...
        alias: [
            "Count", "MyONez$Utils$Collections$IPriorityQueue$1$" + Bridge.getTypeAlias(T) + "$Count",
            "Clear", "MyONez$Utils$Collections$IPriorityQueue$1$" + Bridge.getTypeAlias(T) + "$Clear",
            "Contains", "MyONez$Utils$Collections$IPriorityQueue$1$" + Bridge.getTypeAlias(T) + "$Contains",
            "Enqueue", "MyONez$Utils$Collections$IPriorityQueue$1$" + Bridge.getTypeAlias(T) + "$Enqueue",
            "Dequeue", "MyONez$Utils$Collections$IPriorityQueue$1$" + Bridge.getTypeAlias(T) + "$Dequeue",
            "First", "MyONez$Utils$Collections$IPriorityQueue$1$" + Bridge.getTypeAlias(T) + "$First",
            "UpdatePriority", "MyONez$Utils$Collections$IPriorityQueue$1$" + Bridge.getTypeAlias(T) + "$UpdatePriority",
            "Remove", "MyONez$Utils$Collections$IPriorityQueue$1$" + Bridge.getTypeAlias(T) + "$Remove",
            "GetEnumerator", ["System$Collections$Generic$IEnumerable$1$" + Bridge.getTypeAlias(T) + "$GetEnumerator", "System$Collections$Generic$IEnumerable$1$GetEnumerator"]
        ],
        ctors: {
            /**
        ...
        methods: {
            ...
            CascadeUp: function (node) {
                ...
                while (parent >= 1) {
                    ...
                    if (MyONez.Utils.Collections.PriorityQueue$1(T).HasHigherPriority(parentNode, node)) {
                        break;
                    }
            ...
            CascadeDown: function (node) {
                ...
                while (true) {
                    ...
                    if (MyONez.Utils.Collections.PriorityQueue$1(T).HasHigherPriority(childLeft, newParent)) {
                        newParent = childLeft;
                    }
                    ...
                    if (childRightIndex <= this.Count) {
                        ...
                        if (MyONez.Utils.Collections.PriorityQueue$1(T).HasHigherPriority(childRight, newParent)) {
            ...
            OnNodeUpdated: function (node) {
                ...
                if (parentIndex > 0 && MyONez.Utils.Collections.PriorityQueue$1(T).HasHigherPriority(node, parentNode)) {
                    this.CascadeUp(node);
                } else {
            ...
            IsValidQueue: function () {
                for (var i = 1; i < this.nodes.length; i = (i + 1) | 0) {
                    if (this.nodes[System.Array.index(i, this.nodes)] != null) {
                        ...
                        if (childLeftIndex < this.nodes.length && this.nodes[System.Array.index(childLeftIndex, this.nodes)] != null && MyONez.Utils.Collections.PriorityQueue$1(T).HasHigherPriority(this.nodes[System.Array.index(childLeftIndex, this.nodes)], this.nodes[System.Array.index(i, this.nodes)])) {
                            return false;
                        }

                        var childRightIndex = (childLeftIndex + 1) | 0;
                        if (childRightIndex < this.nodes.length && this.nodes[System.Array.index(childRightIndex, this.nodes)] != null && MyONez.Utils.Collections.PriorityQueue$1(T).HasHigherPriority(this.nodes[System.Array.index(childRightIndex, this.nodes)], this.nodes[System.Array.index(i, this.nodes)])) {
                            return false;
                        }
                    }
                }
    ...
    Bridge.define("MyONez.Utils.Collections.SimplePriorityQueue$1", function (T) { return {
        inherits: [MyONez.Utils.Collections.IPriorityQueue$1(T)],
        statics: {
            fields: {
                InitialQueueSize: 0
        ...
        props: {
             ...
             * @public
             * @readonly
             * @memberof MyONez.Utils.Collections.SimplePriorityQueue$1
             * @function Count
             * @type number
             */
            Count: {
        ...
        ctors: {
            ctor: function () {
                this.$initialize();
                this.queue = new (MyONez.Utils.Collections.PriorityQueue$1(MyONez.Utils.Collections.SimplePriorityQueue$1.SimpleNode(T)))(MyONez.Utils.Collections.SimplePriorityQueue$1(T).InitialQueueSize);
            }
        },
        methods: {
            /**
             ...
             * @instance
             * @public
             * @this MyONez.Utils.Collections.SimplePriorityQueue$1
             * @memberof MyONez.Utils.Collections.SimplePriorityQueue$1
             * @return  {void}
             */
            Clear: function () {
            ...
            Enqueue: function (item, priority) {
                this.queue;
                {
                    var node = new (MyONez.Utils.Collections.SimplePriorityQueue$1.SimpleNode(T))(item);
             ...
             * @memberof MyONez.Utils.Collections.SimplePriorityQueue$1
             * @param   {T}                                                            item
             * @return  {MyONez.Utils.Collections.SimplePriorityQueue$1.SimpleNode}
             */
    ...
    Bridge.define("MyONez.Utils.Collections.SimplePriorityQueue$1.SimpleNode", function (T) { return {
        inherits: [MyONez.Utils.Collections.PriorityQueueNode],
        $kind: "nested class",
        props: {
            Data: Bridge.getDefaultValue(T)
        },
        ctors: {
            ctor: function (data) {
                this.$initialize();
                MyONez.Utils.Collections.PriorityQueueNode.ctor.call(this);
                this.Data = data;
            }
        }
    }; });

    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.GamePadDpadLeftRight", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.GamePadDpadUpDown", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.GamePadLeftStickX", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        fields: {
            Deadzone: 0
        ...
        ctors: {
            ctor: function (deadzone) {
                ...
                this.$initialize();
                MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node.ctor.call(this);
                this.Deadzone = deadzone;
            }
        },
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                this.Value = MyONez.Maths.Mathf.SignThreshold(inputGamePad.GetLeftStick$1(this.Deadzone).X, this.Deadzone);
            }
        }
    });

    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.GamePadLeftStickY", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        fields: {
            Deadzone: 0,
             ...
             * @instance
             * @public
             * @memberof MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.GamePadLeftStickY
             * @default true
             * @type boolean
             */
            InvertResult: false
        ...
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                ...
                this.Value = multiplier * MyONez.Maths.Mathf.SignThreshold(inputGamePad.GetLeftStick$1(this.Deadzone).Y, this.Deadzone);
            }
        }
    });

    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.GamePadRightStickX", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        fields: {
            Deadzone: 0
        ...
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                this.Value = MyONez.Maths.Mathf.SignThreshold(inputGamePad.GetRightStick$1(this.Deadzone).X, this.Deadzone);
            }
        }
    });

    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.GamePadRightStickY", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        fields: {
            Deadzone: 0
        ...
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                this.Value = MyONez.Maths.Mathf.SignThreshold(inputGamePad.GetRightStick$1(this.Deadzone).Y, this.Deadzone);
            }
        }
    });

    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.KeyboardKeys", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        fields: {
            Negative: 0,
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.MouseButtons", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.SettableValue", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        props: {
            AxisValue: 0
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.TouchHalfRegion", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.Node],
        $kind: "nested class",
        fields: {
            isVertical: false,
        ...
        ctors: {
            ...
            ctor: function (isVertical, region) {
                ...
                this.region = ($t = region, $t != null ? $t : MyONez.Core.Instance.Screen.Bounds);
            }
        },
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                ...
                if (this.isVertical) {
                    leftTouch = System.Linq.Enumerable.from(inputTouch.CurrentTouches).any(Bridge.fn.bind(this, $asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.TouchHalfRegion.f1));
                    rightTouch = System.Linq.Enumerable.from(inputTouch.CurrentTouches).any(Bridge.fn.bind(this, $asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.TouchHalfRegion.f2));
                } else {
                    leftTouch = System.Linq.Enumerable.from(inputTouch.CurrentTouches).any(Bridge.fn.bind(this, $asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.TouchHalfRegion.f3));
                    rightTouch = System.Linq.Enumerable.from(inputTouch.CurrentTouches).any(Bridge.fn.bind(this, $asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.TouchHalfRegion.f4));
                }
    ...
    Bridge.ns("MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.TouchHalfRegion", $asm.$);

    Bridge.apply($asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.TouchHalfRegion, {
        f1: function (a) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.GamePadButton", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        fields: {
            Button: 0
        },
        ctors: {
            ctor: function (button) {
                this.$initialize();
                MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node.ctor.call(this);
                this.Button = button;
            }
        },
        methods: {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.GamePadDPadDown", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.GamePadDPadLeft", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.GamePadDPadRight", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.GamePadDPadUp", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.GamePadLeftTrigger", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        fields: {
            Threshold: 0
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.GamePadRightTrigger", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        fields: {
            Threshold: 0
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.KeyboardKey", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        fields: {
            Key: 0
     ...
     *
     * @public
     * @class MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.KeyboardModifiedKey
     * @augments MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node
     */
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.KeyboardModifiedKey", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        fields: {
            Key: 0,
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.MouseLeftButton", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.MouseMiddleButton", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.MouseRightButton", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.SettableValue", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        fields: {
            ButtonValue: false
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.TouchTouched", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualButton.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
     ...
     *
     * @public
     * @class MyONez.ECS.EntitySystems.VirtualInput.VirtualIntegerAxis
     * @augments MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis
     */
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualIntegerAxis", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis],
        props: {
            IntegerValue: {
                get: function () {
        ...
        ctors: {
            ctor: function (overlap) {
                this.$initialize();
                MyONez.ECS.EntitySystems.VirtualInput.VirtualAxis.ctor.call(this, overlap);
            },
            $ctor1: function (overlap, nodes) {
                if (nodes === void 0) { nodes = []; }
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.GamePadDpad", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node],
        $kind: "nested class",
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                if (inputGamePad.DpadRightDown) {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.GamePadLeftStick", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node],
        $kind: "nested class",
        fields: {
            Deadzone: 0
        ...
        ctors: {
            ctor: function (deadzone) {
                ...
                this.$initialize();
                MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node.ctor.call(this);
                this.Deadzone = deadzone;
            }
        },
        methods: {
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.GamePadRightStick", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node],
        $kind: "nested class",
        fields: {
            Deadzone: 0
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.KeyboardKeys", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node],
        $kind: "nested class",
        fields: {
            Down: 0,
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.SettableValue", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node],
        $kind: "nested class",
        fields: {
            JoysticValue: null
    ...
    Bridge.define("MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.TouchHalfRegion", {
        inherits: [MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.Node],
        $kind: "nested class",
        fields: {
            region: null
        ...
        methods: {
            Update: function (inputKeyboard, inputMouse, inputTouch, inputGamePad) {
                ...
                upTouch = System.Linq.Enumerable.from(inputTouch.CurrentTouches).any(Bridge.fn.bind(this, $asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.TouchHalfRegion.f1));
                downTouch = System.Linq.Enumerable.from(inputTouch.CurrentTouches).any(Bridge.fn.bind(this, $asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.TouchHalfRegion.f2));
                leftTouch = System.Linq.Enumerable.from(inputTouch.CurrentTouches).any(Bridge.fn.bind(this, $asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.TouchHalfRegion.f3));
                rightTouch = System.Linq.Enumerable.from(inputTouch.CurrentTouches).any(Bridge.fn.bind(this, $asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.TouchHalfRegion.f4));
    ...
    Bridge.ns("MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.TouchHalfRegion", $asm.$);

    Bridge.apply($asm.$.MyONez.ECS.EntitySystems.VirtualInput.VirtualJoystick.TouchHalfRegion, {
        f1: function (a) {
            return a.Position.Y < this.region.$clone().Height / 2.0;
        },
        f2: function (a) {
    ...
    Bridge.define("MyONez.GlobalManagers.Tweens.Tween$1", function (T) { return {
        inherits: [MyONez.GlobalManagers.Tweens.Interfaces.ITween$1(T)],
        fields: {
        ...
        props: {
            ...
            Target: {
                get: function () {
                    return this.TweenTarget["MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$" + Bridge.getTypeAlias(T) + "$Target"];
                }
            }
        },
        alias: [
            "FromValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$1$" + Bridge.getTypeAlias(T) + "$FromValue",
            "EaseType", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$EaseType",
            "CompletionHandler", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$1$" + Bridge.getTypeAlias(T) + "$CompletionHandler",
            "LoopCompleteHandler", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$1$" + Bridge.getTypeAlias(T) + "$LoopCompleteHandler",
            "NextTween", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$NextTween",
            "Delay", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$Delay",
            "Duration", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$Duration",
            "LoopType", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$LoopType",
            "Loops", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$Loops",
            "DelayBetweenLoops", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$DelayBetweenLoops",
            "Target", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$1$" + Bridge.getTypeAlias(T) + "$Target",
            "Start", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$Start",
            "NotifyLoopCompleted", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$NotifyLoopCompleted",
            "NotifyCompleted", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$NotifyCompleted",
            "Stop", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$Stop"
        ],
        ctors: {
            init: function () {
                this.TimeScale = 1.0;
        ...
        methods: {
            Start: function () {
                if (!this.isFromValueOverridden) {
                    this.FromValue = this.TweenTarget["MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$" + Bridge.getTypeAlias(T) + "$TweenedValue"];
                }
            },
            ...
            Stop: function () {
                this.LoopType = MyONez.GlobalManagers.Tweens.LoopType.None;
                this.Loops = 0;
            }
        }
    }; });

    Bridge.define("MyONez.GlobalManagers.Tweens.TweenTargets.ColorComponentTweenTarget", {
        inherits: [MyONez.GlobalManagers.Tweens.Interfaces.ITweenTarget$1(Microsoft.Xna.Framework.Color)],
        fields: {
            target: null
        },
        props: {
        ...
        alias: [
            "TweenedValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Color$TweenedValue",
            "Target", "MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Color$Target"
        ],
        ctors: {
    ...
    Bridge.define("MyONez.GlobalManagers.Tweens.TweenTargets.PositionComponentTweenTarget", {
        inherits: [MyONez.GlobalManagers.Tweens.Interfaces.ITweenTarget$1(Microsoft.Xna.Framework.Vector2)],
        fields: {
            target: null
        },
        props: {
        ...
        alias: [
            "TweenedValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Vector2$TweenedValue",
            "Target", "MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Vector2$Target"
        ],
        ctors: {
            ctor: function (target) {
                this.$initialize();
    ...
    Bridge.define("MyONez.GlobalManagers.Tweens.TweenTargets.RotateComponentTweenTarget", {
        inherits: [MyONez.GlobalManagers.Tweens.Interfaces.ITweenTarget$1(System.Single)],
        fields: {
            target: null
        },
        props: {
        ...
        alias: [
            "TweenedValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$System$Single$TweenedValue",
            "Target", "MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$System$Single$Target"
        ],
        ctors: {
            ctor: function (target) {
                this.$initialize();
    ...
    Bridge.define("MyONez.GlobalManagers.Tweens.TweenTargets.RotateDegreesComponentTweenTarget", {
        inherits: [MyONez.GlobalManagers.Tweens.Interfaces.ITweenTarget$1(System.Single)],
        fields: {
            target: null
        },
    ...
    Bridge.define("MyONez.GlobalManagers.Tweens.TweenTargets.ScaleComponentTweenTarget", {
        inherits: [MyONez.GlobalManagers.Tweens.Interfaces.ITweenTarget$1(Microsoft.Xna.Framework.Vector2)],
        fields: {
            target: null
        },
     ...
     *
     * @public
     * @class MyONez.Graphics.Drawable.NinePatchDrawable
     * @augments MyONez.Graphics.Drawable.SubtextureDrawable
     */
    Bridge.define("MyONez.Graphics.Drawable.NinePatchDrawable", {
        inherits: [MyONez.Graphics.Drawable.SubtextureDrawable],
        statics: {
            fields: {
                TopLeft: 0,
                TopCenter: 0,
            ...
            methods: {
                 ...
                 * @static
                 * @public
                 * @this MyONez.Graphics.Drawable.NinePatchDrawable
                 * @memberof MyONez.Graphics.Drawable.NinePatchDrawable
        ...
        alias: ["DrawInto$1", "MyONez$Graphics$Drawable$IDrawable$DrawInto$1"],
        ctors: {
            init: function () {
            ...
            ctor: function (texture, sourceRect, left, right, top, bottom) {
                MyONez.Graphics.Drawable.NinePatchDrawable.$ctor2.call(this, new MyONez.Graphics.Drawable.SubtextureDrawable.$ctor1(texture, sourceRect.$clone()), left, right, top, bottom);
            },
            $ctor1: function (texture, left, right, top, bottom) {
                MyONez.Graphics.Drawable.NinePatchDrawable.$ctor2.call(this, new MyONez.Graphics.Drawable.SubtextureDrawable.ctor(texture), left, right, top, bottom);
            },
            $ctor2: function (subtexture, left, right, top, bottom) {
                this.$initialize();
                MyONez.Graphics.Drawable.SubtextureDrawable.ctor.call(this, subtexture.Texture2D);
                this.Left = left;
                this.Right = right;
                this.Top = top;
                this.Bottom = bottom;

                MyONez.Graphics.Drawable.NinePatchDrawable.GenerateNinePatchRects(subtexture.SourceRect.$clone(), this.NinePatchRects, left, right, top, bottom);
            }
        },
        methods: {
            DrawInto$1: function (width, height, color, depth, target) {
                ...
                MyONez.Graphics.Drawable.NinePatchDrawable.GenerateNinePatchRects(this.SourceRect.$clone(), this.destinationRects, Bridge.Int.clip32(this.Left / scale.X), Bridge.Int.clip32(this.Right / scale.X), Bridge.Int.clip32(this.Top / scale.Y), Bridge.Int.clip32(this.Bottom / scale.Y));
                ...
                for (var i1 = 0; i1 < rects.Count; i1 = (i1 + 1) | 0) {
                    ...
                    target.Draw(this.Texture2D, MyONez.Maths.RectangleF.op_Implicit$1(destination1.$clone()), MyONez.Maths.RectangleF.op_Implicit$1(source1.$clone()), color.$clone(), depth);
                }
            }
        }
    });
     ...
     *
     * @public
     * @class MyONez.Graphics.Drawable.TiledDrawable
     * @augments MyONez.Graphics.Drawable.SubtextureDrawable
     */
    Bridge.define("MyONez.Graphics.Drawable.TiledDrawable", {
        inherits: [MyONez.Graphics.Drawable.SubtextureDrawable],
        alias: ["DrawInto$1", "MyONez$Graphics$Drawable$IDrawable$DrawInto$1"],
        ctors: {
            ...
            ctor: function (texture) {
                this.$initialize();
                MyONez.Graphics.Drawable.SubtextureDrawable.ctor.call(this, texture);
            }
        },
        methods: {
            DrawInto$1: function (width, height, color, depth, target) {
                var $t, $t1;
                var source = this.SourceRect.$clone();
                var destination = new MyONez.Maths.RectangleF.$ctor2(-(($t = (System.Nullable.liftne(Microsoft.Xna.Framework.Vector2.op_Inequality, System.Nullable.lift1("$clone", this.Origin), null) ? System.Nullable.getValue(System.Nullable.lift1("$clone", this.Origin)).X : null), $t != null ? $t : ((Bridge.Int.div(source.Width, 2)) | 0))), -(($t1 = (System.Nullable.liftne(Microsoft.Xna.Framework.Vector2.op_Inequality, System.Nullable.lift1("$clone", this.Origin), null) ? System.Nullable.getValue(System.Nullable.lift1("$clone", this.Origin)).Y : null), $t1 != null ? $t1 : ((Bridge.Int.div(source.Height, 2)) | 0))), source.Width, source.Height);
                ...
                for (var x = 0; x < repeatX; x = (x + 1) | 0) {
                    for (var y = 0; y < repeatY; y = (y + 1) | 0) {
                        ...
                        target.Draw(this.Texture2D, destination1.$clone(), MyONez.Maths.RectangleF.op_Implicit$1(source.$clone()), color.$clone(), depth);
                    }
                }
            }
        }
    ...
    Bridge.define("MyONez.Graphics.Renderers.DefaultRenderer", {
        inherits: [MyONez.Graphics.Renderers.Renderer],
        methods: {
    ...
    /** @namespace MyONez.Graphics.Renderers */
     ...
     *
     * @public
     * @class MyONez.Graphics.Renderers.RenderLayerExcludeRenderer
     * @augments MyONez.Graphics.Renderers.Renderer
     */
    Bridge.define("MyONez.Graphics.Renderers.RenderLayerExcludeRenderer", {
        inherits: [MyONez.Graphics.Renderers.Renderer],
        fields: {
        ...
        ctors: {
            ctor: function (excludedRenderLayers) {
                ...
                this.$initialize();
                MyONez.Graphics.Renderers.Renderer.ctor.call(this);
        ...
        methods: {
            IsApplicable: function (entity) {
                var $t, $t1;
                return !System.Linq.Enumerable.from(this.ExcludedRenderLayers).contains(($t = (($t1 = entity.GetComponent(MyONez.ECS.Components.RenderLayerComponent)) != null ? $t1.Layer : null), $t != null ? $t : 0));
            }
        }
    });
     ...
     *
     * @public
     * @class MyONez.Graphics.Renderers.RenderLayerRenderer
     * @augments MyONez.Graphics.Renderers.Renderer
     */
    Bridge.define("MyONez.Graphics.Renderers.RenderLayerRenderer", {
        inherits: [MyONez.Graphics.Renderers.Renderer],
        fields: {
            /**
             ...
             * @instance
             * @public
             * @memberof MyONez.Graphics.Renderers.RenderLayerRenderer
             * @type Array.<number>
             */
            RenderLayers: null
        },
        ...
        methods: {
            IsApplicable: function (entity) {
                var $t, $t1;
                return System.Array.contains(this.RenderLayers, ($t = (($t1 = entity.GetComponent(MyONez.ECS.Components.RenderLayerComponent)) != null ? $t1.Layer : null), $t != null ? $t : 0), System.Int32);
            }
        }
    });

    Bridge.define("MyONez.GlobalManagers.Tweens.PrimitiveTweens.ColorTween", {
        inherits: [MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Color)],
        alias: ["UpdateValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue"],
        ctors: {
            ctor: function (tweenTarget, toValue, duration) {
                this.$initialize();
                MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Color).ctor.call(this, tweenTarget, toValue, duration);
            }
        },
        methods: {
            UpdateValue: function (elapsedTime) {
                this.TweenTarget.MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Color$TweenedValue = MyONez.Maths.Easing.Lerps.Ease(this.EaseType, this.FromValue.$clone(), this.ToValue.$clone(), elapsedTime, this.Duration);
            }
        }
    });

    Bridge.define("MyONez.GlobalManagers.Tweens.PrimitiveTweens.FloatTween", {
        inherits: [MyONez.GlobalManagers.Tweens.Tween$1(System.Single)],
        alias: ["UpdateValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue"],
        ctors: {
            ctor: function (tweenTarget, toValue, duration) {
                this.$initialize();
                MyONez.GlobalManagers.Tweens.Tween$1(System.Single).ctor.call(this, tweenTarget, toValue, duration);
            }
        },
        methods: {
            UpdateValue: function (elapsedTime) {
                this.TweenTarget.MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$System$Single$TweenedValue = MyONez.Maths.Easing.Lerps.Ease$8(this.EaseType, this.FromValue, this.ToValue, elapsedTime, this.Duration);
            }
        }
    });

    Bridge.define("MyONez.GlobalManagers.Tweens.PrimitiveTweens.IntTween", {
        inherits: [MyONez.GlobalManagers.Tweens.Tween$1(System.Int32)],
        alias: ["UpdateValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue"],
        ctors: {
            ctor: function (tweenTarget, toValue, duration) {
                this.$initialize();
                MyONez.GlobalManagers.Tweens.Tween$1(System.Int32).ctor.call(this, tweenTarget, toValue, duration);
            }
        },
        methods: {
            UpdateValue: function (elapsedTime) {
                this.TweenTarget.MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$System$Int32$TweenedValue = Bridge.Int.clip32(MyONez.Maths.Easing.Lerps.Ease$8(this.EaseType, this.FromValue, this.ToValue, elapsedTime, this.Duration));
            }
        }
    });

    Bridge.define("MyONez.GlobalManagers.Tweens.PrimitiveTweens.QuaternionTween", {
        inherits: [MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Quaternion)],
        alias: ["UpdateValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue"],
        ctors: {
            ctor: function (tweenTarget, toValue, duration) {
                this.$initialize();
                MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Quaternion).ctor.call(this, tweenTarget, toValue, duration);
            }
        },
        methods: {
            UpdateValue: function (elapsedTime) {
                this.TweenTarget.MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Quaternion$TweenedValue = MyONez.Maths.Easing.Lerps.Ease$2(this.EaseType, this.FromValue.$clone(), this.ToValue.$clone(), elapsedTime, this.Duration);
            }
        }
    });

    Bridge.define("MyONez.GlobalManagers.Tweens.PrimitiveTweens.RectangleTween", {
        inherits: [MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Rectangle)],
        alias: ["UpdateValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue"],
        ctors: {
            ctor: function (tweenTarget, toValue, duration) {
                this.$initialize();
                MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Rectangle).ctor.call(this, tweenTarget, toValue, duration);
            }
        },
        methods: {
            UpdateValue: function (elapsedTime) {
                this.TweenTarget.MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Rectangle$TweenedValue = MyONez.Maths.Easing.Lerps.Ease$3(this.EaseType, this.FromValue.$clone(), this.ToValue.$clone(), elapsedTime, this.Duration);
            }
        }
    });

    Bridge.define("MyONez.GlobalManagers.Tweens.PrimitiveTweens.Vector2Tween", {
        inherits: [MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Vector2)],
        alias: ["UpdateValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue"],
        ctors: {
            ctor: function (tweenTarget, toValue, duration) {
                this.$initialize();
                MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Vector2).ctor.call(this, tweenTarget, toValue, duration);
            }
        },
        methods: {
            UpdateValue: function (elapsedTime) {
                this.TweenTarget.MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Vector2$TweenedValue = MyONez.Maths.Easing.Lerps.Ease$5(this.EaseType, this.FromValue.$clone(), this.ToValue.$clone(), elapsedTime, this.Duration);
            }
        }
    });

    Bridge.define("MyONez.GlobalManagers.Tweens.PrimitiveTweens.Vector3Tween", {
        inherits: [MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Vector3)],
        alias: ["UpdateValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue"],
        ctors: {
            ctor: function (tweenTarget, toValue, duration) {
                this.$initialize();
                MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Vector3).ctor.call(this, tweenTarget, toValue, duration);
            }
        },
        methods: {
            UpdateValue: function (elapsedTime) {
                this.TweenTarget.MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Vector3$TweenedValue = MyONez.Maths.Easing.Lerps.Ease$6(this.EaseType, this.FromValue.$clone(), this.ToValue.$clone(), elapsedTime, this.Duration);
            }
        }
    });

    Bridge.define("MyONez.GlobalManagers.Tweens.PrimitiveTweens.Vector4Tween", {
        inherits: [MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Vector4)],
        alias: ["UpdateValue", "MyONez$GlobalManagers$Tweens$Interfaces$ITween$UpdateValue"],
        ctors: {
            ctor: function (tweenTarget, toValue, duration) {
                this.$initialize();
                MyONez.GlobalManagers.Tweens.Tween$1(Microsoft.Xna.Framework.Vector4).ctor.call(this, tweenTarget, toValue, duration);
            }
        },
        methods: {
            UpdateValue: function (elapsedTime) {
                this.TweenTarget.MyONez$GlobalManagers$Tweens$Interfaces$ITweenTarget$1$Microsoft$Xna$Framework$Vector4$TweenedValue = MyONez.Maths.Easing.Lerps.Ease$7(this.EaseType, this.FromValue.$clone(), this.ToValue.$clone(), elapsedTime, this.Duration);
            }
        }
    });
     ...
     *
     * @public
     * @class MyONez.Graphics.Renderers.ScreenSpaceRenderer
     * @augments MyONez.Graphics.Renderers.RenderLayerRenderer
     */
    Bridge.define("MyONez.Graphics.Renderers.ScreenSpaceRenderer", {
        inherits: [MyONez.Graphics.Renderers.RenderLayerRenderer],
        ctors: {
            ctor: function (renderLayers) {
                if (renderLayers === void 0) { renderLayers = []; }

                this.$initialize();
                MyONez.Graphics.Renderers.RenderLayerRenderer.ctor.call(this, renderLayers);
                this.RenderAfterPostProcessors = true;
                this.RendererCamera = new MyONez.Graphics.Cameras.ScreenSpaceCamera();
            }
        }
    });
});
