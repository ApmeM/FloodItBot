...
Bridge.assembly("MyONez.Samples.Base", function ($asm, globals) {
    ...
    Bridge.define("MyONez.Samples.Base.AI.BaseFloodItAI", {
        ...
        methods: {
            ...
            IsColorPossible: function (color) {
                if (color < 0 || color >= MyONez.Samples.Base.Screens.SharedData.ColorsCount) {
                    return false;
                }
    ...
    Bridge.define("MyONez.Samples.Base.Components.CounterComponent", {
        ...
        ctors: {
            init: function () {
                this.Players = new (System.Collections.Generic.List$1(MyONez.Samples.Base.Components.CounterComponent.PlayerData)).ctor();
            }
        }
    });

    Bridge.define("MyONez.Samples.Base.Components.CounterComponent.PlayerData", {
        $kind: "nested class",
        fields: {
            Size: 0,
            Wins: 0,
    ...
    Bridge.define("MyONez.Samples.Base.Game1", {
        ...
        methods: {
            Initialize: function () {
                ...
                MyONez.Core.Instance.SwitchScene(new (MyONez.AdditionalContent.Scenes.LoadingScene$1(MyONez.Samples.Base.Screens.GameChooseScene))(Bridge.fn.bind(this, $asm.$.MyONez.Samples.Base.Game1.f1)(new (System.Collections.Generic.List$1(MyONez.AdditionalContent.Scenes.LoadingData)).ctor()), 1200, 600));
            }
        }
    });
    ...
    Bridge.define("MyONez.Samples.Base.Screens.GameChooseScene", {
        ...
        statics: {
            ...
            ctors: {
                init: function () {
                    this.AvailableTurns = Bridge.Int.clip32(MyONez.Samples.Base.Screens.SharedData.MapSize * 1.65);
                }
            }
        },
        ctors: {
            ctor: function () {
                ...
                panel.AddChild(new GeonBit.UI.Entities.Button.$ctor1("Single player")).OnClick = $asm.$.MyONez.Samples.Base.Screens.GameChooseScene.f1;
                panel.AddChild(new GeonBit.UI.Entities.Button.$ctor1("Multi player")).OnClick = $asm.$.MyONez.Samples.Base.Screens.GameChooseScene.f2;
                ui.UserInterface.AddEntity(panel);
            }
        }
    });

    Bridge.ns("MyONez.Samples.Base.Screens.GameChooseScene", $asm.$);

    Bridge.apply($asm.$.MyONez.Samples.Base.Screens.GameChooseScene, {
        f1: function (b) {
            MyONez.Core.Instance.SwitchScene(new MyONez.Samples.Base.Screens.SingleplayerScene());
        },
        f2: function (b) {
            MyONez.Core.Instance.SwitchScene(new MyONez.Samples.Base.Screens.MultiplayerScene());
        }
    });

    Bridge.define("MyONez.Samples.Base.Screens.MultiplayerScene", {
        inherits: [MyONez.ECS.Scene],
        statics: {
            methods: {
                        ...
                        try {
                            for (;;) {
                                switch ($step) {
                                    ...
                                    case 1: {
                                        content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpMulti1);
                                            $enumerator.current = Bridge.box(0, System.Int32);
                                            $step = 2;
                                            return true;
                                    }
                                    case 2: {
                                        content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpMulti2);
                                            $enumerator.current = Bridge.box(0, System.Int32);
                                            $step = 3;
                                            return true;
                                    }
                                    case 3: {
                                        content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpMulti3);
                                            $enumerator.current = Bridge.box(0, System.Int32);
                                            $step = 4;
                                            return true;
                                    }
        ...
        ctors: {
            ctor: function () {
                ...
                this.AddEntitySystem(new MyONez.Samples.Base.Systems.MultiplayerGameOverUpdateSystem(this));
                ...
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.ApplyTurnUpdateSystem, MyONez.Samples.Base.Systems.MultiplayerGameOverUpdateSystem);
                ...
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.CounterToTextUpdateSystem, MyONez.Samples.Base.Systems.MultiplayerGameOverUpdateSystem);
                ...
                field.BlockSize = (Bridge.Int.div(600, MyONez.Samples.Base.Screens.SharedData.MapSize)) | 0;
                field.Map = System.Array.create(0, null, System.Int32, MyONez.Samples.Base.Screens.SharedData.MapSize, MyONez.Samples.Base.Screens.SharedData.MapSize);
                ...
                colorSelectorPosition.Position = new Microsoft.Xna.Framework.Vector2.$ctor2(1000, MyONez.Core.Instance.Screen.Center.Y - Bridge.Int.mul((((Bridge.Int.div(400, MyONez.Samples.Base.Screens.SharedData.ColorsCount)) | 0)), MyONez.Samples.Base.Screens.SharedData.ColorsCount) / 2.0);
                colorSelectionField.Map = System.Array.create(0, null, System.Int32, 1, MyONez.Samples.Base.Screens.SharedData.ColorsCount);
                colorSelectionField.Texture = moonTex;
                colorSelectionField.BlockSize = (((Bridge.Int.div(400, MyONez.Samples.Base.Screens.SharedData.ColorsCount)) | 0) - 10) | 0;
                ...
                player2Turn.PlayerX = (MyONez.Samples.Base.Screens.SharedData.MapSize - 1) | 0;
                player2Turn.PlayerY = (MyONez.Samples.Base.Screens.SharedData.MapSize - 1) | 0;
                player2Turn.TurnMade = true;

                var switcher = fieldEntity.AddComponent$1(MyONez.Samples.Base.Components.PlayerSwitcherComponent, ($t = new MyONez.Samples.Base.Components.PlayerSwitcherComponent(), $t.Players = function (_o1) {
                        _o1.add(player1Turn);
                        _o1.add(player2Turn);
                        return _o1;
                    }(new (System.Collections.Generic.List$1(MyONez.Samples.Base.Components.TurnMadeComponent)).ctor()), $t));
                ...
                counter.Players.add(new MyONez.Samples.Base.Components.CounterComponent.PlayerData());
                counter.Players.add(new MyONez.Samples.Base.Components.CounterComponent.PlayerData());
                ...
                colorsCountDropDown.SelectedValue = Bridge.toString(MyONez.Samples.Base.Screens.SharedData.ColorsCount);
                ...
                fieldSizeDropDown.SelectedValue = Bridge.toString(MyONez.Samples.Base.Screens.SharedData.MapSize);
                ...
                settingsMessageBox.OnDone = Bridge.fn.bind(this, function (b) {
                    ...
                    MyONez.Samples.Base.Screens.SharedData.ColorsCount = System.Int32.parse(colorsCountDropDown.SelectedValue);
                    colorSelectorPosition.Position = new Microsoft.Xna.Framework.Vector2.$ctor2(1000, MyONez.Core.Instance.Screen.Center.Y - Bridge.Int.mul((((Bridge.Int.div(400, MyONez.Samples.Base.Screens.SharedData.ColorsCount)) | 0)), MyONez.Samples.Base.Screens.SharedData.ColorsCount) / 2.0);
                    colorSelectionField.Map = System.Array.create(0, null, System.Int32, 1, MyONez.Samples.Base.Screens.SharedData.ColorsCount);
                    colorSelectionField.Texture = moonTex;
                    colorSelectionField.BlockSize = (((Bridge.Int.div(400, MyONez.Samples.Base.Screens.SharedData.ColorsCount)) | 0) - 10) | 0;
                    ...
                    MyONez.Samples.Base.Screens.SharedData.MapSize = System.Int32.parse(fieldSizeDropDown.SelectedValue);
                    field.BlockSize = (Bridge.Int.div(600, MyONez.Samples.Base.Screens.SharedData.MapSize)) | 0;
                    field.Map = System.Array.create(0, null, System.Int32, MyONez.Samples.Base.Screens.SharedData.MapSize, MyONez.Samples.Base.Screens.SharedData.MapSize);
                    field.Texture = moonTex;
                    player2Turn.PlayerX = (MyONez.Samples.Base.Screens.SharedData.MapSize - 1) | 0;
                ...
                panel.AddChild(($t = new GeonBit.UI.Entities.Button.$ctor1("Back"), $t.OnClick = $asm.$.MyONez.Samples.Base.Screens.MultiplayerScene.f1, $t));
        ...
        methods: {
            BuildHelpMessageBox: function (player1, player2) {
                var images = System.Array.init([MyONez.Core.Instance.Content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpMulti1), MyONez.Core.Instance.Content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpMulti2), MyONez.Core.Instance.Content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpMulti3)], Microsoft.Xna.Framework.Graphics.Texture2D);
            ...
            InitPlayer: function (player, playerTurn, switcher, selectedValue, fieldMap) {
                ...
                switch (selectedValue) {
                    case "User": 
                        ...
                        break;
                    case "Easy": 
                        player.AddComponent(BrainAI.ECS.Components.AIComponent).AIBot = new (BrainAI.AI.FSM.StateMachine$1(System.Array.type(System.Int32, 2)))(fieldMap, new MyONez.Samples.Base.AI.RandomFloodItAI(playerTurn, switcher));
                        break;
                    case "Med.": 
                        player.AddComponent(BrainAI.ECS.Components.AIComponent).AIBot = new (BrainAI.AI.FSM.StateMachine$1(System.Array.type(System.Int32, 2)))(fieldMap, new MyONez.Samples.Base.AI.LineFloodItAI(playerTurn, switcher));
                        break;
                    case "Hard": 
                        player.AddComponent(BrainAI.ECS.Components.AIComponent).AIBot = new (BrainAI.AI.FSM.StateMachine$1(System.Array.type(System.Int32, 2)))(fieldMap, new MyONez.Samples.Base.AI.GreedyFloodItAI(playerTurn, switcher));
                        break;
                }
            },
            Restart: function (field, counter) {
                for (var x = 0; x < System.Array.getLength(field.Map, 0); x = (x + 1) | 0) {
                    for (var y = 0; y < System.Array.getLength(field.Map, 1); y = (y + 1) | 0) {
                        field.Map.set([x, y], MyONez.Maths.Random.NextInt(MyONez.Samples.Base.Screens.SharedData.ColorsCount));
                    }
                }
    ...
    Bridge.ns("MyONez.Samples.Base.Screens.MultiplayerScene", $asm.$);

    Bridge.apply($asm.$.MyONez.Samples.Base.Screens.MultiplayerScene, {
        f1: function (b) {
            MyONez.Core.Instance.SwitchScene(new MyONez.Samples.Base.Screens.GameChooseScene());
        }
    });

    Bridge.define("MyONez.Samples.Base.Screens.SharedData", {
        statics: {
            fields: {
                MapSize: 0,
                ColorsCount: 0
    ...
    Bridge.define("MyONez.Samples.Base.Screens.SingleplayerScene", {
        inherits: [MyONez.ECS.Scene],
        statics: {
            props: {
                AvailableTurns: {
                    get: function () {
                        return Bridge.Int.clip32(MyONez.Samples.Base.Screens.SharedData.MapSize * 1.65);
                    }
                }
            },
            methods: {
                        ...
                        try {
                            for (;;) {
                                switch ($step) {
                                    ...
                                    case 1: {
                                        content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpSingle1);
                                            $enumerator.current = Bridge.box(0, System.Int32);
                                            $step = 2;
                                            return true;
                                    }
                                    case 2: {
                                        content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpSingle2);
                                            $enumerator.current = Bridge.box(0, System.Int32);
                                            $step = 3;
                                            return true;
                                    }
                                    case 3: {
                                        content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpSingle3);
                                            $enumerator.current = Bridge.box(0, System.Int32);
                                            $step = 4;
                                            return true;
                                    }
        ...
        ctors: {
            ctor: function () {
                ...
                this.AddEntitySystem(new MyONez.Samples.Base.Systems.ApplyTurnUpdateSystem(this));
                this.AddEntitySystem(new MyONez.Samples.Base.Systems.CounterToTextUpdateSystem());
                this.AddEntitySystem(new MyONez.Samples.Base.Systems.SingleplayerGameOverUpdateSystem(this));
                this.AddEntitySystem(new GeonBit.UI.ECS.EntitySystems.TextUIUpdateSystem());
                this.AddEntitySystem(new BrainAI.ECS.EntitySystems.AIUpdateSystem());
                this.AddEntitySystem(new GeonBit.UI.ECS.EntitySystems.UIUpdateSystem(MyONez.Core.Instance.Content));
                this.AddEntitySystem(new MyONez.Samples.Base.Systems.TurnSelectorUpdateSystem());
                ...
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.TurnSelectorUpdateSystem, MyONez.Samples.Base.Systems.ApplyTurnUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.ApplyTurnUpdateSystem, MyONez.Samples.Base.Systems.FieldMeshGeneratorSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.ApplyTurnUpdateSystem, MyONez.Samples.Base.Systems.SingleplayerGameOverUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.ApplyTurnUpdateSystem, MyONez.Samples.Base.Systems.CounterToTextUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.ApplyTurnUpdateSystem, MyONez.Samples.Base.Systems.ColorSelectorGrayingUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.ColorSelectorGrayingUpdateSystem, MyONez.Samples.Base.Systems.FieldMeshGeneratorSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.CounterToTextUpdateSystem, MyONez.Samples.Base.Systems.SingleplayerGameOverUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Systems.CounterToTextUpdateSystem, GeonBit.UI.ECS.EntitySystems.TextUIUpdateSystem);
                this.AddEntitySystemExecutionOrder(GeonBit.UI.ECS.EntitySystems.UIUpdateSystem, GeonBit.UI.ECS.EntitySystems.TextUIUpdateSystem);
                ...
                player1.AddComponent(BrainAI.ECS.Components.AIComponent).AIBot = new (BrainAI.AI.FSM.StateMachine$1(System.Array.type(System.Int32, 2)))(field.Map, new MyONez.Samples.Base.AI.GreedyFloodItAI(player1Turn, switcher));
                ...
                panel.AddChild(($t = new GeonBit.UI.Entities.Button.$ctor1("Back"), $t.OnClick = $asm.$.MyONez.Samples.Base.Screens.SingleplayerScene.f1, $t));
        ...
        methods: {
            BuildHelpMessageBox: function (player1) {
                var images = System.Array.init([MyONez.Core.Instance.Content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpSingle1), MyONez.Core.Instance.Content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpSingle2), MyONez.Core.Instance.Content.Load(Microsoft.Xna.Framework.Graphics.Texture2D, MyONez.Samples.Base.ContentPaths.helpSingle3)], Microsoft.Xna.Framework.Graphics.Texture2D);
    ...
    Bridge.ns("MyONez.Samples.Base.Screens.SingleplayerScene", $asm.$);

    Bridge.apply($asm.$.MyONez.Samples.Base.Screens.SingleplayerScene, {
        f1: function (b) {
            MyONez.Core.Instance.SwitchScene(new MyONez.Samples.Base.Screens.GameChooseScene());
        }
    });
    ...
    Bridge.define("MyONez.Samples.Base.Systems.ColorSelectorGrayingUpdateSystem", {
        ...
        methods: {
            DoAction: function (gameTime) {
                ...
                var switcher = field.GetComponent(MyONez.Samples.Base.Components.PlayerSwitcherComponent);
    ...
    Bridge.define("MyONez.Samples.Base.Systems.FieldClickUpdateSystem", {
        ...
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var switcher = fieldEntity.GetComponent(MyONez.Samples.Base.Components.PlayerSwitcherComponent);
    ...
    Bridge.define("MyONez.Samples.Base.Systems.MultiplayerGameOverUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        fields: {
            scene: null
        },
        ...
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                for (var i = 0; i < counter.Players.Count; i = (i + 1) | 0) {
                    if (counter.Players.getItem(i).Size > ((Bridge.Int.div(Bridge.Int.mul(MyONez.Samples.Base.Screens.SharedData.MapSize, MyONez.Samples.Base.Screens.SharedData.MapSize), 2)) | 0)) {
    ...
    Bridge.define("MyONez.Samples.Base.Systems.SingleplayerGameOverUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        fields: {
            scene: null
        },
        ...
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                var field = this.scene.FindEntity("Field").GetComponent(MyONez.Samples.Base.Components.FieldComponent);
                if (counter.TurnsMade === MyONez.Samples.Base.Screens.SingleplayerScene.AvailableTurns) {
    ...
    Bridge.define("MyONez.Samples.Base.AI.GreedyFloodItAI", {
        ...
        ctors: {
            ctor: function (turn, switcher) {
                this.$initialize();
                MyONez.Samples.Base.AI.BaseFloodItAI.ctor.call(this, turn, switcher);
            }
        },
        methods: {
            Act: function () {
                ...
                for (var i = 0; i < MyONez.Samples.Base.Screens.SharedData.ColorsCount; i = (i + 1) | 0) {
    ...
    Bridge.define("MyONez.Samples.Base.AI.RandomFloodItAI", {
        ...
        methods: {
            Act: function () {
                return MyONez.Maths.Random.NextInt(MyONez.Samples.Base.Screens.SharedData.ColorsCount);
            }
        }
    });
});
