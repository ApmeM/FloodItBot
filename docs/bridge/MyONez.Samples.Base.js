...
Bridge.assembly("MyONez.Samples.Base", function ($asm, globals) {
    ...
    Bridge.define("MyONez.Samples.Base.Screens.BasicScene", {
        ...
        ctors: {
            ctor: function () {
                ...
                this.AddEntitySystem(new MyONez.Samples.Base.Screens.FieldMeshGeneratorSystem());
                this.AddEntitySystem(new MyONez.Samples.Base.Screens.FieldClickUpdateSystem());
                this.AddEntitySystem(new MyONez.Samples.Base.Screens.TurnUpdateSystem(this));
                this.AddEntitySystem(new MyONez.Samples.Base.Screens.UpdateCounterUpdateSystem());
                this.AddEntitySystem(new MyONez.Samples.Base.Screens.GameOverUpdateSystem(this));
                ...
                this.AddEntitySystemExecutionOrder(BrainAI.ECS.EntitySystems.AIUpdateSystem, MyONez.Samples.Base.Screens.TurnUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Screens.FieldClickUpdateSystem, MyONez.Samples.Base.Screens.TurnUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Screens.TurnUpdateSystem, MyONez.Samples.Base.Screens.FieldMeshGeneratorSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Screens.TurnUpdateSystem, MyONez.Samples.Base.Screens.GameOverUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Screens.TurnUpdateSystem, MyONez.Samples.Base.Screens.UpdateCounterUpdateSystem);
                this.AddEntitySystemExecutionOrder(MyONez.Samples.Base.Screens.UpdateCounterUpdateSystem, MyONez.Samples.Base.Screens.GameOverUpdateSystem);
                ...
                var counter = counterEntity.AddComponent(MyONez.Samples.Base.Screens.CounterComponent);
    ...
    Bridge.define("MyONez.Samples.Base.Screens.CounterComponent", {
    ...
    Bridge.define("MyONez.Samples.Base.Screens.FieldClickUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.Samples.Base.Screens.TurnMadeComponent, MyONez.ECS.Components.InputMouseComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                LocomotorECS.EntityProcessingSystem.prototype.DoAction$1.call(this, entity, gameTime);
                var turn = entity.GetComponent(MyONez.Samples.Base.Screens.TurnMadeComponent);
    ...
    Bridge.define("MyONez.Samples.Base.Screens.FieldComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            Texture: null,
            ColorCount: 0,
    ...
    Bridge.define("MyONez.Samples.Base.Screens.FieldMeshGeneratorSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.Samples.Base.Screens.FieldComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                var $t, $t1, $t2, $t3, $t4;
                LocomotorECS.EntityProcessingSystem.prototype.DoAction$1.call(this, entity, gameTime);
                var map = entity.GetComponent(MyONez.Samples.Base.Screens.FieldComponent);
     ...
     *
     * @public
     * @class MyONez.Samples.Base.Screens.FloodItAI
     * @augments BrainAI.AI.FSM.State$1
     */
    Bridge.define("MyONez.Samples.Base.Screens.FloodItAI", {
    ...
    Bridge.define("MyONez.Samples.Base.Screens.GameOverUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        fields: {
            scene: null
        },
        ctors: {
            ctor: function (scene) {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.Samples.Base.Screens.CounterComponent]));
                this.scene = scene;
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                var $t;
                LocomotorECS.EntityProcessingSystem.prototype.DoAction$1.call(this, entity, gameTime);
                var counter = entity.GetComponent(MyONez.Samples.Base.Screens.CounterComponent);

                if (counter.GameOver) {
                    return;
                }

                var field = this.scene.FindEntity("player").GetComponent(MyONez.Samples.Base.Screens.FieldComponent);
                if (counter.Count === 25) {
                ...
                for (var x = 0; x < System.Array.getLength(map, 0); x = (x + 1) | 0) {
                    for (var y = 0; y < System.Array.getLength(map, 1); y = (y + 1) | 0) {
                        if (map.get([x, y]) !== color) {
                            return;
                        }
                    }
                }
     ...
     *
     * @public
     * @class MyONez.Samples.Base.Screens.LineFloodItAI
     * @augments BrainAI.AI.FSM.State$1
     */
    Bridge.define("MyONez.Samples.Base.Screens.LineFloodItAI", {
        inherits: [BrainAI.AI.FSM.State$1(System.Array.type(System.Int32, 2))],
        fields: {
            turn: null,
            delay: 0
     ...
     *
     * @public
     * @class MyONez.Samples.Base.Screens.RandomFloodItAI
     * @augments BrainAI.AI.FSM.State$1
     */
    Bridge.define("MyONez.Samples.Base.Screens.RandomFloodItAI", {
        inherits: [BrainAI.AI.FSM.State$1(System.Array.type(System.Int32, 2))],
        fields: {
            turn: null,
            delay: 0
    ...
    Bridge.define("MyONez.Samples.Base.Screens.TurnMadeComponent", {
        inherits: [LocomotorECS.Component],
        fields: {
            X: 0,
            Y: 0
    ...
    Bridge.define("MyONez.Samples.Base.Screens.TurnUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        fields: {
            scene: null
        },
        ctors: {
            ctor: function (scene) {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([MyONez.Samples.Base.Screens.FieldComponent, MyONez.Samples.Base.Screens.TurnMadeComponent]));
                this.scene = scene;
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                LocomotorECS.EntityProcessingSystem.prototype.DoAction$1.call(this, entity, gameTime);
                var map = entity.GetComponent(MyONez.Samples.Base.Screens.FieldComponent);
                var position = entity.GetComponent(MyONez.Samples.Base.Screens.TurnMadeComponent);
                ...
                var counter = counterEntity.GetComponent(MyONez.Samples.Base.Screens.CounterComponent);
    ...
    Bridge.define("MyONez.Samples.Base.Screens.UpdateCounterUpdateSystem", {
        inherits: [LocomotorECS.EntityProcessingSystem],
        ctors: {
            ctor: function () {
                this.$initialize();
                LocomotorECS.EntityProcessingSystem.ctor.call(this, new LocomotorECS.Matching.Matcher().All([GeonBit.UI.ECS.Components.TextComponent, MyONez.Samples.Base.Screens.CounterComponent]));
            }
        },
        methods: {
            DoAction$1: function (entity, gameTime) {
                ...
                text.Text = System.String.format("Moves: {0}. \n Wins: {1} / {2} = {3}", Bridge.box(counter.Count, System.Int32), Bridge.box(counter.StatisticWins, System.Int32), Bridge.box(counter.StatisticCount, System.Int32), Bridge.box(((Bridge.Int.div(Bridge.Int.mul(counter.StatisticWins, 100), Math.max(1, counter.StatisticCount))) | 0), System.Int32));
            }
        }
    });
});
